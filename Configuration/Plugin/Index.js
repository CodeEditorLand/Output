...
import c from "./Transform/ForceTextAreaInput.js";

import "./Transform/HoistFunctionDeclarations.js";

import d from "./Transform/InjectConfigurationOverlay.js";
import S from "./Transform/InjectDisableLazyPaint.js";
import y from "./Transform/InjectEagerExtensionActivation.js";
import x from "./Transform/InjectEagerIdleValue.js";
import C from "./Transform/InjectEagerLifecyclePhase.js";
import I from "./Transform/InjectEditorGPULayerCSS.js";
import P from "./Transform/InjectMacTitlebarOffsetCSS.js";
import R from "./Transform/InjectNameShim.js";
import j from "./Transform/InjectPartZIndexCSS.js";
import b from "./Transform/InjectStorageOverlay.js";
import h from "./Transform/InjectStripBackgroundPolling.js";
import v from "./Transform/InjectTelemetryConsentOff.js";
import k from "./Transform/InjectTerminalGPULayerCSS.js";
import W from "./Transform/InjectWebViewPolyfills.js";
import F from "./Transform/InjectWorkbenchInteractivityCSS.js";
import D from "./Transform/InjectWorkbenchPaintPrime.js";
import M from "./Transform/InjectWorkerBootstrapShim.js";
import T from "./Transform/InlineCSSImport.js";
import g from "./Transform/InstrumentVscodeGit.js";
import V from "./Transform/PatchLocalTerminalBackend.js";

import "./Transform/PatchTerminalGpuAcceleration.js";

import A from "./Transform/ReplaceElectronIPCService.js";
import w from "./Transform/ReplaceExtensionGalleryService.js";
import O from "./Transform/ReplaceSearchService.js";
import U from "./Transform/ReplaceSharedProcess.js";
import E from "./Transform/ReplaceTelemetryService.js";
import L from "./Transform/ReplaceUpdateService.js";
import N from "./Transform/RewriteIconsStyleSheetURLs.js";
import B from "./Transform/RewriteNestedWorkerBootstrap.js";
import G from "./Transform/RewriteNodeModulesPath.js";
import z from "./Transform/RewritePerfBaselineWorker.js";
...
import H, { default as qo } from "./Transform/RewriteWebviewShellCSP.js";
...
const Y = (globalThis.process?.env?.Disable ?? "").toLowerCase() === "true",
	_ = (e) => {
		const l = (e.Profile ?? "").startsWith("release") ? T : K;
		return Y
			? [
					t(e.VSOutput),
					a(e.VSRootFiles),
