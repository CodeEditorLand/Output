...
function u() {
	...
	(typeof window.requestIdleCallback != "function" &&
		(window.requestIdleCallback = (n, e) => {
			const o = (e && e.timeout) || 1,
				t = Date.now();
			return setTimeout(() => {
				n({
					didTimeout: o <= 0,
					timeRemaining: () => Math.max(0, o - (Date.now() - t)),
				});
			}, o);
		}),
...
`,
	...
	((c.prototype = i.prototype), (globalThis.Blob = c));
}

export { b as Marker, u as default };
