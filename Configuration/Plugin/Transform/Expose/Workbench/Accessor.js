...
const WebFactoryImportMarker = "import { mark } from '../../base/common/performance.js';";
...
const Plugin = {
  ...
  Transform({ Path, Source }) {
    ...
    if (IsWebMain || IsDesktopMain) {
      ...
      const ImportMarker = IsDesktopMain ? DesktopMainImportMarker : WebMainImportMarker;
      const ImportInjection = IsDesktopMain ? DesktopMainImportInjection : WebMainImportInjection;
