...
const Marker = /* @__PURE__ */ __name((Letter, Note) => `try { process.stdout.write('[GIT-MARK-${Letter}] ${Note}\\n'); } catch (e) {} `, "Marker");
const MainPatches = [
  {
    Letter: "A",
...
const Plugin = {
  ...
  Match: /* @__PURE__ */ __name(({ Path }) => /extensions\/git\/(?:out|dist)\/main\.js$/.test(Path) || /extensions\/git\/(?:out|dist)\/model\.js$/.test(Path), "Match"),
...
export {
  InstrumentVscodeGit_default as default
};
