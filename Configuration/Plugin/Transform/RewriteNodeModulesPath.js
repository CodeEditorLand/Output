...
const Plugin = {
	...
	Match: /* @__PURE__ */ __name(
		({ Path }) => /\/vs\/base\/common\/network\.js$/.test(Path),
		"Match",
	),
	Transform({ Source }) {
...
var RewriteNodeModulesPath_default = Plugin;
export { RewriteNodeModulesPath_default as default };
//# sourceMappingURL=RewriteNodeModulesPath.js.map
