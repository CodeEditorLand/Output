...
const Tail = `      }).toString();`;
const ReplacementSource = "      const jsSrc = " + JSON.stringify(
  [
    "function() {",
    "  let tooSlow = false;",
    "  function fib(n) {",
...
const Plugin = {
  ...
  Match: /* @__PURE__ */ __name(({ Path }) => /\/vs\/workbench\/services\/timer\/browser\/timerService\.js$/.test(
    Path
  ), "Match"),
  Transform({ Source }) {
...
export {
  RewritePerfBaselineWorker_default as default
};
