async function i(r, e = {}) {
	try {
		...
		if (typeof t == "function")
			return r.includes(":")
				? await t("MountainIPCInvoke", { method: r, params: e })
				: await t(r, e);
	...
	try {
		if (typeof window.__TAURI__ < "u") {
			...
			return {
				...
				...(t.status === "fulfilled" && { arch: t.value }),
				...(s.status === "fulfilled" && { pid: s.value }),
			};
		}
	} catch {}
	return n;
...
var _ = { install: h, installSync: g, get: p, getSync: f };
typeof window < "u" &&
	h().catch((r) => {
		(globalThis.__LAND_POLYFILL_TELEMETRY__?.On("polyfill.install", r, {
...
export {
	l as ProcessPolyfill,
	_ as default,
	p as getProcess,
	f as getProcessSync,
	h as installProcessPolyfill,
	g as installProcessPolyfillSync,
};
