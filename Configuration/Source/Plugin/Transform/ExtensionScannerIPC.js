const n="workbench/services/extensions/electron-browser/extensionsScannerService.js".replaceAll("/","\\/"),t=new RegExp(`${n}$`),s=`import { URI } from '../../../../base/common/uri.js';
...
`,r={Kind:"Transform",Name:"ExtensionScannerIPC",Match:({Path:e})=>t.test(e),Transform(){return{Kind:"Rewrite",Source:s}}};var o=r;export{o as default};
