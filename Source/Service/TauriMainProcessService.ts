...
// NOTE: This file is served at runtime from
// /Static/Application/vs/platform/ipc/electron-browser/
// so VS Code type imports use relative paths that resolve against the
// runtime location. At compile-time in Output's ESBuild, these
// @codeeditorland/output imports resolve via package.json exports.
...
// DevLog — inline because this file is deployed standalone (no bundling)
// into /Static/Application/vs/platform/ipc/electron-browser/.
// The full DevLog module can't be co-deployed there.
