export declare function addMatchMediaChangeListener(
	targetWindow: Window,
	query: string | MediaQueryList,
	callback: (this: MediaQueryList, ev: MediaQueryListEvent) => unknown,
): void;
/** A zoom index, e.g. 1, 2, 3 */
export declare function setZoomLevel(
	zoomLevel: number,
	targetWindow: Window,
): void;
...
export declare function setZoomFactor(
	zoomFactor: number,
	targetWindow: Window,
): void;
...
export declare function getWCOTitlebarAreaRect(
	targetWindow: Window,
): DOMRect | undefined;
