...
export declare const registerWindow: (window: CodeWindow) => IDisposable,
	...
	onDidRegisterWindow: event.Event<IRegisteredCodeWindow>,
	onWillUnregisterWindow: event.Event<CodeWindow>,
	onDidUnregisterWindow: event.Event<CodeWindow>;
export declare function clearNode(node: HTMLElement): void;
export declare function addDisposableListener<
...
export declare const addStandardDisposableGenericMouseDownListener: (
	node: HTMLElement,
	handler: (event: any) => void,
	useCapture?: boolean,
) => IDisposable;
export declare const addStandardDisposableGenericMouseUpListener: (
	node: HTMLElement,
	handler: (event: any) => void,
	useCapture?: boolean,
) => IDisposable;
export declare function addDisposableGenericMouseDownListener(
	node: EventTarget,
	handler: (event: any) => void,
	useCapture?: boolean,
): IDisposable;
export declare function addDisposableGenericMouseMoveListener(
	node: EventTarget,
	handler: (event: any) => void,
	useCapture?: boolean,
): IDisposable;
export declare function addDisposableGenericMouseUpListener(
	node: EventTarget,
	handler: (event: any) => void,
	useCapture?: boolean,
): IDisposable;
 ...
 */
export declare function runWhenWindowIdle(
 ...
 */
export declare let runAtThisOrScheduleAtNextAnimationFrame: (
	targetWindow: Window,
	runner: () => void,
	priority?: number,
) => IDisposable;
 ...
 */
export declare let scheduleAtNextAnimationFrame: (
	targetWindow: Window,
	runner: () => void,
	priority?: number,
) => IDisposable;
export declare function disposableWindowInterval(
	targetWindow: Window,
	handler: () => void | boolean | Promise<unknown>,
	interval: number,
	iterations?: number,
): IDisposable;
...
export declare function addDisposableThrottledListener<
	R,
...
export declare function getClientArea(
	element: HTMLElement,
 ...
 */
export declare function getDomNodePagePosition(
	domNode: HTMLElement,
...
export declare function getLargestChildWidth(
	parent: HTMLElement,
 ...
 */
export declare function setParentFlowTo(
 ...
 */
export declare function isAncestorUsingFlowTo(
	testChild: Node,
	testAncestor: Node,
): boolean;
export declare function findParentWithClass(
	node: HTMLElement,
	clazz: string,
	stopAtClazzOrNode?: string | HTMLElement,
): HTMLElement | null;
export declare function hasParentWithClass(
	node: HTMLElement,
	clazz: string,
	stopAtClazzOrNode?: string | HTMLElement,
): boolean;
...
export declare function cloneGlobalStylesheets(
	targetWindow: Window,
): IDisposable;
...
export declare function createMetaElement(
	container?: HTMLElement,
): HTMLMetaElement;
export declare function createLinkElement(
	container?: HTMLElement,
): HTMLLinkElement;
export declare function createCSSRule(
	selector: string,
	cssText: string,
	style?: HTMLStyleElement,
): void;
export declare function removeCSSRulesContainingSelector(
	ruleName: string,
	style?: HTMLStyleElement,
): void;
...
export declare function restoreParentsScrollTop(
	node: Element,
	state: number[],
): void;
/**
 ...
 */
export declare function trackFocus(
	element: HTMLElement | Window,
): IFocusTracker;
export declare function after<T extends Node>(
	sibling: HTMLElement,
	child: T,
): T;
export declare function append<T extends Node>(
	parent: HTMLElement,
	child: T,
): T;
export declare function append<T extends Node>(
...
export declare function prepend<T extends Node>(
	parent: HTMLElement,
	child: T,
): T;
/**
...
export declare function $<T extends HTMLElement>(
	description: string,
	attrs?: {
		[key: string]: any;
	},
...
export declare function setVisibility(
	visible: boolean,
...
export declare function finalHandler<T extends Event>(
	fn: (event: T) => unknown,
): (event: T) => unknown;
 ...
 */
export declare function computeScreenAwareSize(
	window: Window,
	cssPx: number,
): number;
/**
 ...
 */
export declare function windowOpenWithSuccess(
	url: string,
	noOpener?: boolean,
): boolean;
...
export declare function triggerDownload(
...
export declare function detectFullscreen(
	targetWindow: Window,
 ...
 */
export declare function hookDomPurifyHrefAndSrcSanitizer(
 ...
 */
export declare function safeInnerHtml(
	node: HTMLElement,
	value: string,
...
type TagToRecord<TTag> =
	TagToElementAndId<TTag> extends {
 ...
 * ```
 */
export declare function h<TTag extends string>(
	tag: TTag,
	...
	: never;
export declare function h<TTag extends string, T extends Child[]>(
	tag: TTag,
	children: [...T],
...
export declare function h<TTag extends string, T extends Child[]>(
	...
	: never;
export declare function svgElem<TTag extends string>(
	tag: TTag,
): TagToRecord<TTag> extends infer Y
	? {
			[TKey in keyof Y]: Y[TKey];
	...
	: never;
export declare function svgElem<TTag extends string, T extends Child[]>(
	tag: TTag,
	children: [...T],
): ArrayToObj<T> & TagToRecord<TTag> extends infer Y
	? {
...
export declare function svgElem<TTag extends string, T extends Child[]>(
	...
	: never;
export declare function copyAttributes(
	from: Element,
	to: Element,
	filter?: string[],
): void;
export declare function trackAttributes(
	from: Element,
	to: Element,
	filter?: string[],
): IDisposable;
