 ...
 */
export declare function renderStringAsPlaintext(
	string: IMarkdownString | string,
): any;
/**
 * Strips all markdown from `markdown`. For example `# Header` would be output as `Header`.
 * provide @param withCodeBlocks to retain code blocks
 */
export declare function renderMarkdownAsPlaintext(
	markdown: IMarkdownString,
	withCodeBlocks?: boolean,
): any;
export declare function fillInIncompleteTokens(
