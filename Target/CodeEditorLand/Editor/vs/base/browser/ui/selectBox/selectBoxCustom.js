...
class SelectBoxList extends Disposable {
  ...
  constructSelectDropDown(contextViewProvider) {
    ...
    this.styleElement = domStylesheetsJs.createStyleSheet(
      this.selectDropDownContainer
    );
  ...
  styleList() {
    const background = this.styles.selectBackground ?? "";
    const listBackground = cssJs.asCssValueWithDefault(
  ...
  layoutSelectDropDown(preLayoutPosition) {
    ...
    if (this.selectList) {
      ...
      const verticalPadding = parseFloat(styles.getPropertyValue("--dropdown-padding-top")) + parseFloat(
