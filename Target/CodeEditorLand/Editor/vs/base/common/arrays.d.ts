...
export declare function equals<T>(
 ...
 */
export declare function removeFastWithoutKeepingOrder<T>(
	array: T[],
	index: number,
): void;
/**
 ...
 */
export declare function binarySearch2(
	length: number,
	compareToKey: (index: number) => number,
): number;
type Compare<T> = (a: T, b: T) => number;
export declare function quickSelect<T>(
	nth: number,
	data: T[],
	compare: Compare<T>,
): T;
 ...
 */
export declare function groupAdjacentBy<T>(
	items: Iterable<T>,
	shouldBeGrouped: (item1: T, item2: T) => boolean,
): Iterable<T[]>;
export declare function forEachAdjacent<T>(
	arr: T[],
	f: (item1: T | undefined, item2: T | undefined) => void,
): void;
export declare function forEachWithNeighbors<T>(
	arr: T[],
 ...
 */
export declare function sortedDiff<T>(
 ...
 */
export declare function delta<T>(
	before: ReadonlyArray<T>,
	after: ReadonlyArray<T>,
	compare: (a: T, b: T) => number,
): {
 ...
 * @return The first n elements from array when sorted with compare.
 */
export declare function topAsync<T>(
	array: T[],
	compare: (a: T, b: T) => number,
	n: number,
	batch: number,
 ...
 */
export declare function coalesceInPlace<T>(
 ...
 */
export declare function isNonEmptyArray<T>(
...
export declare function uniqueFilter<T, R>(
	keyFn: (t: T) => R,
): (t: T) => boolean;
export declare function commonPrefixLength<T>(
	one: ReadonlyArray<T>,
...
export declare function index<T>(
	array: ReadonlyArray<T>,
	indexer: (t: T) => string,
): {
	[key: string]: T;
};
export declare function index<T, R>(
	array: ReadonlyArray<T>,
	indexer: (t: T) => string,
	mapper: (t: T) => R,
): {
 ...
 */
export declare function arrayInsert<T>(
	target: T[],
	insertIndex: number,
	insertArr: T[],
): T[];
...
export declare function mapArrayOrNot<T, U>(
	items: T | T[],
	fn: (_: T) => U,
): U | U[];
 ...
 */
export declare function insertInto<T>(
	array: T[],
	start: number,
	newItems: T[],
): void;
 ...
 */
export declare function splice<T>(
	array: T[],
	start: number,
	deleteCount: number,
	newItems: T[],
...
export declare function compareBy<TItem, TCompareBy>(
	selector: (item: TItem) => TCompareBy,
	comparator: Comparator<TCompareBy>,
): Comparator<TItem>;
export declare function tieBreakComparators<TItem>(
...
export declare function reverseOrder<TItem>(
...
export declare class Permutation {
	 ...
	 */
	static createSortPermutation<T>(
		arr: readonly T[],
 ...
 */
export declare function findAsync<T>(
	array: readonly T[],
