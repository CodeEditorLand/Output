...
export declare function createCancelablePromise<T>(
 ...
 */
export declare function raceCancellation<T>(
	promise: Promise<T>,
 ...
 */
export declare function raceCancellationError<T>(
	promise: Promise<T>,
	token: CancellationToken,
): Promise<T>;
/**
 ...
 */
export declare function raceCancellablePromises<T>(
	cancellablePromises: CancelablePromise<T>[],
): Promise<T>;
export declare function raceTimeout<T>(
	promise: Promise<T>,
	timeout: number,
	onTimeout?: () => void,
): Promise<T | undefined>;
export declare function asPromise<T>(
 ...
 * }
 */
export declare function disposableTimeout(
	handler: () => void,
	timeout?: number,
 ...
 */
export declare function firstParallel<T>(
	promiseList: Promise<T>[],
	shouldStop?: (t: T) => boolean,
	defaultValue?: T | null,
): Promise<T | null>;
export declare function firstParallel<T, R extends T>(
	promiseList: Promise<T>[],
 ...
 * context
 */
export declare let runWhenGlobalIdle: (
	callback: (idle: IdleDeadline) => void,
	timeout?: number,
) => IDisposable;
export declare let _runWhenIdle: (
...
export declare class CancelableAsyncIterableObject<
	T,
> extends AsyncIterableObject<T> {
...
export declare function createCancelableAsyncIterable<T>(
