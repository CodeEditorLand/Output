...
export declare class VSBuffer {
	...
	set(
		array: VSBuffer | Uint8Array | ArrayBuffer | ArrayBufferView,
		offset?: number,
	): void;
 ...
 */
export declare function binaryIndexOf(
	haystack: Uint8Array,
	needle: Uint8Array,
	offset?: number,
): number;
export declare function readUInt16LE(
	source: Uint8Array,
	offset: number,
): number;
export declare function writeUInt16LE(
	destination: Uint8Array,
	value: number,
	offset: number,
): void;
export declare function readUInt32BE(
	source: Uint8Array,
	offset: number,
): number;
export declare function writeUInt32BE(
	destination: Uint8Array,
	value: number,
	offset: number,
): void;
export declare function readUInt32LE(
	source: Uint8Array,
	offset: number,
): number;
export declare function writeUInt32LE(
	destination: Uint8Array,
	value: number,
	offset: number,
): void;
export declare function readUInt8(source: Uint8Array, offset: number): number;
export declare function writeUInt8(
	destination: Uint8Array,
	value: number,
	offset: number,
): void;
...
export interface VSBufferReadableStream
	extends streams.ReadableStream<VSBuffer> {}
export interface VSBufferWriteableStream
	extends streams.WriteableStream<VSBuffer> {}
export interface VSBufferReadableBufferedStream
	extends streams.ReadableBufferedStream<VSBuffer> {}
...
export declare function bufferedStreamToBuffer(
...
export declare function streamToBufferReadableStream(
	stream: streams.ReadableStreamEvents<Uint8Array | string>,
): streams.ReadableStream<VSBuffer>;
export declare function newWriteableBufferStream(
	options?: streams.WriteableStreamOptions,
): streams.WriteableStream<VSBuffer>;
export declare function prefixedBufferReadable(
	prefix: VSBuffer,
	readable: VSBufferReadable,
): VSBufferReadable;
export declare function prefixedBufferStream(
	prefix: VSBuffer,
