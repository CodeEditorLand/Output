...
/** @skipMangle */
export declare function setUnexpectedErrorHandler(
	newUnexpectedErrorHandler: (e: any) => void,
): void;
/**
...
export declare function transformErrorForSerialization(
	error: Error,
): SerializedError;
export declare function transformErrorForSerialization(error: any): any;
export declare function transformErrorFromSerialization(
