...
export declare namespace Event {
	 ...
	 */
	function fromNodeEventEmitter<T>(
	 ...
	 */
	function fromDOMEventEmitter<T>(
...
export declare class DynamicListEventMultiplexer<TItem, TEventType>
...
export declare class ValueWithChangeEvent<T>
 ...
 */
export declare function trackSetChanges<T>(
