...
export declare function matchesContiguousSubString(
	word: string,
	wordToMatchAgainst: string,
): IMatch[] | null;
export declare function matchesSubString(
	word: string,
	wordToMatchAgainst: string,
): IMatch[] | null;
export declare function isUpper(code: number): boolean;
export declare function matchesCamelCase(
	word: string,
	camelCaseWord: string,
): IMatch[] | null;
export declare function matchesWords(
	word: string,
	target: string,
	contiguous?: boolean,
): IMatch[] | null;
export declare function matchesFuzzy(
	word: string,
	wordToMatchAgainst: string,
 ...
 */
export declare function matchesFuzzy2(
	pattern: string,
	word: string,
): IMatch[] | null;
export declare function anyScore(
	pattern: string,
	lowPattern: string,
	patternPos: number,
	word: string,
...
export declare function isPatternInWord(
	patternLow: string,
	patternPos: number,
	patternLen: number,
	wordLow: string,
...
export declare function fuzzyScore(
	pattern: string,
	patternLow: string,
	patternStart: number,
	word: string,
...
export declare function fuzzyScoreGracefulAggressive(
	pattern: string,
	lowPattern: string,
	patternPos: number,
	word: string,
...
export declare function fuzzyScoreGraceful(
	pattern: string,
	lowPattern: string,
	patternPos: number,
	word: string,
