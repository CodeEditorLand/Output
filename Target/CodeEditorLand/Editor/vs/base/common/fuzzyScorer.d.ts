...
export declare function scoreFuzzy(
	target: string,
	query: string,
	queryLower: string,
...
export declare function scoreFuzzy2(
	target: string,
...
export declare function scoreItemFuzzy<T>(
	item: T,
...
export declare function compareItemsByFuzzyScore<T>(
	itemA: T,
	itemB: T,
	query: IPreparedQuery,
	allowNonContiguousMatches: boolean,
...
export declare function pieceToQuery(
	piece: IPreparedQueryPiece,
): IPreparedQuery;
export declare function pieceToQuery(
	pieces: IPreparedQueryPiece[],
): IPreparedQuery;
