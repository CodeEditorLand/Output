...
export declare function splitGlobAware(
	pattern: string,
	splitChar: string,
): string[];
...
export declare function isRelativePattern(
	obj: unknown,
): obj is IRelativePattern;
export declare function getBasenameTerms(
	patternOrExpression: ParsedPattern | ParsedExpression,
): string[];
export declare function getPathTerms(
	patternOrExpression: ParsedPattern | ParsedExpression,
): string[];
export declare function patternsEquals(
