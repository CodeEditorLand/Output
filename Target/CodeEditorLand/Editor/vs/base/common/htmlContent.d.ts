...
export declare class MarkdownString implements IMarkdownString {
	...
	appendText(
		value: string,
		newlineStyle?: MarkdownStringTextNewlineStyle,
	): MarkdownString;
...
export declare function isEmptyMarkdownString(
...
export declare function markdownStringEqual(
	a: IMarkdownString,
	b: IMarkdownString,
): boolean;
 ...
 */
export declare function appendEscapedMarkdownCodeBlockFence(
	code: string,
	langId: string,
): string;
