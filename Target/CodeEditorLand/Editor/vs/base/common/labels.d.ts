...
export declare function getPathLabel(
	resource: URI,
	formatting: IPathLabelFormatting,
): string;
export declare function normalizeDriveLetter(
	path: string,
	isWindowsOS?: boolean,
): string;
export declare function tildify(
	path: string,
	userHome: string,
	os?: OperatingSystem,
): string;
 ...
 */
export declare function mnemonicMenuLabel(
	label: string,
 ...
 * -   macOS: Unsupported (replace && with empty string)
 */
export declare function mnemonicButtonLabel(
	label: string,
	forceDisableMnemonics?: boolean,
): string;
