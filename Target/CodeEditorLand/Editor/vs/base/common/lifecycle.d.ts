...
export declare function setDisposableTracker(
	tracker: IDisposableTracker | null,
): void;
 ...
 */
export declare function isDisposable<E extends any>(
	thing: E,
...
export declare function dispose<T extends IDisposable>(
...
export declare function disposeIfDisposable<T extends IDisposable | object>(
	disposables: Array<T>,
): Array<T>;
/**
 * Combine multiple disposable values into a single {@link IDisposable}.
 */
export declare function combinedDisposable(
 ...
 */
export declare class MutableDisposable<T extends IDisposable>
 ...
 */
export declare class MandatoryMutableDisposable<T extends IDisposable>
	implements IDisposable
{
...
export declare function disposeOnReturn(
	fn: (store: DisposableStore) => void,
): void;
/**
 * A map the manages the lifecycle of the values that it stores.
 */
export declare class DisposableMap<K, V extends IDisposable = IDisposable>
	implements IDisposable
{
