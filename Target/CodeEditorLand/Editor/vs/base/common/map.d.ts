...
export declare function mapsStrictEqualIgnoreOrder(
 ...
 */
export declare class TwoKeyMap<
 ...
 * where creating a composite key whenever the data is accessed is too expensive.
 */
export declare class ThreeKeyMap<
	TFirst extends string | number,
	TSecond extends string | number,
...
> {
	private _data;
	set(first: TFirst, second: TSecond, third: TThird, value: TValue): void;
	get(first: TFirst, second: TSecond, third: TThird): TValue | undefined;
	clear(): void;
	values(): IterableIterator<TValue>;
}
/**
 ...
 * where creating a composite key whenever the data is accessed is too expensive.
 */
export declare class FourKeyMap<
	TFirst extends string | number,
	TSecond extends string | number,
	TThird extends string | number,
