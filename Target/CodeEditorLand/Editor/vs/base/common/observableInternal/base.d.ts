...
export declare function _setRecomputeInitiallyAndOnChange(
	recomputeInitiallyAndOnChange: typeof _recomputeInitiallyAndOnChange,
): void;
declare let _keepObserved: typeof keepObserved;
export declare function _setKeepObserved(
	keepObserved: typeof _keepObserved,
): void;
...
export declare abstract class ConvenientObservable<T, TChange>
 ...
 */
export declare function subtransaction(
 ...
 */
export declare function observableValue<T, TChange = void>(
	name: string,
	initialValue: T,
...
export declare class ObservableValue<T, TChange = void>
 ...
 */
export declare function disposableObservableValue<
...
export declare class DisposableObservableValue<
		T extends IDisposable | undefined,
		TChange = void,
	>
