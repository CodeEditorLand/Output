 ...
 * @see derived
 */
export declare function derivedHandleChanges<T, TChangeSummary>(
	options: IDebugNameData & {
...
export declare function derivedWithStore<T>(
...
export declare function derivedDisposable<T extends IDisposable | undefined>(
	computeFn: (reader: IReader) => T,
): IObservable<T>;
export declare function derivedDisposable<T extends IDisposable | undefined>(
	owner: DebugOwner,
...
export declare class Derived<T, TChangeSummary = any>
	...
	implements IReader, IObserver
{
	...
	constructor(
		...
		_computeFn: (reader: IReader, changeSummary: TChangeSummary) => T,
		createChangeSummary: (() => TChangeSummary) | undefined,
		_handleChange:
			| ((context: IChangeContext, summary: TChangeSummary) => boolean)
			| undefined,
		_handleLastObserverRemoved: (() => void) | undefined,
...
export declare class DerivedWithSetter<T, TChangeSummary = any>
	...
	implements ISettableObservable<T>
{
	...
	constructor(
		...
		handleChange:
			| ((context: IChangeContext, summary: TChangeSummary) => boolean)
			| undefined,
		handleLastObserverRemoved: (() => void) | undefined,
