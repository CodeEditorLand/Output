...
export declare function observableFromPromise<T>(
	promise: Promise<T>,
): IObservable<{
	value?: T;
}>;
export declare function observableFromEvent<T, TArgs = unknown>(
	owner: DebugOwner,
	event: Event<TArgs>,
...
export declare function observableFromEventOpts<T, TArgs = unknown>(
...
export declare class FromEventObservable<TArgs, T> extends BaseObservable<T> {
	...
	constructor(
		...
		event: Event<TArgs>,
		_getValue: (args: TArgs | undefined) => T,
		_getTransaction: () => ITransaction | undefined,
		_equalityComparator: EqualityComparer<T>,
	);
 ...
 */
export declare function observableSignal<TDelta = void>(
	debugName: string,
...
export declare function signalFromObservable<T>(
 ...
 */
export declare function debouncedObservable<T>(
	observable: IObservable<T>,
	debounceMs: number,
 ...
 */
export declare function debouncedObservable2<T>(
	observable: IObservable<T>,
	debounceMs: number,
): IObservable<T>;
export declare function wasEventTriggeredRecently(
	event: Event<any>,
	timeoutMs: number,
	disposableStore: DisposableStore,
): IObservable<boolean>;
 ...
 */
export declare function keepObserved<T>(
	observable: IObservable<T>,
): IDisposable;
/**
 * This converts the given observable into an autorun.
 */
export declare function recomputeInitiallyAndOnChange<T>(
	observable: IObservable<T>,
...
export declare class KeepAliveObserver implements IObserver {
	...
	constructor(
		...
		_handleValue: ((value: any) => void) | undefined,
	);
...
export declare function derivedObservableWithCache<T>(
	owner: DebugOwner,
	computeFn: (reader: IReader, lastValue: T | undefined) => T,
): IObservable<T>;
export declare function derivedObservableWithWritableCache<T>(
	owner: object,
	computeFn: (reader: IReader, lastValue: T | undefined) => T,
): IObservable<T> & {
 ...
 */
export declare function mapObservableArrayCached<TIn, TOut, TKey = TIn>(
	owner: DebugOwner,
...
export declare class ValueWithChangeEventFromObservable<T>
...
export declare function observableFromValueWithChangeEvent<T>(
	owner: DebugOwner,
 ...
 */
export declare function latestChangedValue<T extends IObservable<any>[]>(
	owner: DebugOwner,
	observables: T,
 ...
 */
export declare function derivedConstOnceDefined<T>(
	owner: DebugOwner,
	fn: (reader: IReader) => T,
): IObservable<T | undefined>;
type RemoveUndefined<T> = T extends undefined ? never : T;
export declare function runOnChange<T, TChange>(
	observable: IObservable<T, TChange>,
	cb: (
		value: T,
...
export declare function runOnChangeWithStore<T, TChange>(
	observable: IObservable<T, TChange>,
	cb: (
		value: T,
		previousValue: undefined | T,
