...
export declare const isEqualOrParent: (
	base: URI,
	parentCandidate: URI,
	ignoreFragment?: boolean,
) => boolean;
export declare const getComparisonKey: (
	uri: URI,
	ignoreFragment?: boolean,
) => string;
...
export declare const isEqualAuthority: (
	a1: string | undefined,
	a2: string | undefined,
) => boolean;
export declare const hasTrailingPathSeparator: (
	resource: URI,
	sep?: string,
) => boolean;
export declare const removeTrailingPathSeparator: (
	resource: URI,
	sep?: string,
) => URI;
export declare const addTrailingPathSeparator: (
	resource: URI,
	sep?: string,
) => URI;
export declare function distinctParents<T>(
	items: T[],
...
export declare function toLocalResource(
	resource: URI,
