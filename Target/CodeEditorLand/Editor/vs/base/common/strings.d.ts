 ...
 */
export declare function format2(
	template: string,
 ...
 */
export declare function getLeadingWhitespace(
	str: string,
	start?: number,
	end?: number,
): string;
 ...
 * If string is empty or contains only whitespaces, returns -1
 */
export declare function lastNonWhitespaceIndex(
	str: string,
	startIndex?: number,
): number;
...
export declare function compareSubstringIgnoreCase(
	a: string,
	b: string,
	aStart?: number,
	aEnd?: number,
...
export declare function startsWithIgnoreCase(
	str: string,
	candidate: string,
): boolean;
/**
 ...
 * See http://en.wikipedia.org/wiki/Surrogate_pair
 */
export declare function computeCodePoint(
 ...
 */
export declare function getNextCodePoint(
	str: string,
	len: number,
	offset: number,
): number;
...
export declare function nextCharLength(
	str: string,
	initialOffset: number,
): number;
export declare function prevCharLength(
	str: string,
	initialOffset: number,
): number;
export declare function getCharContainingOffset(
	str: string,
	offset: number,
): [number, number];
...
export declare function containsUppercaseCharacter(
	target: string,
	ignoreEscapedChars?: boolean,
): boolean;
...
export declare function getGraphemeBreakType(
	codePoint: number,
): GraphemeBreakType;
 ...
 */
export declare function getLeftDeleteOffset(
	offset: number,
	str: string,
): number;
