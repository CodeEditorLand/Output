...
export declare function transformOutgoingURIs<T>(
	obj: T,
	transformer: IURITransformer,
): T;
export declare function transformIncomingURIs<T>(
	obj: T,
	transformer: IURITransformer,
): T;
export declare function transformAndReviveIncomingURIs<T>(
	obj: T,
	transformer: IURITransformer,
): T;
