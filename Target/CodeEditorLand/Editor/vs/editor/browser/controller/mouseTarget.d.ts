...
export declare class PointerHandlerLastRenderData {
	...
	constructor(
		...
		lastTextareaPosition: Position | null,
	);
}
export declare class MouseTarget {
	...
	static createContentWidget(
		element: HTMLElement | null,
		mouseColumn: number,
		detail: string,
	): IMouseTargetContentWidget;
	static createScrollbar(
		element: HTMLElement | null,
		mouseColumn: number,
		position: Position,
	): IMouseTargetScrollbar;
	static createOverlayWidget(
		element: HTMLElement | null,
		mouseColumn: number,
		detail: string,
	): IMouseTargetOverlayWidget;
	static createOutsideEditor(
		mouseColumn: number,
		position: Position,
