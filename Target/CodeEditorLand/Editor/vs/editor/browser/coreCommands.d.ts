...
export declare namespace CoreNavigationCommands {
	...
	type EditorScrollCommandOptions = EditorScroll_.RawArguments &
		BaseCommandOptions;
	class EditorScrollImpl extends CoreEditorCommand<EditorScrollCommandOptions> {
		constructor();
		determineScrollMethod(
	...
	type RevealLineCommandOptions = RevealLine_.RawArguments &
		BaseCommandOptions;
...
export declare namespace CoreEditingCommands {
	abstract class CoreEditingCommand extends EditorCommand {
		...
		abstract runCoreEditingCommand(
			editor: ICodeEditor,
			viewModel: IViewModel,
			args: unknown,
		): void;
