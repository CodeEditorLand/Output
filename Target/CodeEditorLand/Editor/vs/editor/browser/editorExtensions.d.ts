...
export declare abstract class EditorCommand extends Command {
	 ...
	 */
	static bindToContribution<T extends IEditorContribution>(
		controllerGetter: (editor: ICodeEditor) => T | null,
	): EditorControllerCommand<T>;
	static runEditorCommand(
		accessor: ServicesAccessor,
		args: any,
		precondition: ContextKeyExpression | undefined,
		runner: (
...
export declare function registerModelAndPositionCommand(
	id: string,
	handler: (
		accessor: ServicesAccessor,
		model: ITextModel,
...
export declare function registerEditorCommand<T extends EditorCommand>(
	editorCommand: T,
): T;
export declare function registerEditorAction<T extends EditorAction>(ctor: {
	new (): T;
}): T;
export declare function registerMultiEditorAction<T extends MultiEditorAction>(
	action: T,
): T;
export declare function registerInstantiatedEditorAction(
 ...
 */
export declare function registerEditorContribution<
 ...
 */
export declare function registerDiffEditorContribution<
	Services extends BrandedService[],
>(
	id: string,
	ctor: {
...
export declare namespace EditorExtensionsRegistry {
	...
	function getSomeEditorContributions(
		ids: string[],
