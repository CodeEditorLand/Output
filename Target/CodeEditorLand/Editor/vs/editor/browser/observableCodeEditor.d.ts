 ...
 */
export declare function observableCodeEditor(
	editor: ICodeEditor,
...
export declare class ObservableCodeEditor extends Disposable {
	...
	readonly value: import("../../base/common/observable.js").ISettableObservable<
		string,
		void
	>;
	...
	readonly layoutInfo: IObservable<
		import("../common/config/editorOptions.js").EditorLayoutInfo,
		unknown
	>;
