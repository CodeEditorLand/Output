 ...
 * @internal
 */
declare abstract class BaseEditorOption<K extends EditorOption, T, V>
 ...
 * @internal
 */
declare abstract class ComputedEditorOption<K extends EditorOption, V>
	implements IEditorOption<K, V>
{
	readonly id: K;
 ...
 * @internal
 */
export declare function clampedInt<T>(
	value: any,
	defaultValue: T,
	minimum: number,
	maximum: number,
 ...
 * @internal
 */
export declare function clampedFloat<T extends number>(
	value: any,
	defaultValue: T,
	minimum: number,
	maximum: number,
 ...
 * @internal
 */
export declare function stringSet<T>(
	value: T | undefined,
	defaultValue: T,
 ...
 * @internal
 */
export declare function cursorBlinkingStyleFromString(
 ...
 * @internal
 */
export declare function cursorStyleToString(
 ...
 * @internal
 */
export declare function cursorStyleFromString(
	cursorStyle:
		| "line"
		| "block"
		| "underline"
 ...
 * @internal
 */
export declare class EditorFontLigatures extends BaseEditorOption<
 ...
 * @internal
 */
export declare class EditorFontVariations extends BaseEditorOption<
 ...
 * @internal
 */
export declare class EditorLayoutInfoComputer extends ComputedEditorOption<
 ...
 * @internal
 */
export declare function filterValidationDecorations(
	options: IComputedEditorOptions,
): boolean;
...
export declare const EditorOptions: {
	...
	>;
	experimentalEditContextEnabled: IEditorOption<
