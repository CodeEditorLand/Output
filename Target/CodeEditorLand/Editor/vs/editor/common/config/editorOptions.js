...
class EditorClassName extends ComputedEditorOption {
  ...
  compute(env, options, _) {
    ...
    if (options.get(115 /* showUnused */)) {
      classNames.push("showUnused");
    }
    if (options.get(144 /* showDeprecated */)) {
...
class EditorLayoutInfoComputer extends ComputedEditorOption {
  ...
  static computeLayout(options, env) {
    ...
    const wordWrapOverride2 = options.get(141 /* wordWrapOverride2 */);
    const wordWrapOverride1 = wordWrapOverride2 === "inherit" ? options.get(140 /* wordWrapOverride1 */) : wordWrapOverride2;
    const wordWrap = wordWrapOverride1 === "inherit" ? options.get(136 /* wordWrap */) : wordWrapOverride1;
    const wordWrapColumn = options.get(139 /* wordWrapColumn */);
    ...
    const scrollBeyondLastLine = options.get(109 /* scrollBeyondLastLine */);
    const padding = options.get(87 /* padding */);
    const minimap = options.get(75 /* minimap */);
    const scrollbar = options.get(107 /* scrollbar */);
    const verticalScrollbarWidth = scrollbar.verticalScrollbarSize;
    const verticalScrollbarHasArrows = scrollbar.verticalHasArrows;
    const scrollbarArrowSize = scrollbar.arrowSize;
    const horizontalScrollbarHeight = scrollbar.horizontalScrollbarSize;
    const folding = options.get(45 /* folding */);
    const showFoldingDecoration = options.get(114 /* showFoldingControls */) !== "never";
...
class PlaceholderOption extends BaseEditorOption {
  ...
  constructor() {
    super(91 /* placeholder */, "placeholder", void 0);
  }
  validate(input) {
    if (typeof input === "undefined") {
      return this.defaultValue;
...
class EditorQuickSuggestions extends BaseEditorOption {
  ...
  constructor() {
    ...
    super(93 /* quickSuggestions */, "quickSuggestions", defaults, {
      type: "object",
...
function filterValidationDecorations(options) {
  const renderValidationDecorations = options.get(102 /* renderValidationDecorations */);
  if (renderValidationDecorations === "editable") {
    return options.get(95 /* readOnly */);
  }
...
class EditorWrappingInfoComputer extends ComputedEditorOption {
  ...
  constructor() {
    super(150 /* wrappingInfo */);
  }
  compute(env, options, _) {
    const layoutInfo = options.get(149 /* layoutInfo */);
    return {
      isDominatedByLongLines: env.isDominatedByLongLines,
...
const EditorOptions = {
  ...
  colorDecoratorActivatedOn: register(new EditorStringEnumOption(152 /* colorDecoratorsActivatedOn */, "colorDecoratorsActivatedOn", "clickAndHover", ["clickAndHover", "hover", "click"], {
    enumDescriptions: [
  ...
  renderLineHighlightOnlyWhenFocus: register(new EditorBooleanOption(
    101 /* renderLineHighlightOnlyWhenFocus */,
  ...
  renderValidationDecorations: register(new EditorStringEnumOption(
    102 /* renderValidationDecorations */,
    "renderValidationDecorations",
    "editable",
    ["editable", "on", "off"]
  )),
  renderWhitespace: register(new EditorStringEnumOption(
    103 /* renderWhitespace */,
    "renderWhitespace",
    "selection",
  ...
  revealHorizontalRightPadding: register(new EditorIntOption(
    104 /* revealHorizontalRightPadding */,
  ...
  scrollBeyondLastLine: register(new EditorBooleanOption(
    109 /* scrollBeyondLastLine */,
    "scrollBeyondLastLine",
    true,
    { description: nls.localize("scrollBeyondLastLine", "Controls whether the editor will scroll beyond the last line.") }
  )),
  scrollPredominantAxis: register(new EditorBooleanOption(
    110 /* scrollPredominantAxis */,
  ...
  suggestOnTriggerCharacters: register(new EditorBooleanOption(
    125 /* suggestOnTriggerCharacters */,
