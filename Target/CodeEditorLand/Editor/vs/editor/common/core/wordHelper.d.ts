...
export declare function ensureValidWordDefinition(
...
export declare function setDefaultGetWordAtTextConfig(
	value: IGetWordAtTextConfig,
): import("../../../base/common/lifecycle.js").IDisposable;
export declare function getWordAtText(
	column: number,
