...
export declare class CursorMoveCommands {
	...
	static expandLineSelection(
		viewModel: IViewModel,
		cursors: CursorState[],
	): PartialCursorState[];
	static moveToBeginningOfBuffer(
		viewModel: IViewModel,
		cursors: CursorState[],
		inSelectionMode: boolean,
	): PartialCursorState[];
	static moveToEndOfBuffer(
		viewModel: IViewModel,
		cursors: CursorState[],
		inSelectionMode: boolean,
	): PartialCursorState[];
	...
	static findPositionInViewportIfOutside(
		viewModel: IViewModel,
		cursor: CursorState,
