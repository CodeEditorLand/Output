...
export declare class AutoClosingOpenCharTypeOperation {
	...
	static getAutoClosingPairClose(
		config: CursorConfiguration,
		model: ITextModel,
		selections: Selection[],
		ch: string,
...
export declare class EnterOperation {
	...
	static lineInsertBefore(
		config: CursorConfiguration,
		model: ITextModel | null,
		selections: Selection[] | null,
	): ICommand[];
	static lineInsertAfter(
		config: CursorConfiguration,
		model: ITextModel | null,
		selections: Selection[] | null,
	): ICommand[];
	static lineBreakInsert(
		config: CursorConfiguration,
		model: ITextModel,
		selections: Selection[],
	): ICommand[];
...
export declare function shiftIndent(
	config: CursorConfiguration,
	indentation: string,
	count?: number,
): string;
export declare function unshiftIndent(
	config: CursorConfiguration,
	indentation: string,
	count?: number,
): string;
export declare function shouldSurroundChar(
	config: CursorConfiguration,
	ch: string,
): boolean;
