...
export declare class TypeOperations {
	...
	static typeWithoutInterceptors(
		prevEditOperationType: EditOperationType,
		config: CursorConfiguration,
		model: ITextModel,
		selections: Selection[],
...
export declare class CompositionOutcome {
	...
	constructor(
		deletedText: string,
		deletedSelectionStart: number,
		deletedSelectionEnd: number,
		insertedText: string,
		insertedSelectionStart: number,
		insertedSelectionEnd: number,
	);
}
