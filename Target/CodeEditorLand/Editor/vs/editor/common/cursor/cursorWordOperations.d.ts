...
export declare class WordOperations {
	...
	static _moveWordPartLeft(
		model: ICursorSimpleModel,
		position: Position,
	): Position;
	static moveWordRight(
		wordSeparators: WordCharacterClassifier,
		model: ICursorSimpleModel,
		position: Position,
		wordNavigationType: WordNavigationType,
	): Position;
	static _moveWordPartRight(
		model: ICursorSimpleModel,
		position: Position,
	): Position;
	...
	static deleteWordLeft(
		ctx: DeleteWordContext,
		wordNavigationType: WordNavigationType,
	): Range | null;
	static deleteInsideWord(
		wordSeparators: WordCharacterClassifier,
		model: ITextModel,
		selection: Selection,
	): Range;
...
export declare class WordPartOperations extends WordOperations {
	...
	static moveWordPartLeft(
		wordSeparators: WordCharacterClassifier,
		model: ICursorSimpleModel,
		position: Position,
		hasMulticursor: boolean,
	): Position;
	static moveWordPartRight(
		wordSeparators: WordCharacterClassifier,
		model: ICursorSimpleModel,
		position: Position,
	): Position;
