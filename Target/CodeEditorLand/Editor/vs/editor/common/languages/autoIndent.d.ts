 ...
 */
export declare function getInheritIndentForLine(
	autoIndent: EditorAutoIndentStrategy,
	model: IVirtualModel,
	lineNumber: number,
	honorIntentialIndent: boolean | undefined,
...
export declare function getGoodIndentForLine(
	autoIndent: EditorAutoIndentStrategy,
...
export declare function getIndentForEnter(
	autoIndent: EditorAutoIndentStrategy,
	model: ITextModel,
	range: Range,
	indentConverter: IIndentConverter,
 ...
 */
export declare function getIndentActionForType(
...
export declare function getIndentMetadata(
	model: ITextModel,
	lineNumber: number,
	languageConfigurationService: ILanguageConfigurationService,
): number | null;
