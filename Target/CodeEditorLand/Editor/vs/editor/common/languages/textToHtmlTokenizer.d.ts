...
export type IReducedTokenizationSupport = Omit<
	...
	"tokenize"
>;
export declare function tokenizeToStringSync(
	languageService: ILanguageService,
	text: string,
	languageId: string,
): string;
export declare function tokenizeToString(
	languageService: ILanguageService,
	text: string,
	languageId: string | null,
): Promise<string>;
export declare function tokenizeLineToHTML(
	text: string,
...
export declare function _tokenizeToString(
	text: string,
