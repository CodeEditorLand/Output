...
export declare class SingleModelEditStackElement
...
export declare class MultiModelEditStackElement
	implements IWorkspaceUndoRedoElement
{
	readonly label: string;
	readonly code: string;
...
export declare function isEditStackElement(
