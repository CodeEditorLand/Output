...
export declare function createTextBufferFactory(
	text: string,
...
export declare function createTextBufferFactoryFromStream(
	stream: ITextStream,
): Promise<model.ITextBufferFactory>;
export declare function createTextBufferFactoryFromStream(
	stream: VSBufferReadableStream,
): Promise<model.ITextBufferFactory>;
export declare function createTextBufferFactoryFromSnapshot(
	snapshot: model.ITextSnapshot,
): model.ITextBufferFactory;
export declare function createTextBuffer(
	...
	implements model.ITextModel, IDecorationsTreesHost
{
	...
	get onDidChangeLanguage(): Event<
		import("../textModelEvents.js").IModelLanguageChangedEvent
	>;
	get onDidChangeLanguageConfiguration(): Event<
		import("../textModelEvents.js").IModelLanguageConfigurationChangedEvent
	>;
	get onDidChangeTokens(): Event<
		import("../textModelEvents.js").IModelTokensChangedEvent
	>;
	...
	constructor(
		...
		associatedResource: (URI | null) | undefined,
	...
	_overwriteInitialUndoRedoSnapshot(
...
export declare class ModelDecorationInjectedTextOptions
...
export declare class ModelDecorationOptions
	implements model.IModelDecorationOptions
{
