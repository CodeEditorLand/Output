...
export declare class TokenizerWithStateStoreAndTextModel<
...
export declare class DefaultBackgroundTokenizer
	implements IBackgroundTokenizer
{
	private readonly _tokenizerWithStateStore;
	private readonly _backgroundTokenStore;
	private _isDisposed;
	constructor(
		_tokenizerWithStateStore: TokenizerWithStateStoreAndTextModel,
		_backgroundTokenStore: IBackgroundTokenizationStore,
	);
	dispose(): void;
	handleChanges(): void;
