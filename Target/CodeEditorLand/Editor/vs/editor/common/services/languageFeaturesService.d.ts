...
export declare class LanguageFeaturesService
	implements ILanguageFeaturesService
{
	...
	readonly hoverProvider: LanguageFeatureRegistry<
		HoverProvider<import("../languages.js").Hover>
	>;
	...
	readonly inlineCompletionsProvider: LanguageFeatureRegistry<
		InlineCompletionsProvider<
			import("../languages.js").InlineCompletions<
				import("../languages.js").InlineCompletion
			>
		>
	>;
	readonly inlineEditProvider: LanguageFeatureRegistry<
		InlineEditProvider<import("../languages.js").IInlineEdit>
	>;
