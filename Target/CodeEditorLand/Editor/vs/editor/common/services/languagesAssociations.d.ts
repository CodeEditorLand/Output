 ...
 */
export declare function registerPlatformLanguageAssociation(
 ...
 */
export declare function registerConfiguredLanguageAssociation(
	association: ILanguageAssociation,
): void;
/**
 ...
 */
export declare function getMimeTypes(
	resource: URI | null,
	firstLine?: string,
): string[];
/**
 * @see `getMimeTypes`
 */
export declare function getLanguageIds(
	resource: URI | null,
	firstLine?: string,
): string[];
