...
export declare class ModelService extends Disposable implements IModelService {
	...
	constructor(
		...
		_resourcePropertiesService: ITextResourcePropertiesService,
...
export declare class DefaultModelSHA1Computer
	implements ITextModelSHA1Computer
{
