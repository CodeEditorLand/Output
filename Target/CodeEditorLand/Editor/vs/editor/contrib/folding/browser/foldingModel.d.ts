 ...
 */
export declare function toggleCollapseState(
 ...
 * @param lineNumbers the location of the regions to collapse or expand, or if not set, all regions in the model.
 */
export declare function setCollapseStateLevelsDown(
	foldingModel: FoldingModel,
	doCollapse: boolean,
	levels?: number,
	lineNumbers?: number[],
 ...
 */
export declare function setCollapseStateLevelsUp(
	foldingModel: FoldingModel,
	doCollapse: boolean,
	levels: number,
	lineNumbers: number[],
 ...
 * @param lineNumbers the location of the regions to collapse or expand.
 */
export declare function setCollapseStateUp(
	foldingModel: FoldingModel,
	doCollapse: boolean,
	lineNumbers: number[],
): void;
 ...
 * @param doCollapse Whether to collapse or expand
 */
export declare function setCollapseStateAtLevel(
	foldingModel: FoldingModel,
	foldLevel: number,
	doCollapse: boolean,
 ...
 */
export declare function setCollapseStateForRest(
	foldingModel: FoldingModel,
	doCollapse: boolean,
	blockedLineNumbers: number[],
): void;
 ...
 */
export declare function setCollapseStateForMatchingLines(
	foldingModel: FoldingModel,
	regExp: RegExp,
	doCollapse: boolean,
): void;
 ...
 * @param foldingModel the folding model
 */
export declare function setCollapseStateForType(
	foldingModel: FoldingModel,
	type: string,
	doCollapse: boolean,
): void;
 ...
 */
export declare function getParentFoldLine(
	lineNumber: number,
	foldingModel: FoldingModel,
): number | null;
/**
 ...
 */
export declare function getPreviousFoldLine(
	lineNumber: number,
	foldingModel: FoldingModel,
): number | null;
/**
 ...
 */
export declare function getNextFoldLine(
	lineNumber: number,
	foldingModel: FoldingModel,
): number | null;
export {};
