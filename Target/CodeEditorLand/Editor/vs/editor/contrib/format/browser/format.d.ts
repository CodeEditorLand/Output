...
export declare function getRealAndSyntheticDocumentFormattersOrdered(
...
export declare function formatDocumentRangesWithSelectedProvider(
...
export declare function formatDocumentRangesWithProvider(
	accessor: ServicesAccessor,
...
export declare function formatDocumentWithSelectedProvider(
	accessor: ServicesAccessor,
	editorOrModel: ITextModel | IActiveCodeEditor,
	mode: FormattingMode,
...
export declare function formatDocumentWithProvider(
	accessor: ServicesAccessor,
...
export declare function getDocumentRangeFormattingEditsUntilResult(
...
export declare function getDocumentFormattingEditsUntilResult(
	workerService: IEditorWorkerService,
	languageFeaturesService: ILanguageFeaturesService,
	model: ITextModel,
	options: FormattingOptions,
...
export declare function getDocumentFormattingEditsWithSelectedProvider(
	workerService: IEditorWorkerService,
	languageFeaturesService: ILanguageFeaturesService,
	editorOrModel: ITextModel | IActiveCodeEditor,
	mode: FormattingMode,
...
export declare function getOnTypeFormattingEdits(
	workerService: IEditorWorkerService,
	languageFeaturesService: ILanguageFeaturesService,
	model: ITextModel,
	position: Position,
