...
export declare class MarkdownHoverParticipant
	implements IEditorHoverParticipant<MarkdownHover>
{
	...
	updateMarkdownHoverVerbosityLevel(
		action: HoverVerbosityAction,
		index: number,
		focus?: boolean,
	): Promise<
...
export declare function renderMarkdownHovers(
	context: IEditorHoverRenderContext,
...
export declare function labelForHoverVerbosityAction(
