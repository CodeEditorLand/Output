...
export declare class InlineCompletionsHintsWidget extends Disposable {
	...
	constructor(
		editor: ICodeEditor,
		model: IObservable<InlineCompletionsModel | undefined>,
		instantiationService: IInstantiationService,
	);
}
export declare class InlineSuggestionHintsContentWidget
	extends Disposable
	implements IContentWidget
{
	...
	constructor(
		editor: ICodeEditor,
		withBorder: boolean,
		_position: IObservable<Position | null>,
		_currentSuggestionIdx: IObservable<number>,
		_suggestionCount: IObservable<number | undefined>,
		_extraCommands: IObservable<Command[]>,
...
export declare class CustomizedMenuWorkbenchToolBar extends WorkbenchToolBar {
	...
	constructor(
		...
		menuId: MenuId,
		options2: IMenuWorkbenchToolBarOptions | undefined,
