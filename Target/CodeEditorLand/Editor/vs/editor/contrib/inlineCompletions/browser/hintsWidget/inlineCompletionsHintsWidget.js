...
let InlineSuggestionHintsContentWidget = class extends Disposable {
  ...
  _warningMessageContentNode = derivedWithStore(
    (reader, store) => {
  ...
  _warningMessageNode = n.div(
    {
      ...
      style: {
        ...
        marginBottom: 4,
        display: derived(
          (reader) => this._warning.read(reader) ? "block" : "none"
        )
      }
    },
  ...
  availableSuggestionCountAction = this._register(
    new Action(
