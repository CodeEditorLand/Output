...
export declare class InlineCompletionsAccessibleView
	implements IAccessibleViewImplentation
{
	...
	): InlineCompletionsAccessibleViewContentProvider | undefined;
}
declare class InlineCompletionsAccessibleViewContentProvider
	extends Disposable
