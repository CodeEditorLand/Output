...
let InlineCompletionsModel = class extends Disposable {
  constructor(textModel, selectedSuggestItem, _textModelVersionId, _positions, _debounceValue, _suggestPreviewEnabled, _suggestPreviewMode, _inlineSuggestMode, _enabled, _inlineEditsEnabled, _shouldHideInlineEdit, _editor, _instantiationService, _commandService, _languageConfigurationService) {
    super();
  ...
  _alwaysShowInlineEdit = observableValue(this, false);
  _resetAlwaysShowInlineEdit = this._register(autorun((reader) => {
    this._primaryPosition.read(reader);
    this._textModelVersionId.read(reader);
    this._alwaysShowInlineEdit.set(false, void 0);
  }));
  ...
  inlineEditAvailable = derived((reader) => {
  ...
  async accept(editor) {
    ...
    this._alwaysShowInlineEdit.set(true, void 0);
  }
