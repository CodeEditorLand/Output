...
export declare class InlineCompletionsSource extends Disposable {
	...
	readonly inlineCompletions: import("../../../../../base/common/observable.js").ISettableObservable<
		UpToDateInlineCompletions | undefined,
		void
	> &
		IDisposable;
	readonly suggestWidgetInlineCompletions: import("../../../../../base/common/observable.js").ISettableObservable<
		UpToDateInlineCompletions | undefined,
		void
	> &
		IDisposable;
	...
	constructor(
		...
		_versionId: IObservable<number | null>,
...
export declare class InlineCompletionWithUpdatedRange {
	...
	constructor(
		...
		decorationId: string,
		_textModel: ITextModel,
		_modelVersion: IObservable<number | null>,
	);
