...
export declare function subtractPositions(
	pos1: Position,
	pos2: Position,
): Position;
export declare function substringPos(text: string, pos: Position): string;
export declare function getEndPositionsAfterApplying(
	edits: readonly SingleTextEdit[],
): Position[];
export declare function convertItemsToStableObservables<T>(
