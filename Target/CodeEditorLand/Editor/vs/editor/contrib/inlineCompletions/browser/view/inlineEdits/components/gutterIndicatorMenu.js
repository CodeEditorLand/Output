...
let GutterIndicatorMenuContent = class {
  ...
  _createHoverContent() {
    const activeElement = observableValue(
      "active",
      void 0
    );
    const createOptionArgs = /* @__PURE__ */ __name((options) => {
      return {
        title: options.title,
        icon: options.icon,
        keybinding: typeof options.commandId === "string" ? this._getKeybinding(
          options.commandArgs ? void 0 : options.commandId
        ) : derived(
          (reader) => typeof options.commandId === "string" ? void 0 : this._getKeybinding(
            options.commandArgs ? void 0 : options.commandId.read(
              reader
            )
          ).read(reader)
        ),
        ...
        onAction: /* @__PURE__ */ __name(() => {
          ...
          return this._commandService.executeCommand(
            typeof options.commandId === "string" ? options.commandId : options.commandId.get(),
            ...options.commandArgs ?? []
          );
        }, "onAction")
      };
    ...
    const gotoAndAccept = option(
      createOptionArgs({
        ...
        icon: this._model.tabAction.map(
    ...
    const toggleCollapsedMode = this._inlineEditsShowCollapsed.map(
      (showCollapsed) => showCollapsed ? option(
        createOptionArgs({
          id: "showExpanded",
          title: localize(
            "showExpanded",
      ...
      [
        ...
        n.div({
          ...
          ref: /* @__PURE__ */ __name((elem) => {
            const keybindingLabel = store.add(
  ...
  return derivedWithStore(
    (_reader, store) => n.div(
      ...
      [
        n.div({
          ref: /* @__PURE__ */ __name((elem) => {
            const actionBar2 = store.add(
              new ActionBar(elem, options)
            );
