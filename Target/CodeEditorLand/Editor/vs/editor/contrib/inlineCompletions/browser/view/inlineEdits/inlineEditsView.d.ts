...
export declare class InlineEditsViewAndDiffProducer extends Disposable {
	...
	static readonly hot: IObservable<
		typeof InlineEditsViewAndDiffProducer,
		unknown
	>;
	...
	constructor(
		_editor: ICodeEditor,
		_edit: IObservable<InlineEdit | undefined>,
...
export declare class InlineEditsView extends Disposable {
	...
	constructor(
		_editor: ICodeEditor,
		_edit: IObservable<InlineEditWithChanges | undefined>,
		_instantiationService: IInstantiationService,
	);
