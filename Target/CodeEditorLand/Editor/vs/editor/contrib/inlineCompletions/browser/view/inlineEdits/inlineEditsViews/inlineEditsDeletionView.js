...
class InlineEditsDeletionView extends Disposable {
  ...
  _editorLayoutInfo = derived(this, (reader) => {
    ...
    const codeRect = Rect.fromLeftTopRightBottom(
      left,
      selectionTop,
      right,
      selectionBottom
  ...
  _originalOverlay = n.div(
    ...
    derived((reader) => {
      const layoutInfoObs = mapOutFalsy(this._editorLayoutInfo).read(
        reader
      );
      if (!layoutInfoObs) {
        return void 0;
      ...
      const overlayRect = derived((reader2) => {
        ...
        return rect.intersectHorizontal(
          new OffsetRange(
            overlayHider.left,
      ...
      return [
        ...
        n.div({
          ...
          style: {
            ...
            borderRadius: `${BORDER_RADIUS}px`,
            border: getOriginalBorderColor(this._tabAction).map(
