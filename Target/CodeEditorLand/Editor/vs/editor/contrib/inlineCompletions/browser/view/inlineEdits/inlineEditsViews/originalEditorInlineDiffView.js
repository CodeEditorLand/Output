...
class OriginalEditorInlineDiffView extends Disposable {
  ...
  isHovered = observableCodeEditor(
  ...
  _tokenizationFinished = modelTokenizationFinished(
          ...
          if (m.original.contains(i2.originalRange.startLineNumber)) {
            ...
            originalDecorations.push({
              ...
              options: {
                ...
                inlineClassName: useInlineDiff ? classNames(
                  "strike-through",
                  "inlineCompletions"
                ) : null,
                zIndex: 1
            ...
            const textSegments = insertedText.length > 3 ? [
              {
                ...
                offsetRange: new OffsetRange(
                  i2.modifiedRange.startColumn - 1,
                  i2.modifiedRange.startColumn
                )
              },
              {
            ...
            for (const {
              ...
              originalDecorations.push({
                range: Range.fromPositions(
                  i2.originalRange.getEndPosition()
                ),
                options: {
                  description: "inserted-text",
                  before: {
                    tokens: lineTokens.getTokensInRange(
                      offsetRange
                    ),
                    content: text,
