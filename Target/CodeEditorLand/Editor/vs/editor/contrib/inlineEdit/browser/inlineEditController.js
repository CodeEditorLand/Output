...
.monaco-editor .inline-edit {
  ...
  _inlineEditEnabled = observableFromEvent(this, this.editor.onDidChangeConfiguration, () => this.editor.getOption(EditorOption.inlineEdit).enabled);
  _enabled = derived(this, (reader) => this._inlineEditEnabled.read(reader) && !this._inlineCompletionInlineEdits.read(reader));
