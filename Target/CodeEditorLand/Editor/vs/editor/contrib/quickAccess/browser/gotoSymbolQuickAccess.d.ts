...
export declare abstract class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
	...
	constructor(
		...
		_outlineModelService: IOutlineModelService,
		options?: IGotoSymbolQuickAccessProviderOptions,
	);
	...
	protected waitForLanguageSymbolRegistry(
		model: ITextModel,
		disposables: DisposableStore,
	): Promise<boolean>;
	private doProvideWithEditorSymbols;
	protected doGetSymbolPicks(
