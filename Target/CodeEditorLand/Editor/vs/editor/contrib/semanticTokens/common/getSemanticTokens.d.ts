...
export declare function isSemanticTokens(
	v: SemanticTokens | SemanticTokensEdits,
): v is SemanticTokens;
export declare function isSemanticTokensEdits(
	v: SemanticTokens | SemanticTokensEdits,
...
export declare function hasDocumentSemanticTokensProvider(
	registry: LanguageFeatureRegistry<DocumentSemanticTokensProvider>,
	model: ITextModel,
): boolean;
export declare function getDocumentSemanticTokens(
	registry: LanguageFeatureRegistry<DocumentSemanticTokensProvider>,
	model: ITextModel,
...
export declare function hasDocumentRangeSemanticTokensProvider(
	providers: LanguageFeatureRegistry<DocumentRangeSemanticTokensProvider>,
	model: ITextModel,
): boolean;
export declare function getDocumentRangeSemanticTokens(
