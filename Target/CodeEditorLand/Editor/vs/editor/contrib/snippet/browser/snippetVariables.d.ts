...
export declare class CompositeSnippetVariableResolver
...
export declare class SelectionBasedVariableResolver
	implements VariableResolver
{
	...
	constructor(
		...
		_selectionIdx: number,
		_overtypingCapturer: OvertypingCapturer | undefined,
	);
	resolve(variable: Variable): string | undefined;
}
...
export declare class ClipboardBasedVariableResolver
	implements VariableResolver
{
	...
	constructor(
		_readClipboardText: IReadClipboardText,
		_selectionIdx: number,
...
export declare class WorkspaceBasedVariableResolver
	implements VariableResolver
{
