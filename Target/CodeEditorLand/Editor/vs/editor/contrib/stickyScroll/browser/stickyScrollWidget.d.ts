...
declare class RenderedStickyLine {
	...
	constructor(
		index: number,
		lineNumber: number,
		lineDomNode: HTMLElement,
		lineNumberDomNode: HTMLElement,
		foldingIcon: StickyFoldingIcon | undefined,
