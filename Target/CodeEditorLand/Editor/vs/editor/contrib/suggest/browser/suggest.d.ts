...
export declare class CompletionItem {
	...
	constructor(
		...
		container: languages.CompletionList,
...
export declare class CompletionOptions {
	...
	constructor(
		...
		providerItemsToReuse?: ReadonlyMap<
			languages.CompletionItemProvider,
			CompletionItem[]
		>,
...
export declare function getSnippetSuggestSupport():
	| languages.CompletionItemProvider
	| undefined;
export declare function setSnippetSuggestSupport(
...
export declare function provideSuggestionItems(
...
export declare function getSuggestionComparator(
	snippetConfig: SnippetSortOrder,
): (a: CompletionItem, b: CompletionItem) => number;
export declare function showSimpleSuggestions(
	editor: ICodeEditor,
	provider: languages.CompletionItemProvider,
): void;
