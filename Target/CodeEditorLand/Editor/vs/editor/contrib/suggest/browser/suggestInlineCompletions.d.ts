...
declare class SuggestInlineCompletion implements InlineCompletion {
	...
	constructor(
		...
		filterText: string,
		additionalTextEdits: ISingleEditOperation[] | undefined,
		command: Command | undefined,
		completion: CompletionItem,
	);
}
declare class InlineCompletionResults
	...
	implements InlineCompletions<SuggestInlineCompletion>
{
	...
	constructor(
		...
		_suggestMemoryService: ISuggestMemoryService,
	);
	canBeReused(
		model: ITextModel,
		line: number,
...
export declare class SuggestInlineCompletions
	extends Disposable
	implements InlineCompletionsProvider<InlineCompletionResults>
{
	...
	private _lastResult?;
	constructor(
		_languageFeatureService: ILanguageFeaturesService,
