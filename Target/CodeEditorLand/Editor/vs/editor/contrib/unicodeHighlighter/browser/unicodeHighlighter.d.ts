...
export declare class UnicodeHighlighter
	extends Disposable
	implements IEditorContribution
{
	...
	constructor(
		_editor: ICodeEditor,
		_editorWorkerService: IEditorWorkerService,
		_workspaceTrustService: IWorkspaceTrustManagementService,
...
export declare class UnicodeHighlighterHover implements IHoverPart {
	...
	constructor(
		owner: IEditorHoverParticipant<UnicodeHighlighterHover>,
		range: Range,
		decoration: IModelDecoration,
	);
	isValidForHoverAnchor(anchor: HoverAnchor): boolean;
}
export declare class UnicodeHighlighterHoverParticipant
...
export declare class DisableHighlightingInCommentsAction
...
export declare class DisableHighlightingInStringsAction
	extends EditorAction
	implements IDisableUnicodeHighlightAction
{
	static ID: string;
...
export declare class DisableHighlightingOfAmbiguousCharactersAction
	extends EditorAction
	implements IDisableUnicodeHighlightAction
{
	static ID: string;
...
export declare class DisableHighlightingOfInvisibleCharactersAction
	extends EditorAction
	implements IDisableUnicodeHighlightAction
{
	static ID: string;
...
export declare class DisableHighlightingOfNonBasicAsciiCharactersAction
	extends EditorAction
	implements IDisableUnicodeHighlightAction
{
	static ID: string;
