 ...
 */
export declare class StandaloneCodeEditor
...
export declare class StandaloneEditor
...
export declare class StandaloneDiffEditor2
 ...
 * @internal
 */
export declare function createTextModel(
	modelService: IModelService,
	languageService: ILanguageService,
	value: string,
