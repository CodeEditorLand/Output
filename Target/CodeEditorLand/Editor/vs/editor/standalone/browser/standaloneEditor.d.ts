 ...
 * @event
 */
export declare function onDidCreateEditor(
 ...
 * @event
 */
export declare function onDidCreateDiffEditor(
 ...
 * The editor will read the size of `domElement`.
 */
export declare function createDiffEditor(
	domElement: HTMLElement,
	options?: IStandaloneDiffEditorConstructionOptions,
	override?: IEditorOverrideServices,
): IStandaloneDiffEditor;
export declare function createMultiFileDiffEditor(
	domElement: HTMLElement,
	override?: IEditorOverrideServices,
 ...
 */
export declare function addEditorAction(
 ...
 */
export declare function addKeybindingRules(
 ...
 */
export declare function setModelLanguage(
	model: ITextModel,
 ...
 */
export declare function setModelMarkers(
	model: ITextModel,
	owner: string,
	markers: IMarkerData[],
): void;
 ...
 * @event
 */
export declare function onDidChangeMarkers(
 ...
 * @event
 */
export declare function onDidCreateModel(
 ...
 * @event
 */
export declare function onWillDisposeModel(
	listener: (model: ITextModel) => void,
): IDisposable;
/**
 ...
 * @event
 */
export declare function onDidChangeModelLanguage(
	listener: (e: {
 ...
 */
export declare function createWebWorker<T extends object>(
	opts: IWebWorkerOptions,
): MonacoWebWorker<T>;
/**
 * Colorize the contents of `domNode` using attribute `data-lang`.
 */
export declare function colorizeElement(
	domNode: HTMLElement,
 ...
 */
export declare function colorizeModelLine(
	model: ITextModel,
	lineNumber: number,
	tabSize?: number,
): string;
 ...
 */
export declare function registerEditorOpener(
