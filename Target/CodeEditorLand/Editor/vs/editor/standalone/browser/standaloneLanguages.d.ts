 ...
 * @event
 */
export declare function onLanguage(
	languageId: string,
	callback: () => void,
): IDisposable;
/**
 ...
 * @event
 */
export declare function onLanguageEncountered(
	languageId: string,
	callback: () => void,
): IDisposable;
/**
 ...
 */
export declare function setLanguageConfiguration(
	languageId: string,
 ...
 * @internal
 */
export declare class EncodedTokenizationSupportAdapter
 ...
 * @internal
 */
export declare class TokenizationSupportAdapter
	implements languages.ITokenizationSupport, IDisposable
{
	private readonly _languageId;
	private readonly _actual;
	...
	constructor(
		_languageId: string,
		_actual: TokensProvider,
		_languageService: ILanguageService,
		_standaloneThemeService: IStandaloneThemeService,
	);
	dispose(): void;
	getInitialState(): languages.IState;
	private static _toClassicTokens;
	static adaptTokenize(
		language: string,
		actual: {
 ...
 */
export declare function registerTokensProviderFactory(
	languageId: string,
 ...
 */
export declare function setTokensProvider(
	languageId: string,
	provider:
		| TokensProvider
 ...
 */
export declare function setMonarchTokensProvider(
	languageId: string,
 ...
 */
export declare function registerReferenceProvider(
 ...
 */
export declare function registerRenameProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerNewSymbolNameProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerSignatureHelpProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerHoverProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerDocumentSymbolProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerDocumentHighlightProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerLinkedEditingRangeProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerDefinitionProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerImplementationProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerTypeDefinitionProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerCodeLensProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerCodeActionProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerDocumentFormattingEditProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerDocumentRangeFormattingEditProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerOnTypeFormattingEditProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerLinkProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerCompletionItemProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerColorProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerFoldingRangeProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerDeclarationProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerSelectionRangeProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerDocumentSemanticTokensProvider(
	languageSelector: LanguageSelector,
 ...
 * For the best user experience, register both a semantic tokens provider and a top-down tokenizer.
 */
export declare function registerDocumentRangeSemanticTokensProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerInlineCompletionsProvider(
	languageSelector: LanguageSelector,
	provider: languages.InlineCompletionsProvider,
): IDisposable;
export declare function registerInlineEditProvider(
	languageSelector: LanguageSelector,
 ...
 */
export declare function registerInlayHintsProvider(
	languageSelector: LanguageSelector,
