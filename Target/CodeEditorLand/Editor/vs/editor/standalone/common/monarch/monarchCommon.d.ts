...
export declare function isFuzzyActionArr(
	what: FuzzyAction | FuzzyAction[],
): what is FuzzyAction[];
export declare function isFuzzyAction(
	what: FuzzyAction | FuzzyAction[],
): what is FuzzyAction;
 ...
 */
export declare function substituteMatches(
	lexer: ILexerMin,
	str: string,
	id: string,
	matches: string[],
 ...
 *
 */
export declare function substituteMatchesRe(
	lexer: ILexerMin,
	str: string,
	state: string,
): string;
 ...
 */
export declare function findRules(
	lexer: ILexer,
	inState: string,
): IRule[] | null;
/**
