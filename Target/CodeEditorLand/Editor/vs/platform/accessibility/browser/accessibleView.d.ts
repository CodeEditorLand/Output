...
export declare class AccessibleContentProvider
	extends Disposable
	implements IAccessibleViewContentProvider
{
	...
	constructor(
		...
		onKeyDown?: ((e: IKeyboardEvent) => void) | undefined,
		getSymbols?: (() => IAccessibleViewSymbol[]) | undefined,
		onDidRequestClearLastProvider?:
			| Event<AccessibleViewProviderId>
			| undefined,
	);
}
export declare class ExtensionContentProvider
	extends Disposable
