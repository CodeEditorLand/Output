...
export declare function isConfigurationOverrides(
	thing: any,
...
export declare function isConfigurationUpdateOverrides(
	thing: any,
...
export declare function isConfigured<T>(
	configValue: IConfigurationValue<T>,
): configValue is IConfigurationValue<T> & {
	value: T;
};
 ...
 */
export declare function getConfigurationValue<T>(
	config: any,
	settingPath: string,
	defaultValue?: T,
): T;
export declare function merge(base: any, add: any, overwrite: boolean): void;
export declare function getLanguageTagSettingPlainKey(
	settingKey: string,
): string;
