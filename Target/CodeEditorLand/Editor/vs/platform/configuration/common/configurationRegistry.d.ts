...
export declare const resourceLanguageSettingsSchemaId =
	"vscode://schemas/settings/resourceLanguage";
export declare const configurationDefaultsSchemaId =
...
export declare function keyFromOverrideIdentifiers(
...
export declare function getAllConfigurationProperties(
