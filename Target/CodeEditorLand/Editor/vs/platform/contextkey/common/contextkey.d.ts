...
export declare function expressionsAreEqualWithConstantSubstitution(
...
export declare class ContextKeyGreaterEqualsExpr
	implements IContextKeyExpression
{
	private readonly key;
	private readonly value;
	private negated;
...
export declare class ContextKeySmallerEqualsExpr
	implements IContextKeyExpression
{
	private readonly key;
	private readonly value;
...
export declare class RawContextKey<
