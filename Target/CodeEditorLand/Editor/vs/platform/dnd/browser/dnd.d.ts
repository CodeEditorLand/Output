...
export declare function extractEditorsDropData(
	e: DragEvent,
): Array<IDraggedResourceEditorInput>;
export declare function extractEditorsAndFilesDropData(
	accessor: ServicesAccessor,
	e: DragEvent,
): Promise<Array<IDraggedResourceEditorInput>>;
export declare function createDraggedEditorInputFromRawResourcesData(
...
export declare function extractFileListData(
	accessor: ServicesAccessor,
	files: FileList,
): Promise<IFileTransferData[]>;
export declare function containsDragType(
	event: DragEvent,
