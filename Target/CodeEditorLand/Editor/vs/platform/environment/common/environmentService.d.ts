...
export declare abstract class AbstractNativeEnvironmentService
...
export declare function parseExtensionHostDebugPort(
	args: NativeParsedArgs,
	isBuilt: boolean,
): IExtensionHostDebugParams;
export declare function parseDebugParams(
