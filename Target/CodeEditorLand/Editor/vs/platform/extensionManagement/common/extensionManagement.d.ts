...
export declare const EXTENSION_IDENTIFIER_PATTERN =
	"^([a-z0-9A-Z][a-z0-9-A-Z]*)\\.([a-z0-9A-Z][a-z0-9-A-Z]*)$";
export declare const EXTENSION_IDENTIFIER_REGEX: RegExp;
export declare const WEB_EXTENSION_TAG = "__web_extension";
export declare const EXTENSION_INSTALL_SKIP_WALKTHROUGH_CONTEXT =
	"skipWalkthrough";
export declare const EXTENSION_INSTALL_SOURCE_CONTEXT =
	"extensionInstallSource";
export declare const EXTENSION_INSTALL_DEP_PACK_CONTEXT =
	"dependecyOrPackExtensionInstall";
export declare const EXTENSION_INSTALL_CLIENT_TARGET_PLATFORM_CONTEXT =
...
export declare function TargetPlatformToString(
	...
	| "Alpine ARM 64"
	| "Mac Silicon";
export declare function toTargetPlatform(
...
export declare function isIExtensionIdentifier(
	thing: any,
...
export declare const DISABLED_EXTENSIONS_STORAGE_PATH =
	"extensionsIdentifiers/disabled";
export declare const ENABLED_EXTENSIONS_STORAGE_PATH =
