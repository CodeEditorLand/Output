...
export declare class ExtensionManagementChannel implements IServerChannel {
	...
	constructor(
		service: IExtensionManagementService,
		getUriTransformer: (requestContext: any) => IURITransformer | null,
	);
...
export declare class ExtensionManagementChannelClient
	extends Disposable
	implements IExtensionManagementService
{
	...
	protected readonly _onDidInstallExtensions: Emitter<
