...
export declare function areSameExtensions(
...
export declare function getIdAndVersion(
	id: string,
...
export declare function getGalleryExtensionId(
	publisher: string | undefined,
	name: string,
): string;
export declare function groupByExtension<T>(
	extensions: T[],
	getExtensionIdentifier: (t: T) => IExtensionIdentifier,
): T[][];
export declare function getLocalExtensionTelemetryData(
...
export declare function getGalleryExtensionTelemetryData(
	extension: IGalleryExtension,
): any;
export declare const BetterMergeId: ExtensionIdentifier;
export declare function getExtensionDependencies(
	installedExtensions: ReadonlyArray<IExtension>,
	extension: IExtension,
): IExtension[];
export declare function computeTargetPlatform(
