...
export declare abstract class AbstractExtensionsScannerService
	extends Disposable
...
export declare class ExtensionScannerInput {
	...
	constructor(
		...
		applicationExtensionslocation: URI | undefined,
		applicationExtensionslocationMtime: number | undefined,
		profile: boolean,
