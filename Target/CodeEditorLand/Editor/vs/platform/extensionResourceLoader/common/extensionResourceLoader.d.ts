...
export declare function migratePlatformSpecificExtensionGalleryResourceURL(
	resource: URI,
	targetPlatform: TargetPlatform,
): URI | undefined;
export declare abstract class AbstractExtensionResourceLoaderService
	implements IExtensionResourceLoaderService
{
	...
	isExtensionGalleryResource(uri: URI): boolean;
	protected getExtensionGalleryRequestHeaders(): Promise<
