...
export declare function normalizeVersion(
...
export declare function isValidExtensionVersion(
	productVersion: string,
	productDate: ProductDate,
	extensionManifest: IExtensionManifest,
	extensionIsBuiltin: boolean,
...
export declare function isEngineValid(
	engine: string,
	version: string,
	date: ProductDate,
): boolean;
export declare function areApiProposalsCompatible(
	apiProposals: string[],
): boolean;
export declare function areApiProposalsCompatible(
	apiProposals: string[],
