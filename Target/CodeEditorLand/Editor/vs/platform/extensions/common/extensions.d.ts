...
export declare function getWorkspaceSupportTypeMessage(
	supportType:
...
export declare function isApplicationScopedExtension(
	manifest: IExtensionManifest,
): boolean;
export declare function isLanguagePackExtension(
	manifest: IExtensionManifest,
): boolean;
export declare function isAuthenticationProviderExtension(
	manifest: IExtensionManifest,
): boolean;
export declare function isResolverExtension(
	manifest: IExtensionManifest,
...
export declare function parseEnabledApiProposalNames(
