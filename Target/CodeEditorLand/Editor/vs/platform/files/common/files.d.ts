...
export declare function isFileOpenForWriteOptions(
...
export declare function isFileSystemWatcher(
	thing: unknown,
...
export declare function hasReadWriteCapability(
	provider: IFileSystemProvider,
...
export declare function hasFileFolderCopyCapability(
	provider: IFileSystemProvider,
...
export declare function hasFileCloneCapability(
	provider: IFileSystemProvider,
...
export declare function hasOpenReadWriteCloseCapability(
	provider: IFileSystemProvider,
...
export declare function hasFileReadStreamCapability(
	provider: IFileSystemProvider,
...
export declare function hasFileAtomicReadCapability(
	provider: IFileSystemProvider,
...
export declare function hasFileAtomicWriteCapability(
	provider: IFileSystemProvider,
...
export declare function hasFileAtomicDeleteCapability(
	provider: IFileSystemProvider,
...
export declare function hasReadonlyCapability(
	provider: IFileSystemProvider,
...
export declare class FileSystemProviderError
	extends Error
...
export declare function markAsFileSystemProviderError(
	error: Error,
	code: FileSystemProviderErrorCode,
): Error;
export declare function toFileSystemProviderErrorCode(
	error: Error | undefined | null,
): FileSystemProviderErrorCode;
export declare function toFileOperationResult(
	error: Error,
): FileOperationResult;
...
export declare function isParent(
	path: string,
	candidate: string,
	ignoreCase?: boolean,
): boolean;
...
export declare class FileOperationError extends Error {
	...
	readonly options?:
		| (IReadFileOptions | IWriteFileOptions | ICreateFileOptions)
		| undefined;
	constructor(
		message: string,
...
export declare const FILES_READONLY_FROM_PERMISSIONS_CONFIG =
...
export declare function etag(stat: { mtime: number; size: number }): string;
export declare function etag(stat: {
	mtime: number | undefined;
	size: number | undefined;
}): string | undefined;
export declare function whenProviderRegistered(
	file: URI,
...
export declare function getLargeFileConfirmationLimit(
