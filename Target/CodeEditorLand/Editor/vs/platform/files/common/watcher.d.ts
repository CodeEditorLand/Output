...
export declare function isWatchRequestWithCorrelation(
...
export declare function isRecursiveWatchRequest(
	request: IWatchRequest,
...
export declare abstract class AbstractNonRecursiveWatcherClient extends AbstractWatcherClient {
	...
	protected abstract createWatcher(
...
export declare function reviveFileChanges(
	changes: IFileChange[],
): IFileChange[];
export declare function coalesceEvents(changes: IFileChange[]): IFileChange[];
export declare function normalizeWatcherPattern(
	path: string,
	pattern: string | IRelativePattern,
): string | IRelativePattern;
export declare function parseWatcherPatterns(
	path: string,
	patterns: Array<string | IRelativePattern>,
): ParsedPattern[];
export declare function isFiltered(
	event: IFileChange,
	filter: FileChangeFilter | undefined,
): boolean;
export declare function requestFilterToString(
	filter: FileChangeFilter | undefined,
): string;
export {};
