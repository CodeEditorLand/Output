...
export declare class NodeJSFileWatcherLibrary extends Disposable {
	...
	constructor(
		...
		recursiveWatcher: IRecursiveWatcherWithSubscribe | undefined,
		onDidFilesChange: (changes: IFileChange[]) => void,
		onDidWatchFail?: (() => void) | undefined,
		onLogMessage?: ((msg: ILogMessage) => void) | undefined,
 ...
 */
export declare function watchFileContents(
	path: string,
