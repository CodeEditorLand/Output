...
export declare function areKeyboardLayoutsEqual(
	a: IKeyboardLayoutInfo | null,
	b: IKeyboardLayoutInfo | null,
): boolean;
export declare function parseKeyboardLayoutDescription(
	layout: IKeyboardLayoutInfo | null,
): {
	label: string;
	description: string;
};
export declare function getKeyboardLayoutId(
	layout: IKeyboardLayoutInfo,
): string;
export declare function windowsKeyboardMappingEquals(
	a: IWindowsKeyboardMapping | null,
	b: IWindowsKeyboardMapping | null,
): boolean;
export declare function macLinuxKeyboardMappingEquals(
