...
export declare const RawWorkbenchListScrollAtBoundaryContextKey: RawContextKey<
	"top" | "none" | "bottom" | "both"
>;
export declare const WorkbenchListScrollAtTopContextKey:
	| import("../../contextkey/common/contextkey.js").ContextKeyExpression
	| undefined;
export declare const WorkbenchListScrollAtBottomContextKey:
	| import("../../contextkey/common/contextkey.js").ContextKeyExpression
	| undefined;
...
export declare class WorkbenchObjectTree<
...
export declare class WorkbenchDataTree<
	TInput,
	T,
	TFilterData = void,
> extends DataTree<TInput, T, TFilterData> {
	private internals;
	get contextKeyService(): IContextKeyService;
	get useAltAsMultipleSelectionModifier(): boolean;
	get onDidOpen(): Event<IOpenEvent<T | undefined>>;
...
export declare class WorkbenchAsyncDataTree<
	TInput,
	T,
	TFilterData = void,
