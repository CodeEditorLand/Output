...
export declare const makeRawSocketHeaders: (
	path: string,
	query: string,
	deubgLabel: string,
) => string;
...
export declare function connectManagedSocket<T extends ManagedSocket>(
	socket: T,
	path: string,
	query: string,
	debugLabel: string,
...
export declare abstract class ManagedSocket
	extends Disposable
	implements ISocket
{
