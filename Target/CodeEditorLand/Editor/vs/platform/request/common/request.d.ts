...
export declare abstract class AbstractRequestService
	extends Disposable
...
export declare function asText(
	context: IRequestContext,
): Promise<string | null>;
export declare function asTextOrError(
	context: IRequestContext,
): Promise<string | null>;
export declare function asJson<T = {}>(
	context: IRequestContext,
): Promise<T | null>;
export declare function updateProxyConfigurationsScope(
