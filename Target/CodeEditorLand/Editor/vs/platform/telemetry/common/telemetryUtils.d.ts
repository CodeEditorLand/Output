...
export declare class NullEndpointTelemetryService
 ...
 */
export declare function supportsTelemetry(
 ...
 */
export declare function isLoggingOnly(
	productService: IProductService,
	environmentService: IEnvironmentService,
): boolean;
/**
 ...
 */
export declare function getTelemetryLevel(
 ...
 */
export declare function isInternalTelemetry(
	productService: IProductService,
...
export declare function getPiiPathsFromEnvironment(
	paths: IPathEnvironment,
): string[];
/**
 ...
 */
export declare function cleanData(
