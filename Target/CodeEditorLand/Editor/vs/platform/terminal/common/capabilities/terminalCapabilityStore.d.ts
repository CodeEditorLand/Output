...
export declare class TerminalCapabilityStore
	extends Disposable
	implements ITerminalCapabilityStore
{
	...
	readonly onDidRemoveCapability: import("../../../../workbench/workbench.web.main.internal.js").Event<
		TerminalCapabilityChangeEvent<any>
	>;
	private readonly _onDidAddCapability;
	readonly onDidAddCapability: import("../../../../workbench/workbench.web.main.internal.js").Event<
		TerminalCapabilityChangeEvent<any>
	>;
...
export declare class TerminalCapabilityStoreMultiplexer
	extends Disposable
	implements ITerminalCapabilityStore
{
