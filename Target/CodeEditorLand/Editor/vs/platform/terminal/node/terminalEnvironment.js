...
shellIntegrationArgs.set("fish" /* Fish */, ["--init-command", ". {0}/out/vs/workbench/contrib/terminal/common/scripts/shellIntegration.fish"]);
shellIntegrationArgs.set("fish-login" /* FishLogin */, ["-l", "--init-command", ". {0}/out/vs/workbench/contrib/terminal/common/scripts/shellIntegration.fish"]);
