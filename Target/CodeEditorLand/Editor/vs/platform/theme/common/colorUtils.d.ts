...
export declare function asCssVariableWithDefault(
...
export declare function registerColor(
	id: string,
...
export declare function executeTransform(
...
export declare function ifDefinedThenElse(
	ifArg: ColorIdentifier,
	thenArg: ColorValue,
	elseArg: ColorValue,
): ColorTransform;
export declare function lessProminent(
	colorValue: ColorValue,
 ...
 */
export declare function resolveColorValue(
	colorValue: ColorValue | null,
	theme: IColorTheme,
): Color | undefined;
export declare const workbenchColorsSchemaId =
