...
export declare function isTunnelProvider(
...
export declare function extractLocalHostUriMetaDataForPortMapping(uri: URI):
	...
	| undefined;
export declare function extractQueryLocalHostUriMetaDataForPortMapping(
	uri: URI,
):
	| {
			address: string;
...
export declare function isPortPrivileged(
	port: number,
	host: string,
	os: OperatingSystem,
	osRelease: string,
...
export declare abstract class AbstractTunnelService
	extends Disposable
	implements ITunnelService
{
	...
	protected readonly _tunnels: Map<
		string,
		Map<
			number,
			{
