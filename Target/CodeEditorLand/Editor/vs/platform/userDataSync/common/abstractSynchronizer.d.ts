...
export declare function getSyncResourceLogLabel(
...
export declare abstract class AbstractSynchroniser
	extends Disposable
	implements IUserDataSynchroniser
{
	...
	private getUserData;
	protected updateRemoteUserData(
		content: string,
		ref: string | null,
	): Promise<IRemoteUserData>;
...
export declare abstract class AbstractFileSynchroniser extends AbstractSynchroniser {
	...
	protected updateLocalFileContent(
		newContent: string,
...
export declare abstract class AbstractInitializer
