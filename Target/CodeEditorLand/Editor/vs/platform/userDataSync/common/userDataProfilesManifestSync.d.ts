...
export declare class UserDataProfilesManifestSynchroniser
...
export declare function stringifyLocalProfiles(
	profiles: IUserDataProfile[],
	format: boolean,
): string;
export declare function parseUserDataProfilesManifest(
	syncData: ISyncData,
): ISyncUserDataProfile[];
export {};
