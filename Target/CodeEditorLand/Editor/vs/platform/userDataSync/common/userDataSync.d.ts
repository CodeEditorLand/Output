...
export declare function getDefaultIgnoredSettings(
	excludeExtensions?: boolean,
): string[];
export declare function getIgnoredSettingsForExtension(
...
export declare const CONFIG_SYNC_KEYBINDINGS_PER_PLATFORM =
...
export declare function isAuthenticationProvider(
	thing: any,
...
export declare function getPathSegments(
