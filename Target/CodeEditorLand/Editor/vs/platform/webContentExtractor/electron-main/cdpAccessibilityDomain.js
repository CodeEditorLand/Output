...
`),i=0),n.push(r),n.push("`")}}function B(t){const e=[];return N(t,e),e}function N(t,e){if(h(t.node)==="link"&&v(t)){const s=a(t.node,!0),c=f(t.node),o=t.node.description?.value||"";e.push(`- [${s}](${c})${o?" - "+o:""}`)}for(const s of t.children)N(s,e)}export{S as $MB};
