...
export declare function isOpenedAuxiliaryWindow(
...
export declare function isWorkspaceToOpen(
	uriToOpen: IWindowOpenable,
): uriToOpen is IWorkspaceToOpen;
export declare function isFolderToOpen(
	uriToOpen: IWindowOpenable,
): uriToOpen is IFolderToOpen;
export declare function isFileToOpen(
	uriToOpen: IWindowOpenable,
...
export type MenuBarVisibility =
	...
	| "hidden"
	| "compact";
export declare function getMenuBarVisibility(
...
export declare function hasCustomTitlebar(
	configurationService: IConfigurationService,
	titleBarStyle?: TitlebarStyle,
): boolean;
export declare function hasNativeTitlebar(
	configurationService: IConfigurationService,
	titleBarStyle?: TitlebarStyle,
): boolean;
export declare function getTitleBarStyle(
	configurationService: IConfigurationService,
): TitlebarStyle;
export declare const DEFAULT_CUSTOM_TITLEBAR_HEIGHT = 35;
export declare function useWindowControlsOverlay(
	configurationService: IConfigurationService,
): boolean;
export declare function useNativeFullScreen(
	configurationService: IConfigurationService,
): boolean;
