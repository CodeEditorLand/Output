...
export declare function isSingleFolderWorkspaceIdentifier(
	obj: unknown,
): obj is ISingleFolderWorkspaceIdentifier;
export declare function isEmptyWorkspaceIdentifier(
	obj: unknown,
...
export declare function toWorkspaceIdentifier(
...
export declare function isWorkspaceIdentifier(
	obj: unknown,
...
export declare function reviveIdentifier(
...
export declare function isWorkspaceFolder(
	thing: unknown,
): thing is IWorkspaceFolder;
export declare class Workspace implements IWorkspace {
	...
	constructor(
		...
		_transient: boolean,
		_configuration: URI | null,
		_ignorePathCasing: (key: URI) => boolean,
	);
...
export declare class WorkspaceFolder implements IWorkspaceFolder {
	 ...
	 */
	readonly raw?:
		| (IRawFileWorkspaceFolder | IRawUriWorkspaceFolder)
		| undefined;
	readonly uri: URI;
	readonly name: string;
	readonly index: number;
...
export declare function isUntitledWorkspace(
	path: URI,
...
export declare const STANDALONE_EDITOR_WORKSPACE_ID =
	"4064f6ec-cb38-4ad0-af64-ee6467e63c82";
export declare function isStandaloneEditorWorkspace(
	workspace: IWorkspace,
): boolean;
export declare function isSavedWorkspace(
	path: URI,
	environmentService: IEnvironmentService,
): boolean;
