...
export declare function isRecentWorkspace(
	curr: IRecent,
): curr is IRecentWorkspace;
...
export declare function isStoredWorkspaceFolder(
	obj: unknown,
 ...
 */
export declare function getStoredWorkspaceFolder(
	folderURI: URI,
...
export declare function toWorkspaceFolders(
 ...
 */
export declare function rewriteWorkspaceFileForNewLocation(
...
export declare function restoreRecentlyOpened(
	data: RecentlyOpenedStorageData | undefined,
	logService: ILogService,
): IRecentlyOpened;
export declare function toStoreData(
