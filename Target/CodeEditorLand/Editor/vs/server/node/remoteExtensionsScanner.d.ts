...
export declare class RemoteExtensionsScannerService
	implements IRemoteExtensionsScannerService
{
	...
	constructor(
		_extensionManagementCLI: ExtensionManagementCLI,
		environmentService: IServerEnvironmentService,
		_userDataProfilesService: IUserDataProfilesService,
		_extensionsScannerService: IExtensionsScannerService,
		_logService: ILogService,
		_extensionGalleryService: IExtensionGalleryService,
		_languagePackService: ILanguagePackService,
	);
...
export declare class RemoteExtensionsScannerChannel implements IServerChannel {
	...
	constructor(
		service: RemoteExtensionsScannerService,
		getUriTransformer: (requestContext: any) => IURITransformer,
	);
