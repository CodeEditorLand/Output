...
export declare function parseServerConnectionToken(
	args: ServerParsedArgs,
	defaultValue: () => Promise<string>,
): Promise<ServerConnectionToken | ServerConnectionTokenParseError>;
export declare function determineServerConnectionToken(
	args: ServerParsedArgs,
): Promise<ServerConnectionToken | ServerConnectionTokenParseError>;
export declare function requestHasValidConnectionToken(
