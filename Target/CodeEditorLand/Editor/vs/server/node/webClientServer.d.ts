 ...
 */
export declare function serveError(
 ...
 */
export declare function serveFile(
	filePath: string,
...
export declare class WebClientServer {
	...
	constructor(
		_connectionToken: ServerConnectionToken,
		_basePath: string,
		serverRootPath: string,
		_environmentService: IServerEnvironmentService,
		_logService: ILogService,
		_requestService: IRequestService,
		_productService: IProductService,
		_cssDevService: ICSSDevelopmentService,
	);
	/**
