...
export declare class MainThreadTerminalService
	implements MainThreadTerminalServiceShape
{
	...
	constructor(
		...
		_terminalLinkProviderService: ITerminalLinkProviderService,
		_terminalQuickFixService: ITerminalQuickFixService,
		_instantiationService: IInstantiationService,
		_environmentVariableService: IEnvironmentVariableService,
...
export declare function getOutputMatchForLines(
	lines: string[],
