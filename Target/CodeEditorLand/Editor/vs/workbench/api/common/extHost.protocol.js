...
import {
  IChatRelatedFile,
  IChatRelatedFileProviderMetadata as IChatRelatedFilesProviderMetadata,
  IChatRequestDraft
...
const MainContext = {
  ...
  MainThreadCodeMapper: createProxyIdentifier(
  ...
  MainThreadChatStatus: createProxyIdentifier(
