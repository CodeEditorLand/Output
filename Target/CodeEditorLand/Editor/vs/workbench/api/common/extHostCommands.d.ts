	...
	implements extHostTypeConverter.Command.ICommandsConverter
{
	...
	constructor(
		...
		_lookupApiCommand: (id: string) => ApiCommand | undefined,
...
export declare class ApiCommandArgument<V, O = V> {
	...
	static readonly Position: ApiCommandArgument<
		extHostTypes.Position,
		IPosition
	>;
	static readonly Range: ApiCommandArgument<extHostTypes.Range, IRange>;
	static readonly Selection: ApiCommandArgument<
	...
	static Arr<T, K = T>(
		element: ApiCommandArgument<T, K>,
	): ApiCommandArgument<T[], K[]>;
	static readonly CallHierarchyItem: ApiCommandArgument<
	...
	>;
	static readonly TypeHierarchyItem: ApiCommandArgument<
	...
	>;
	static readonly TestItem: ApiCommandArgument<
		vscode.TestItem,
		import("../../contrib/testing/common/testTypes.js").ITestItem
	>;
	constructor(
		name: string,
		description: string,
...
export declare class ApiCommandResult<V, O = V> {
	...
	constructor(
		description: string,
		convert: (v: V, apiArgs: any[], cmdConverter: CommandsConverter) => O,
	);
}
export declare class ApiCommand {
	...
	constructor(
		...
		internalId: string,
		description: string,
		args: ApiCommandArgument<any, any>[],
		result: ApiCommandResult<any, any>,
	);
}
