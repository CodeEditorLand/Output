...
export declare class ExtHostCustomEditors
	implements extHostProtocol.ExtHostCustomEditorsShape
{
	...
	constructor(
		...
		_extensionStoragePaths: IExtensionStoragePaths | undefined,
		_extHostWebview: ExtHostWebviews,
		_extHostWebviewPanels: ExtHostWebviewPanels,
	);
