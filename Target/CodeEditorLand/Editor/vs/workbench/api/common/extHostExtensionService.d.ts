...
export declare abstract class AbstractExtHostExtensionService
	extends Disposable
	implements ExtHostExtensionServiceShape
{
	...
	constructor(
		...
		_extHostManagedSockets: IExtHostManagedSockets,
		_extHostLanguageModels: IExtHostLanguageModels,
	);
...
export declare class Extension<T extends object | null | undefined>
