...
export declare class ExtHostNotebookDocumentSaveParticipant
	implements ExtHostNotebookDocumentSaveParticipantShape
{
	...
	constructor(
		...
		_notebooksAndEditors: ExtHostNotebookController,
		_mainThreadBulkEdits: MainThreadBulkEditsShape,
		_thresholds?: {
			timeout: number;
			errors: number;
		},
