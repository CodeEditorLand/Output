...
export declare class ExtHostNotebookEditor {
	...
	static readonly apiEditorsToExtHost: WeakMap<
	...
	constructor(
		id: string,
		_proxy: MainThreadNotebookEditorsShape,
		notebookData: ExtHostNotebookDocument,
		_visibleRanges: vscode.NotebookRange[],
		_selections: vscode.NotebookRange[],
