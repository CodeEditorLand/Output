...
export declare abstract class ExtHostTaskBase
	implements ExtHostTaskShape, IExtHostTask
{
	...
	private nextHandle;
	protected addCustomExecution(
		taskDTO: tasks.ITaskDTO,
		task: vscode.Task,
		isProvided: boolean,
	): Promise<void>;
	protected getTaskExecution(
