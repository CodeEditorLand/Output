...
export declare class ExtHostTerminal extends Disposable {
	...
	constructor(
		_proxy: MainThreadTerminalServiceShape,
		_id: ExtHostTerminalIdentifier,
		_creationOptions:
...
export declare abstract class BaseExtHostTerminalService
	extends Disposable
	implements IExtHostTerminalService, ExtHostTerminalServiceShape
{
	...
	readonly onDidOpenTerminal: Event<vscode.Terminal>;
	protected readonly _onDidChangeActiveTerminal: Emitter<
	...
	constructor(
		...
		_extHostCommands: IExtHostCommands,
	...
	abstract createTerminalFromOptions(
		options: vscode.TerminalOptions,
		internalOptions?: ITerminalInternalOptions,
	): vscode.Terminal;
	getDefaultShell(useAutomationShell: boolean): string;
