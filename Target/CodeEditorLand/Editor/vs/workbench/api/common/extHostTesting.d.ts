...
export declare class ExtHostTesting
	extends Disposable
	implements ExtHostTestingShape
{
	...
	constructor(
		...
		editors: IExtHostDocumentsAndEditors,
	);
	/**
...
export declare class TestRunCoordinator {
	...
	): never[] | Promise<vscode.FileCoverageDetail[]>;
	/**
