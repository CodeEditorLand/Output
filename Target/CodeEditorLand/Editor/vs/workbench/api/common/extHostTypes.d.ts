...
export declare function getDebugDescriptionOfSelection(
	selection: vscode.Selection,
): string;
export declare class ResolvedAuthority {
	static isResolvedAuthority(
...
export declare class ManagedResolvedAuthority {
	...
	readonly connectionToken?: string | undefined;
	static isManagedResolvedAuthority(
		resolvedAuthority: any,
...
export declare class InlineSuggestionList
	implements vscode.InlineCompletionList
{
...
export declare function asStatusBarItemIdentifier(
...
export declare class DebugAdapterExecutable
	implements vscode.DebugAdapterExecutable
{
...
export declare class EvaluatableExpression
	implements vscode.EvaluatableExpression
{
	readonly range: vscode.Range;
...
export declare class InlineValueVariableLookup
...
export declare class InlineValueEvaluatableExpression
...
export declare function validateTestCoverageCount(
	cc?: vscode.TestCoverageCount,
): void;
...
export declare class ChatResponseAnchorPart
	implements vscode.ChatResponseAnchorPart
{
...
export declare class ChatRequestEditorData
	implements vscode.ChatRequestEditorData
{
...
export declare class LanguageModelToolResultPart
	implements vscode.LanguageModelChatMessageToolResultPart
{
	toolCallId: string;
	content: string;
	isError: boolean;
...
{
	static User(
		content: string | LanguageModelToolResultPart,
		name?: string,
	...
	content2: (
		| string
		| vscode.LanguageModelChatMessageToolResultPart
...
export declare class LanguageModelToolCallPart
	implements vscode.LanguageModelChatResponseToolCallPart
{
	name: string;
	toolCallId: string;
	parameters: any;
...
export declare class LanguageModelTextPart
	implements vscode.LanguageModelChatResponseTextPart
{
	value: string;
	constructor(value: string);
}
