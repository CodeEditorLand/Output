...
export declare function shouldSerializeBuffersForPostMessage(
	extension: IExtensionDescription,
): boolean;
export declare class ExtHostWebviews
	extends Disposable
	implements extHostProtocol.ExtHostWebviewsShape
{
	...
	constructor(
		...
		_deprecationService: IExtHostApiDeprecationService,
	);
	dispose(): void;
	$onMessage(
		handle: extHostProtocol.WebviewHandle,
...
export declare function toExtensionData(
	extension: IExtensionDescription,
): extHostProtocol.WebviewExtensionDescription;
export declare function serializeWebviewOptions(
	extension: IExtensionDescription,
	workspace: IExtHostWorkspace | undefined,
	options: vscode.WebviewOptions,
