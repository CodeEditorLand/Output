...
export declare function getSockets(stdout: string): Record<
	string,
	{
		pid: number;
		socket: number;
...
export declare function loadConnectionTable(
	stdout: string,
...
export declare function findPorts(
	connections: {
		socket: number;
		ip: string;
		port: number;
...
export declare function tryFindRootPorts(
	connections: {
		socket: number;
		ip: string;
		port: number;
