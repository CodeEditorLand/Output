...
export declare function extractTreeDropData(
...
export declare class ResourcesDropHandler {
	...
	constructor(
		options: IResourcesDropHandlerOptions,
...
export declare function fillEditorsDragData(
...
export declare function toggleDropEffect(
