...
export declare class CompositeBarActionViewItem extends BaseActionViewItem {
	...
	constructor(
		...
		badgesEnabled: (compositeId: string) => boolean,
...
export declare class CompositeOverflowActivityActionViewItem extends CompositeBarActionViewItem {
	...
	constructor(
		...
		getBadge: (compositeId: string) => IBadge,
		getCompositeOpenAction: (compositeId: string) => IAction,
...
export declare class CompositeActionViewItem extends CompositeBarActionViewItem {
	...
	constructor(
		...
		toggleCompositeBadgeAction: IAction,
		compositeContextMenuActionsProvider: (compositeId: string) => IAction[],
		contextMenuActionsProvider: () => IAction[],
		dndHandler: ICompositeDragAndDrop,
...
export declare class ToggleCompositePinnedAction extends Action {
	...
	constructor(
		activity: ICompositeBarActionItem | undefined,
		compositeBar: ICompositeBar,
	);
...
export declare class ToggleCompositeBadgeAction extends Action {
	...
	private compositeBar;
	constructor(
		compositeBarActionItem: ICompositeBarActionItem | undefined,
		compositeBar: ICompositeBar,
	);
	run(context: string): Promise<void>;
}
