...
declare abstract class AbstractGlobalActivityActionViewItem extends CompositeBarActionViewItem {
	...
	protected resolveContextMenuActions(
		disposables: DisposableStore,
	): Promise<IAction[]>;
	private run;
	protected resolveMainMenuActions(
		menu: IMenu,
...
export declare class AccountsActivityActionViewItem extends AbstractGlobalActivityActionViewItem {
	...
	constructor(
		...
		contextMenuAlignmentOptions: () =>
			...
			| undefined,
		fillContextMenuActions: (actions: IAction[]) => void,
		themeService: IThemeService,
...
export declare function isAccountsActionVisible(
	storageService: IStorageService,
): boolean;
export {};
