...
export declare const ACCEPT_PRIMARY_ACTION_NOTIFICATION =
...
export declare const TOGGLE_DO_NOT_DISTURB_MODE =
	"notifications.toggleDoNotDisturbMode";
export declare const TOGGLE_DO_NOT_DISTURB_MODE_BY_SOURCE =
...
export declare function getNotificationFromContext(
	listService: IListService,
	context?: unknown,
): INotificationViewItem | undefined;
export declare function registerNotificationCommands(
