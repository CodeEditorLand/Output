...
export declare abstract class AbstractPaneCompositePart
	...
	implements IPaneCompositePart
{
	...
	constructor(
		partId: Parts.PANEL_PART | Parts.AUXILIARYBAR_PART | Parts.SIDEBAR_PART,
		partOptions: IPartOptions,
		activePaneCompositeSettingsKey: string,
		activePaneContextKey: IContextKey<string>,
		paneFocusContextKey: IContextKey<boolean>,
