...
let WindowTitle = class extends Disposable {
  ...
  checkTitleVariables() {
    ...
    if (typeof titleTemplate === "string") {
      ...
      this.titleIncludesEditorState = titleTemplate.includes(
        "${activeEditorState}"
      );
    }
  }
  ...
  getWindowTitle() {
    ...
    if (!this.titleIncludesEditorState && this.accessibilityService.isScreenReaderOptimized() && this.configurationService.getValue(
