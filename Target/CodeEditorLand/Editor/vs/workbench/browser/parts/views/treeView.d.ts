...
declare abstract class AbstractTreeView
	extends Disposable
...
declare class MultipleSelectionActionRunner extends ActionRunner {
	...
	constructor(
		notificationService: INotificationService,
		getSelectedResources: () => ITreeItem[],
	);
	protected runAction(
		action: IAction,
...
export declare class CustomTreeViewDragAndDrop
	implements ITreeDragAndDrop<ITreeItem>
{
	...
	constructor(
		...
		instantiationService: IInstantiationService,
		treeViewsDragAndDropService: ITreeViewsDnDService,
		logService: ILogService,
	);
