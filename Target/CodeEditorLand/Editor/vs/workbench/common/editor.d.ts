 ...
 */
export declare const SIDE_BY_SIDE_EDITOR_ID =
 ...
 */
export declare const BINARY_DIFF_EDITOR_ID =
...
export declare function isEditorPaneWithSelection(
...
export declare function isEditorPaneWithScrolling(
	editorPane: IEditorPane | undefined,
 ...
 */
export declare function findViewStateForEditor(
	input: EditorInput,
...
export declare function isResourceEditorInput(
	editor: unknown,
): editor is IResourceEditorInput;
export declare function isResourceDiffEditorInput(
	editor: unknown,
): editor is IResourceDiffEditorInput;
export declare function isResourceMultiDiffEditorInput(
	editor: unknown,
): editor is IResourceMultiDiffEditorInput;
export declare function isResourceSideBySideEditorInput(
	editor: unknown,
): editor is IResourceSideBySideEditorInput;
export declare function isUntitledResourceEditorInput(
	editor: unknown,
): editor is IUntitledTextResourceEditorInput;
export declare function isResourceMergeEditorInput(
	editor: unknown,
...
export declare function isSideBySideEditorInput(
	editor: unknown,
...
export declare function isDiffEditorInput(
	editor: unknown,
): editor is IDiffEditorInput;
...
export declare function createTooLargeFileError(
	group: IEditorGroup,
	input: EditorInput,
...
export declare function isEditorInputWithOptions(
	editor: unknown,
): editor is EditorInputWithOptions;
export declare function isEditorInputWithOptionsAndGroup(
	editor: unknown,
...
export declare function isEditorIdentifier(
	identifier: unknown,
...
export declare function isEditorCommandsContext(
	context: unknown,
...
export declare function preventEditorClose(
...
export declare function pathsToEditors(
...
export declare function isTextEditorViewState(
	candidate: unknown,
...
export declare function isEditorOpenError(
	obj: unknown,
): obj is IEditorOpenError;
export declare function createEditorOpenError(
