...
export declare function isSerializedEditorGroupModel(
	group?: unknown,
...
export declare function isGroupEditorChangeEvent(
...
export declare function isGroupEditorOpenEvent(
	e: IGroupModelChangeEvent,
...
export declare function isGroupEditorMoveEvent(
	e: IGroupModelChangeEvent,
...
export declare function isGroupEditorCloseEvent(
	e: IGroupModelChangeEvent,
...
export declare class EditorGroupModel
	extends Disposable
	implements IEditorGroupModel
{
