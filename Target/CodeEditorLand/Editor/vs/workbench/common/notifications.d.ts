	...
	implements INotificationHandle
{
	...
	constructor(
		item: INotificationViewItem,
		onClose: (item: INotificationViewItem) => void,
	);
...
export declare function isNotificationViewItem(
	obj: unknown,
...
export declare class NotificationViewItemProgress
	extends Disposable
...
export declare class NotificationViewItem
	extends Disposable
