...
export declare function ViewContainerLocationToString(
	viewContainerLocation: ViewContainerLocation,
): "sidebar" | "panel" | "auxiliarybar";
...
export interface IViewsRegistry {
	...
	registerViewWelcomeContent(
		id: string,
		viewContent: IViewContentDescriptor,
	): IDisposable;
...
export interface ITreeView extends IDisposable {
	...
	refresh(
		treeItems?: readonly ITreeItem[],
		checkboxesChanged?: readonly ITreeItem[],
	): Promise<void>;
...
export declare class ResolvableTreeItem implements ITreeItem {
	...
	constructor(
		treeItem: ITreeItem,
		resolve?: (token: CancellationToken) => Promise<ITreeItem | undefined>,
	);
