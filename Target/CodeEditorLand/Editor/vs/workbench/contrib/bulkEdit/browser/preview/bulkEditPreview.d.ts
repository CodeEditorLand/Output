...
export declare class BulkEditPreviewProvider
	implements ITextModelContentProvider
{
	...
	constructor(
		_operations: BulkFileOperations,
		_languageService: ILanguageService,
		_modelService: IModelService,
		_textModelResolverService: ITextModelService,
	);
	dispose(): void;
	...
	provideTextContent(
		...
		import("../../../../../editor/common/model.js").ITextModel | null
	>;
}
