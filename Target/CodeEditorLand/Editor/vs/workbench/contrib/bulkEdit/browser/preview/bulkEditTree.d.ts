...
export declare class FileElement implements ICheckable {
	...
	constructor(
		parent: CategoryElement | BulkFileOperations,
		edit: BulkFileOperation,
	);
	isChecked(): boolean;
	setChecked(value: boolean): void;
	isDisabled(): boolean;
...
export declare class BulkEditDataSource
...
export declare function compareBulkFileOperations(
	a: BulkFileOperation,
	b: BulkFileOperation,
): number;
export declare class BulkEditAccessibilityProvider
...
export declare class BulkEditIdentityProvider
	implements IIdentityProvider<BulkEditElement>
{
...
export declare class CategoryElementRenderer
	implements
		ITreeRenderer<CategoryElement, FuzzyScore, CategoryElementTemplate>
{
...
export declare class FileElementRenderer
	implements ITreeRenderer<FileElement, FuzzyScore, FileElementTemplate>
{
...
export declare class TextEditElementRenderer
	implements
		ITreeRenderer<TextEditElement, FuzzyScore, TextEditElementTemplate>
{
	private readonly _themeService;
...
export declare class BulkEditDelegate
	implements IListVirtualDelegate<BulkEditElement>
{
	getHeight(): number;
	getTemplateId(element: BulkEditElement): string;
}
export declare class BulkEditNaviLabelProvider
	implements IKeyboardNavigationLabelProvider<BulkEditElement>
{
