...
export declare class Call {
	...
	constructor(
		...
		parent: Call | undefined,
	);
	static compare(a: Call, b: Call): number;
}
export declare class DataSource
	implements IAsyncDataSource<CallHierarchyModel, Call>
{
...
export declare class CallRenderer
...
export declare class AccessibilityProvider
	implements IListAccessibilityProvider<Call>
{
	getDirection: () => CallHierarchyDirection;
	constructor(getDirection: () => CallHierarchyDirection);
