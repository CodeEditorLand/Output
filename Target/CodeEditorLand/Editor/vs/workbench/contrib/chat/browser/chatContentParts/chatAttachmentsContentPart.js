...
let ChatAttachmentsContentPart = class extends Disposable {
  constructor(variables, contentReferences = [], domNode = dom.$(
    ".chat-attached-context"
  ), contextKeyService, instantiationService, openerService, hoverService, commandService, themeService, labelService) {
    super();
...
\`\`\``
  ...
  async createImageElements(buffer, widget, hoverElement) {
    ...
    const img = dom.$("img.chat-attached-context-image", {
      src: url,
      alt: ""
    });
