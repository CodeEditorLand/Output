...
let ChatDragAndDrop = class extends Themable {
  constructor(contianer, inputPart, styles, themeService, extensionService) {
    super(themeService);
  ...
  guessDropType(e) {
    if (this.isImageDnd(e)) {
      return this.extensionService.extensions.some((ext) => isProposedApiEnabled(ext, "chatReferenceBinaryData")) ? 1 /* IMAGE */ : void 0;
