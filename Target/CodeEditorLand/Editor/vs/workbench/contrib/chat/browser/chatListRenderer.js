...
let ChatListItemRenderer = class extends Disposable {
  ...
  renderTemplate(container) {
    ...
    const template = { avatarContainer, username, detail, value, rowContainer, elementDisposables, templateDisposables, contextKeyService, instantiationService: scopedInstantiationService, agentHover, titleToolbar, footerToolbar, disabledOverlay };
    return template;
  }
