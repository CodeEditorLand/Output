...
export declare class ChatResponseAccessibleView
	implements IAccessibleViewImplentation
{
	...
	): ChatResponseAccessibleProvider | undefined;
}
declare class ChatResponseAccessibleProvider
	extends Disposable
