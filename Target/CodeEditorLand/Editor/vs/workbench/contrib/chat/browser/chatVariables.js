...
let ChatVariablesService = class {
  ...
  async attachContext(name, value, location) {
    ...
    const widget = location === ChatAgentLocation.EditingSession && !unifiedViewEnabled ? await showEditsView(this.viewsService) : this.chatWidgetService.lastFocusedWidget ?? await showChatView(this.viewsService);
