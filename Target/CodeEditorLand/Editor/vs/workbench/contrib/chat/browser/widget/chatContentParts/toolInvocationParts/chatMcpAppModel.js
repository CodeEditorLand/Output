import*as C from"../../../../../../../base/browser/dom.js";import{$1c as E}from"../../../../../../../base/common/assert.js";import{$$h as I}from"../../../../../../../base/common/async.js";import{$qj as g}from"../../../../../../../base/common/buffer.js";import{$Jf as x}from"../../../../../../../base/common/cancellation.js";import{$xf as S}from"../../../../../../../base/common/event.js";import{$Gn as j}from"../../../../../../../base/common/hash.js";import{$jk as w}from"../../../../../../../base/common/htmlContent.js";import{$Ed as L}from"../../../../../../../base/common/lifecycle.js";import{autorun as R,autorunSelfDisposable as T,observableValue as O}from"../../../../../../../base/common/observable.js";import{$Fh as v}from"../../../../../../../base/common/resources.js";import{$Uf as A}from"../../../../../../../base/common/strings.js";import{$rd as b,$dd as H}from"../../../../../../../base/common/types.js";import{localize as P}from"../../../../../../../nls.js";import{$Mj as Y}from"../../../../../../../platform/instantiation/common/instantiation.js";import{$yo as W}from"../../../../../../../platform/log/common/log.js";import{$NQ as _}from"../../../../../../../platform/opener/common/opener.js";import{$Vn as q}from"../../../../../../../platform/product/common/productService.js";import{$hp as F}from"../../../../../../../platform/storage/common/storage.js";import{$D4b as N}from"../../../../../mcp/browser/mcpToolCallUI.js";import{McpResourceURI as y}from"../../../../../mcp/common/mcpTypes.js";import{McpApps as z}from"../../../../../mcp/common/modelContextProtocolApps.js";import{$MEb as X,$OEb as Z}from"../../../../../webview/browser/webview.js";import{$tV as B}from"../../../../common/tools/languageModelToolsService.js";import{$S6b as U}from"../../../chat.js";var k=function(h,t,e,o){var i=arguments.length,n=i<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(h,t,e,o);else for(var a=h.length-1;a>=0;a--)(s=h[a])&&(n=(i<3?s(n):i>3?s(t,e,n):s(t,e))||n);return i>3&&n&&Object.defineProperty(t,e,n),n},d=function(h,t){return function(e,o){t(e,o,h)}},m;const V="chatMcpApp.origins";let D=class extends L{static{m=this}static{this.a=new WeakMap}constructor(t,e,o,i,n,s,a,r,l,c,p,$){super(),this.toolInvocation=t,this.renderData=e,this.u=o,this.w=s,this.y=a,this.z=r,this.C=c,this.F=p,this.G=$,this.h=this.D(new x),this.j=!1,this.m=void 0,this.r=O(this,{status:"loading"}),this.loadState=this.r,this.t=this.D(new S),this.onDidChangeHeight=this.t.event,this.b=new Z(V,l),this.q=this.b.getOrigin("mcpApp",e.serverDefinitionId),this.g=this.D(this.w.createInstance(N,e)),this.n=m.a.get(this.toolInvocation)??300,this.f=this.D(this.z.createWebviewElement({origin:this.q,title:P(7040,null),options:{purpose:"chatOutputItem",enableFindWidget:!1,disableServiceWorker:!0,retainContextWhenHidden:!0},contentOptions:{allowMultipleAPIAcquire:!0,allowScripts:!0,allowForms:!0},extension:void 0}));const M=C.getWindow(this.u);this.f.mountTo(this.u,M),this.hostContext=this.g.hostContext.map((u,f)=>({...u,containerDimensions:{width:n.read(f),maxHeight:i.read(f)},toolCall:{toolCallId:this.toolInvocation.toolCallId,toolName:this.toolInvocation.toolId}})),this.D(R(u=>{const f=this.hostContext.read(u);this.j&&this.Z({method:"ui/notifications/host-context-changed",params:f})})),this.D(this.f.onMessage(async({message:u})=>{await this.L(u)})),this.H()}get height(){return this.n}remount(){this.f.reinitializeAfterDismount(),this.j=!1}retry(){this.r.set({status:"loading"},void 0),this.H()}async H(){const t=this.h.token;try{const e=await this.g.loadResource(t);if(t.isCancellationRequested)return;const o=this.I(e);this.j=!1,this.m=e.csp,this.f.setHtml(o),this.r.set({status:"loaded"},void 0)}catch(e){this.C.error("[MCP App] Error loading app:",e),this.r.set({status:"error",error:e},void 0)}}I({html:t,csp:e}){const o=a=>(a?.join(" ")||"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;"),n=`<meta http-equiv="Content-Security-Policy" content="${`
			default-src 'none';
