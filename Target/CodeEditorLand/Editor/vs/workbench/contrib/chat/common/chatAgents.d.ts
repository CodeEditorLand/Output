...
export declare function isChatWelcomeMessageContent(
	obj: any,
): obj is IChatWelcomeMessageContent;
export interface IChatAgentImplementation {
	...
	provideWelcomeMessage?(
		token: CancellationToken,
	): ProviderResult<IChatWelcomeMessageContent | undefined>;
	provideChatTitle?: (
		history: IChatAgentHistoryEntry[],
		token: CancellationToken,
...
export declare function getFullyQualifiedId(
	chatAgentData: IChatAgentData,
): string;
export declare function reviveSerializedAgent(
