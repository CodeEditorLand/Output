...
var ChatContextKeys;
((ChatContextKeys2) => {
  ChatContextKeys2.responseVote = new RawContextKey(
  ...
  ChatContextKeys2.responseDetectedAgentCommand = new RawContextKey(
  ...
  ChatContextKeys2.responseSupportsIssueReporting = new RawContextKey(
  ...
  ChatContextKeys2.responseIsFiltered = new RawContextKey(
  ...
  ChatContextKeys2.responseHasError = new RawContextKey(
  ...
  ChatContextKeys2.requestInProgress = new RawContextKey(
  ...
  ChatContextKeys2.isRequestPaused = new RawContextKey(
    "chatRequestIsPaused",
    false,
    {
      type: "boolean",
      description: localize(
        "chatRequestIsPaused",
        "True when the current request is paused."
      )
    }
  );
  ChatContextKeys2.canRequestBePaused = new RawContextKey(
    ...
    false,
    {
      ...
      description: localize(
        "chatCanRequestBePaused",
        "True when the current request can be paused."
      )
    }
  );
  ChatContextKeys2.isResponse = new RawContextKey(
    "chatResponse",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.isRequest = new RawContextKey("chatRequest", false, {
    type: "boolean",
    description: localize("chatRequest", "The chat item is a request")
  });
  ChatContextKeys2.itemId = new RawContextKey("chatItemId", "", {
    type: "string",
    description: localize("chatItemId", "The id of the chat item.")
  });
  ChatContextKeys2.lastItemId = new RawContextKey(
    "chatLastItemId",
    [],
    {
      type: "string",
  ...
  ChatContextKeys2.editApplied = new RawContextKey(
    "chatEditApplied",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.inputHasText = new RawContextKey(
    "chatInputHasText",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.inputHasFocus = new RawContextKey(
    "chatInputHasFocus",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.inChatInput = new RawContextKey(
    "inChatInput",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.inChatSession = new RawContextKey("inChat", false, {
    type: "boolean",
    description: localize(
      "inChat",
  ...
  ChatContextKeys2.inUnifiedChat = new RawContextKey(
    "inUnifiedChat",
    false,
    {
      type: "boolean",
      description: localize(
        "inUnifiedChat",
        "True when focus is in the unified chat widget, false otherwise."
      )
    }
  );
  ChatContextKeys2.instructionsAttached = new RawContextKey(
  ...
  ChatContextKeys2.chatMode = new RawContextKey(
    "chatMode",
    ChatMode.Ask,
    {
      type: "string",
  ...
  ChatContextKeys2.supported = ContextKeyExpr.or(
    IsWebContext.toNegated(),
    RemoteNameContext.notEqualsTo("")
  );
  ChatContextKeys2.enabled = new RawContextKey("chatIsEnabled", false, {
    type: "boolean",
    description: localize(
      "chatIsEnabled",
  ...
  ChatContextKeys2.panelParticipantRegistered = new RawContextKey(
  ...
  ChatContextKeys2.editingParticipantRegistered = new RawContextKey(
  ...
  ChatContextKeys2.chatEditingCanUndo = new RawContextKey(
    "chatEditingCanUndo",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.chatEditingCanRedo = new RawContextKey(
    "chatEditingCanRedo",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.extensionInvalid = new RawContextKey(
  ...
  ChatContextKeys2.inputCursorAtTop = new RawContextKey(
    "chatCursorAtTop",
    false
  );
  ChatContextKeys2.inputHasAgent = new RawContextKey(
    "chatInputHasAgent",
    false
  );
  ChatContextKeys2.location = new RawContextKey(
    "chatLocation",
    void 0
  );
  ChatContextKeys2.inQuickChat = new RawContextKey(
    "quickChatHasFocus",
    false,
    {
      type: "boolean",
  ...
  ChatContextKeys2.hasFileAttachments = new RawContextKey(
  ...
  ChatContextKeys2.languageModelsAreUserSelectable = new RawContextKey(
  ...
  ChatContextKeys2.SetupViewKeys = /* @__PURE__ */ new Set([
    ChatContextKeys2.Setup.hidden.key,
    ChatContextKeys2.Setup.installed.key,
    ChatContextKeys2.Entitlement.signedOut.key,
    ChatContextKeys2.Entitlement.canSignUp.key,
    ...ChatContextKeys2.Setup.fromDialog.keys()
  ]);
  ...
  ChatContextKeys2.chatQuotaExceeded = new RawContextKey(
    "chatQuotaExceeded",
    false,
    true
  );
  ChatContextKeys2.completionsQuotaExceeded = new RawContextKey(
  ...
  ChatContextKeys2.Editing = {
    hasToolsAgent: new RawContextKey("chatHasToolsAgent", false, {
      type: "boolean",
      description: localize(
        "chatEditingHasToolsAgent",
        "True when a tools agent is registered."
      )
    }),
    agentModeDisallowed: new RawContextKey(
      ...
      void 0,
      {
        ...
        description: localize(
          "chatAgentModeDisallowed",
          "True when agent mode is not allowed."
        )
      }
    ),
...
((ChatContextKeyExprs2) => {
  ChatContextKeyExprs2.unifiedChatEnabled = ContextKeyExpr.has(
    `config.${ChatConfiguration.UnifiedChatView}`
  );
  ChatContextKeyExprs2.inEditsOrUnified = ContextKeyExpr.or(
    ChatContextKeys.location.isEqualTo(ChatAgentLocation.EditingSession),
    ChatContextKeys.inUnifiedChat
  );
  ChatContextKeyExprs2.inNonUnifiedPanel = ContextKeyExpr.and(
