...
const CONTEXT_PARTICIPANT_SUPPORTS_MODEL_PICKER = new RawContextKey("chatParticipantSupportsModelPicker", true, { type: "boolean", description: localize("chatParticipantSupportsModelPicker", "True when the current chat participant supports picking the model manually.") });
export {
  ...
  CONTEXT_PARTICIPANT_SUPPORTS_MODEL_PICKER,
  CONTEXT_REQUEST,
  CONTEXT_RESPONSE,
