...
export declare const CHAT_EDITING_MULTI_DIFF_SOURCE_RESOLVER_SCHEME =
...
export declare const decidedChatEditingResourceContextKey: RawContextKey<
	string[]
>;
export declare const chatEditingResourceContextKey: RawContextKey<
	string | undefined
>;
export declare const inChatEditingSessionContextKey: RawContextKey<
	boolean | undefined
>;
export declare const applyingChatEditsContextKey: RawContextKey<
	boolean | undefined
>;
