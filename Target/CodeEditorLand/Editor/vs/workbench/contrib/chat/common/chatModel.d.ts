...
export declare function isChatRequestVariableEntry(
	obj: unknown,
...
export type IChatProgressResponseContent =
	...
	| IChatToolInvocation
	| IChatToolInvocationSerialized;
export declare function toChatHistoryContent(
...
export declare class ChatRequestModel implements IChatRequestModel {
	...
	constructor(
		...
		_variableData: IChatRequestVariableData,
		_attempt?: number,
		_confirmation?: string | undefined,
		_locationData?: IChatLocationData | undefined,
		_attachedContext?: IChatRequestVariableEntry[] | undefined,
	);
...
export declare class ChatResponseModel
	extends Disposable
	...
	constructor(
		_response:
			...
			| ReadonlyArray<
			  ...
			  >,
		_session: ChatModel,
		_agent: IChatAgentData | undefined,
		_slashCommand: IChatAgentCommand | undefined,
		requestId: string,
		_isComplete?: boolean,
		_isCanceled?: boolean,
		_vote?: ChatAgentVoteDirection | undefined,
		_voteDownReason?: ChatAgentVoteDownReason | undefined,
		_result?: IChatAgentResult | undefined,
 ...
 */
export declare function normalizeSerializableChatData(
	raw: ISerializableChatDataIn,
): ISerializableChatData;
export declare function isExportableSessionData(
	obj: unknown,
): obj is IExportableChatData;
export declare function isSerializableSessionData(
	obj: unknown,
...
export declare class ChatModel extends Disposable implements IChatModel {
	...
	constructor(
		...
		_initialLocation: ChatAgentLocation,
	...
	deinitialize(): void;
	initialize(
		welcomeMessage?: IChatWelcomeMessageContent,
		sampleQuestions?: IChatFollowup[],
	): void;
...
export declare function updateRanges(
	variableData: IChatRequestVariableData,
	diff: number,
): IChatRequestVariableData;
export declare function canMergeMarkdownStrings(
	md1: IMarkdownString,
	md2: IMarkdownString,
): boolean;
export declare function appendMarkdownString(
	md1: IMarkdownString,
	md2: IMarkdownString | string,
): IMarkdownString;
export declare function getCodeCitationsMessage(
