...
class ChatRequestModel {
  constructor(_session, message, _variableData, _attempt = 0, _confirmation, _locationData, _attachedContext, isCompleteAddedRequest = false) {
...
class ChatResponseModel extends Disposable {
  constructor(_response, _session, _agent, _slashCommand, requestId, _isComplete = false, _isCanceled = false, _vote, _voteDownReason, _result, followups, _isDisabled = false, isCompleteAddedRequest = false) {
    super();
    this._session = _session;
    this._agent = _agent;
...
let ChatModel = class extends Disposable {
  ...
  getRequests(includeDisabledRequests = true) {
  ...
  addRequest(message, variableData, attempt, chatAgent, slashCommand, confirmation, locationData, attachments, isCompleteAddedRequest) {
    ...
    request.response = new ChatResponseModel([], this, chatAgent, slashCommand, request.id, void 0, void 0, void 0, void 0, void 0, void 0, void 0, isCompleteAddedRequest);
  ...
  acceptResponseProgress(request, progress, quiet) {
    ...
    if (progress.kind === "markdownContent" || progress.kind === "treeData" || progress.kind === "inlineReference" || progress.kind === "codeblockUri" || progress.kind === "markdownVuln" || progress.kind === "progressMessage" || progress.kind === "command" || progress.kind === "textEdit" || progress.kind === "warning" || progress.kind === "progressTask" || progress.kind === "confirmation" || progress.kind === "toolInvocation") {
