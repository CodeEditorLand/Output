 ...
 */
export declare class ChatRequestAgentSubcommandPart
	implements IParsedChatRequestPart
{
	readonly range: OffsetRange;
	readonly editorRange: IRange;
 ...
 */
export declare class ChatRequestSlashCommandPart
	implements IParsedChatRequestPart
{
	readonly range: OffsetRange;
	readonly editorRange: IRange;
 ...
 */
export declare class ChatRequestDynamicVariablePart
	implements IParsedChatRequestPart
{
	readonly range: OffsetRange;
	readonly editorRange: IRange;
...
export declare function reviveParsedChatRequest(
...
export declare function formatChatQuestion(
