...
export declare function isRequestVM(
	item: unknown,
): item is IChatRequestViewModel;
export declare function isResponseVM(
	item: unknown,
): item is IChatResponseViewModel;
...
export declare class ChatResponseViewModel
	extends Disposable
	implements IChatResponseViewModel
{
	...
	constructor(
		_model: IChatResponseModel,
		logService: ILogService,
		chatAgentNameService: IChatAgentNameService,
	);
	private trace;
	setVote(vote: ChatAgentVoteDirection): void;
	setVoteDownReason(reason: ChatAgentVoteDownReason | undefined): void;
