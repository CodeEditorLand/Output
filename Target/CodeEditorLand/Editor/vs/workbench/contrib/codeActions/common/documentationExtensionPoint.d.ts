...
export declare const documentationExtensionPointDescriptor: {
	...
	deps: import("../../../services/extensions/common/extensionsRegistry.js").IExtensionPoint<
		import("../../../services/language/common/languageService.js").IRawLanguageExtensionPoint[]
	>[];
