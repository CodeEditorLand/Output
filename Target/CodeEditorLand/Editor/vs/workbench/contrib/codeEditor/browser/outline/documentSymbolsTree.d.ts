...
export declare class DocumentSymbolNavigationLabelProvider
	implements IKeyboardNavigationLabelProvider<DocumentSymbolItem>
{
	getKeyboardNavigationLabel(element: DocumentSymbolItem): {
		toString(): string;
	};
}
export declare class DocumentSymbolAccessibilityProvider
	implements IListAccessibilityProvider<DocumentSymbolItem>
{
...
export declare class DocumentSymbolIdentityProvider
	implements IIdentityProvider<DocumentSymbolItem>
{
...
declare class DocumentSymbolTemplate {
	...
	constructor(
		...
		iconLabel: IconLabel,
		iconClass: HTMLElement,
		decoration: HTMLElement,
	);
}
export declare class DocumentSymbolVirtualDelegate
	implements IListVirtualDelegate<DocumentSymbolItem>
{
	getHeight(_element: DocumentSymbolItem): number;
	getTemplateId(element: DocumentSymbolItem): string;
}
export declare class DocumentSymbolGroupRenderer
	implements
		ITreeRenderer<OutlineGroup, FuzzyScore, DocumentSymbolGroupTemplate>
{
...
export declare class DocumentSymbolRenderer
	implements
...
export declare class DocumentSymbolFilter
	implements ITreeFilter<DocumentSymbolItem>
{
	...
	constructor(
		_prefix: "breadcrumbs" | "outline",
		_textResourceConfigService: ITextResourceConfigurationService,
	);
	filter(element: DocumentSymbolItem): boolean;
}
export declare class DocumentSymbolComparator
	implements IOutlineComparator<DocumentSymbolItem>
{
