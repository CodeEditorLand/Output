...
export declare function isMouseUpEventDragFromMouseDown(
	mouseDownInfo: {
		lineNumber: number;
	} | null,
	e: IEditorMouseEvent,
): number | null;
export declare function isMouseUpEventMatchMouseDown(
	mouseDownInfo: {
		lineNumber: number;
	} | null,
	e: IEditorMouseEvent,
): number | null;
export declare class ReviewZoneWidget
	extends ZoneWidget
	implements ICommentThreadWidget
{
	...
	constructor(
		editor: ICodeEditor,
		_uniqueOwner: string,
		_commentThread: languages.CommentThread,
