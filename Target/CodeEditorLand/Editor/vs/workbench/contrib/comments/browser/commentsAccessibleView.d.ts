...
export declare class CommentsAccessibleView
	extends Disposable
	implements IAccessibleViewImplentation
{
	...
	): CommentsAccessibleContentProvider | undefined;
	constructor();
}
export declare class CommentThreadAccessibleView
	extends Disposable
	implements IAccessibleViewImplentation
{
	...
	getProvider(
		accessor: ServicesAccessor,
	): CommentsThreadWidgetAccessibleContentProvider | undefined;
	constructor();
}
declare class CommentsAccessibleContentProvider
	extends Disposable
	implements IAccessibleViewContentProvider
{
	...
	constructor(
		_commentsView: CommentsPanel,
		_focusedCommentNode: any,
		_menus: CommentsMenus,
	);
...
declare class CommentsThreadWidgetAccessibleContentProvider
	extends Disposable
	implements IAccessibleViewContentProvider
{
