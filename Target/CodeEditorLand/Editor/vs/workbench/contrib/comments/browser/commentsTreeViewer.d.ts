...
export declare class ResourceWithCommentsRenderer
	implements
		IListRenderer<
...
export declare class CommentNodeRenderer
	implements
...
export declare class CommentsList extends WorkbenchObjectTree<
