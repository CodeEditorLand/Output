...
export declare abstract class AbstractExpressionDataSource<
	Input,
...
> implements IAsyncDataSource<Input, Element>
{
	...
	constructor(
		...
		debugVisualizer: IDebugVisualizerService,
	);
...
export declare abstract class AbstractExpressionsRenderer<T = IExpression>
