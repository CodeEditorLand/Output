...
export declare const makeStackFrameColumnDecoration: (
	noCharactersBefore: boolean,
) => IModelDecorationOptions;
export declare function createDecorationsForStackFrame(
	stackFrame: IStackFrame,
	isFocusedSession: boolean,
	noCharactersBefore: boolean,
): IModelDeltaDecoration[];
export declare class CallStackEditorContribution
	extends Disposable
