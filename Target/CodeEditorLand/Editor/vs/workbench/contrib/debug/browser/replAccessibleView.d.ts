...
export declare class ReplAccessibleView implements IAccessibleViewImplentation {
	...
	): ReplOutputAccessibleViewProvider | undefined;
}
declare class ReplOutputAccessibleViewProvider
	extends Disposable
	implements IAccessibleViewContentProvider
{
	...
	constructor(
		_replView: Repl,
		_focusedElement: IReplElement | undefined,
		_accessibleViewService: IAccessibleViewService,
	);
