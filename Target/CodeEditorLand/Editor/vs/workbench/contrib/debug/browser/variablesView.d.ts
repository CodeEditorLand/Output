...
export declare function openContextMenuForVariableTreeElement(
...
export declare class VisualizedVariableRenderer extends AbstractExpressionsRenderer {
	 ...
	 * or cancelled./
	 */
	static rendererOnVisualizationRange(
		model: IViewModel,
...
export declare class VariablesRenderer extends AbstractExpressionsRenderer {
	...
	constructor(
		...
		menuService: IMenuService,
		contextKeyService: IContextKeyService,
		visualization: IDebugVisualizerService,
		contextMenuService: IContextMenuService,
		debugService: IDebugService,
		contextViewService: IContextViewService,
		hoverService: IHoverService,
...
export declare const VIEW_MEMORY_ID =
	"workbench.debug.viewlet.action.viewMemory";
export declare const BREAK_WHEN_VALUE_CHANGES_ID =
	"debug.breakWhenValueChanges";
export declare const BREAK_WHEN_VALUE_IS_ACCESSED_ID =
