...
export declare class ExpressionContainer implements IExpressionContainer {
	...
	constructor(
		...
		_reference: number | undefined,
		id: string,
		namedVariables?: number | undefined,
		indexedVariables?: number | undefined,
		memoryReference?: string | undefined,
		startOfVariables?: number | undefined,
		presentationHint?: DebugProtocol.VariablePresentationHint | undefined,
		valueLocationReference?: number | undefined,
	);
...
export declare class VisualizedExpression implements IExpression {
	...
	constructor(
		session: IDebugSession | undefined,
		visualizer: IDebugVisualizerService,
		treeId: string,
		treeItem: IDebugVisualizationTreeItem,
		original?: Variable | undefined,
	);
	getSession(): IDebugSession | undefined;
	...
	implements IExpression
{
	...
	constructor(
		...
		idDuplicationIndex?: string,
		declarationLocationReference?: number | undefined,
		valueLocationReference?: number | undefined,
	);
 ...
 */
export declare const getUriForDebugMemory: (
	sessionId: string,
...
export declare abstract class BaseBreakpoint
	extends Enablement
...
export declare class FunctionBreakpoint
...
export declare class DataBreakpoint
	extends BaseBreakpoint
	implements IDataBreakpoint
{
...
export declare class ExceptionBreakpoint
	extends BaseBreakpoint
...
export declare class InstructionBreakpoint
	extends BaseBreakpoint
