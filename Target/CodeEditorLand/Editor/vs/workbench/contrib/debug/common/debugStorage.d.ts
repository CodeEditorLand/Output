...
export declare class DebugStorage extends Disposable {
	...
	readonly breakpoints: import("../../../../base/common/observable.js").ISettableObservable<
		Breakpoint[],
		void
	>;
	readonly functionBreakpoints: import("../../../../base/common/observable.js").ISettableObservable<
		FunctionBreakpoint[],
		void
	>;
	readonly exceptionBreakpoints: import("../../../../base/common/observable.js").ISettableObservable<
		ExceptionBreakpoint[],
		void
	>;
	readonly dataBreakpoints: import("../../../../base/common/observable.js").ISettableObservable<
		DataBreakpoint[],
		void
	>;
	readonly watchExpressions: import("../../../../base/common/observable.js").ISettableObservable<
		Expression[],
		void
	>;
	constructor(
