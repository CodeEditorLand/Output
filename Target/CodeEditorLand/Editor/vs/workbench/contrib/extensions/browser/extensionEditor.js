...
__name(toMemoryString, "toMemoryString");
  ...
  renderInstallInfo(container, extension) {
    ...
    append(
      ...
      $(
        ".more-info-entry",
        void 0,
        $("div", void 0, localize("Version", "Version")),
    ...
    if (extension.installedTimestamp) {
      append(
        ...
        $(
          ...
          $("div", void 0, toDateString(new Date(extension.installedTimestamp)))
        )
      );
    }
    if (extension.source !== "gallery") {
      ...
      append(
        ...
        $(
          ".more-info-entry",
          void 0,
          $("div", void 0, localize("source", "Source")),
          element
        )
      );
    ...
    if (extension.size) {
      const element = $("div", void 0, toMemoryString(extension.size));
      append(
        installInfo,
        $(
          ".more-info-entry",
    ...
    this.getCacheLocation(extension).then((cacheLocation) => {
      ...
      computeSize(cacheLocation, this.fileService).then((cacheSize) => {
        ...
        const element = $("div", void 0, toMemoryString(cacheSize));
        append(
          installInfo,
          $(
            ".more-info-entry",
...
ExtensionEditor = __decorateClass([
  ...
  __decorateParam(21, IRemoteAgentService),
