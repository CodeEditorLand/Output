...
export declare abstract class ExtensionAction
	extends Action
...
export declare class InstallAction extends ExtensionAction {
	...
	constructor(
		...
		instantiationService: IInstantiationService,
		runtimeExtensionService: IExtensionService,
		workbenchThemeService: IWorkbenchThemeService,
...
export declare abstract class InstallInOtherServerAction extends ExtensionAction {
	...
	constructor(
		id: string,
		server: IExtensionManagementServer | null,
...
export declare function getContextMenuActions(
...
export declare class IgnoreExtensionRecommendationAction extends Action {
	...
	constructor(
		extension: IExtension,
		extensionRecommendationsManagementService: IExtensionIgnoredRecommendationsService,
	);
	run(): Promise<any>;
}
...
export declare class ExtensionStatusLabelAction
	extends Action
	implements IExtensionContainer
{
	private readonly extensionService;
...
export declare const showExtensionsWithIdsCommandId =
