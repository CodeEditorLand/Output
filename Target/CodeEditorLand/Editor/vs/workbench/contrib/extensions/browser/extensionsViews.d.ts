...
export declare class ExtensionsListView extends ViewPane {
	...
	protected getInstallableRecommendations(
...
export declare class StaticQueryExtensionsView extends ExtensionsListView {
	...
	constructor(
		options: StaticQueryExtensionsViewOptions,
		viewletViewOptions: IViewletViewOptions,
		notificationService: INotificationService,
		keybindingService: IKeybindingService,
		contextMenuService: IContextMenuService,
...
export declare class WorkspaceRecommendedExtensionsView
...
export declare function getAriaLabelForExtension(
