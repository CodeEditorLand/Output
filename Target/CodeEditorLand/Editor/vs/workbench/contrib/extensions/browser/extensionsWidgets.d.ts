...
export declare abstract class ExtensionWidget
	extends Disposable
...
export declare class ExtensionHoverWidget extends ExtensionWidget {
	...
	constructor(
		options: ExtensionHoverOptions,
		extensionStatusAction: ExtensionStatusAction,
		extensionsWorkbenchService: IExtensionsWorkbenchService,
		hoverService: IHoverService,
		configurationService: IConfigurationService,
		extensionRecommendationsService: IExtensionRecommendationsService,
...
export declare class ExtensionRecommendationWidget extends ExtensionWidget {
	...
	constructor(
		container: HTMLElement,
		extensionRecommendationsService: IExtensionRecommendationsService,
		extensionIgnoredRecommendationsService: IExtensionIgnoredRecommendationsService,
	);
	render(): void;
