...
export declare function findValidPasteFileTarget(
...
export declare function incrementFileName(
	name: string,
	isFolder: boolean,
...
export declare function validateFileName(
...
export declare const renameHandler: (
	accessor: ServicesAccessor,
) => Promise<void>;
export declare const moveFileToTrashHandler: (
	accessor: ServicesAccessor,
) => Promise<void>;
export declare const deleteFileHandler: (
	accessor: ServicesAccessor,
) => Promise<void>;
export declare const copyFileHandler: (
	accessor: ServicesAccessor,
) => Promise<void>;
export declare const cutFileHandler: (
	accessor: ServicesAccessor,
) => Promise<void>;
export declare const pasteFileHandler: (
	accessor: ServicesAccessor,
	fileList?: FileList,
) => Promise<void>;
export declare const openFilePreserveFocusHandler: (
	accessor: ServicesAccessor,
) => Promise<void>;
declare class BaseSetActiveEditorReadonlyInSession extends Action2 {
	...
	constructor(
		...
		newReadonlyState: true | false | "toggle" | "reset",
	);
	run(accessor: ServicesAccessor): Promise<void>;
}
