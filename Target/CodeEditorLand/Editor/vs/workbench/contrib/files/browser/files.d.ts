...
export declare function getResourceForCommand(
	commandArg: unknown,
	editorService: IEditorService,
	listService: IListService,
): URI | undefined;
export declare function getMultiSelectedResources(
	commandArg: unknown,
	listService: IListService,
...
export declare function getOpenEditorsViewMultiSelection(
