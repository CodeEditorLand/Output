...
export declare class ExplorerDelegate
	implements IListVirtualDelegate<ExplorerItem>
{
...
export declare class ExplorerDataSource
...
export declare class CompressedNavigationController
...
export declare class FilesRenderer
	implements
		...
		IDisposable
{
	...
	constructor(
		...
		updateWidth: (stat: ExplorerItem) => void,
 ...
 */
export declare class FilesFilter
	implements ITreeFilter<ExplorerItem, FuzzyScore>
{
	private readonly contextService;
	private readonly configurationService;
	private readonly explorerService;
...
export declare class FileDragAndDrop implements ITreeDragAndDrop<ExplorerItem> {
	...
	private dropEnabled;
	constructor(
		isCollapsed: (item: ExplorerItem) => boolean,
		explorerService: IExplorerService,
		editorService: IEditorService,
...
export declare function isCompressedFolderName(
	target: HTMLElement | EventTarget | Element | null,
): boolean;
export declare class ExplorerCompressionDelegate
