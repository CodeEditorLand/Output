...
export declare class Session {
	...
	constructor(
		...
		hunkData: HunkData,
		chatModel: ChatModel,
		versionsByRequest?: [string, number][],
	);
...
export declare class StashedSession {
	...
	constructor(
		editor: ICodeEditor,
		session: Session,
		_undoCancelEdits: IValidEditOperation[],
		contextKeyService: IContextKeyService,
		_sessionService: IInlineChatSessionService,
...
export declare class HunkData {
	...
	constructor(
		...
		_textModel0: ITextModel,
		_textModelN: ITextModel,
	);
	dispose(): void;
