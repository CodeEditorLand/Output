...
export declare class MarkersWidgetAccessibilityProvider
...
export declare class VirtualDelegate
	implements IListVirtualDelegate<MarkerElement>
{
...
export declare class ResourceMarkersRenderer
	implements
		ITreeRenderer<
			ResourceMarkers,
			ResourceMarkersFilterData,
	...
	implements ITreeRenderer<Marker, MarkerFilterData, IMarkerTemplateData>
{
	...
	constructor(
		markersViewState: MarkersViewModel,
...
export declare class RelatedInformationRenderer
	implements
		ITreeRenderer<
			RelatedInformation,
			RelatedInformationFilterData,
...
export declare class MarkersViewModel extends Disposable {
	...
	constructor(
		...
		viewMode: MarkersViewMode | undefined,
