...
export declare namespace Markers {
	...
	const RELATED_INFORMATION_COPY_MESSAGE_ACTION_ID =
		"problems.action.copyRelatedInformationMessage";
	const FOCUS_PROBLEMS_FROM_FILTER =
	...
	const MARKERS_VIEW_SHOW_MULTILINE_MESSAGE =
		"problems.action.showMultilineMessage";
	const MARKERS_VIEW_SHOW_SINGLELINE_MESSAGE =
	...
	const TOGGLE_MARKERS_VIEW_ACTION_ID =
