...
export declare class MappingAlignment<T extends LineRangeMapping> {
	...
	static compute<T extends LineRangeMapping>(
		fromInputToOutput1: readonly T[],
		fromInputToOutput2: readonly T[],
	): MappingAlignment<T>[];
	constructor(
		inputRange: LineRange,
		output1Range: LineRange,
		output1LineMappings: T[],
		output2Range: LineRange,
		output2LineMappings: T[],
	);
	toString(): string;
}
/**
...
export declare class DetailedLineRangeMapping extends LineRangeMapping {
	...
	constructor(
		inputRange: LineRange,
		inputTextModel: ITextModel,
		outputRange: LineRange,
		outputTextModel: ITextModel,
