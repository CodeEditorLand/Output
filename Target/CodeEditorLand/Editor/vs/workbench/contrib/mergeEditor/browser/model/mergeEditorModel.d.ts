...
export declare class MergeEditorModel extends EditorModel {
	...
	constructor(
		...
		input1: InputData,
		input2: InputData,
		resultTextModel: ITextModel,
		diffComputer: IMergeDiffComputer,
		options: {
			resetResult: boolean;
		},
	...
	readonly baseInput1Diffs: IObservable<
		DetailedLineRangeMapping[],
		TextModelDiffChangeReason
	>;
	readonly baseInput2Diffs: IObservable<
		DetailedLineRangeMapping[],
		TextModelDiffChangeReason
	>;
	readonly baseResultDiffs: IObservable<
		DetailedLineRangeMapping[],
		TextModelDiffChangeReason
	>;
	...
	readonly inputDiffComputingState: IObservable<
