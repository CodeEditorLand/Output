...
export declare class ModifiedBaseRange {
	...
	constructor(
		baseRange: LineRange,
		baseTextModel: ITextModel,
		input1Range: LineRange,
		input1TextModel: ITextModel,
		/**
		 * From base to input1
		 */
		input1Diffs: readonly DetailedLineRangeMapping[],
		input2Range: LineRange,
		input2TextModel: ITextModel,
		/**
		 * From base to input2
		 */
...
export declare function getOtherInputNumber(
