...
export declare function leftJoin<TLeft, TRight>(
	left: Iterable<TLeft>,
...
export declare function join<TLeft, TRight>(
	left: Iterable<TLeft>,
	right: readonly TRight[],
	compare: (left: TLeft, right: TRight) => CompareResult,
): IterableIterator<{
...
export declare function concatArrays<TArr extends any[]>(
	...arrays: TArr
): TArr[number][number][];
export declare function elementAtOrUndefined<T>(
	arr: T[],
	index: number,
): T | undefined;
export declare function thenIfNotDisposed<T>(
	promise: Promise<T>,
	then: () => void,
): IDisposable;
