...
export declare abstract class CodeEditorView extends Disposable {
	...
	readonly model: IObservable<
		import("../../model/mergeEditorModel.js").MergeEditorModel | undefined,
		unknown
	>;
	...
	readonly cursorPosition: IObservable<
	...
	constructor(
		...
		viewModel: IObservable<undefined | MergeEditorViewModel>,
		configurationService: IConfigurationService,
	);
	protected getEditorContributions(): IEditorContributionDescription[];
}
export declare function createSelectionsAutorun(
