...
export declare class ScrollSynchronizer extends Disposable {
	...
	constructor(
		...
		input2View: InputCodeEditorView,
		baseView: IObservable<BaseCodeEditorView | undefined>,
		inputResultView: ResultCodeEditorView,
		layout: IObservable<IMergeEditorLayout>,
	);
