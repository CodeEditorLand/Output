...
export declare class MergeEditorViewZones {
	...
	constructor(
		input1ViewZones: readonly MergeEditorViewZone[],
		input2ViewZones: readonly MergeEditorViewZone[],
		baseViewZones: readonly MergeEditorViewZone[],
		resultViewZones: readonly MergeEditorViewZone[],
	);
}
/**
