...
export declare class MultiDiffEditorInput
	extends EditorInput
	implements ILanguageSupport
{
	...
	static fromResourceMultiDiffEditorInput(
	...
	readonly resources: import("../../../../base/common/observable.js").IObservable<
		readonly MultiDiffEditorItem[] | undefined,
		unknown
	>;
