...
export declare class NotebookQuickPickProvider
	implements IQuickPickDataSource<OutlineEntry>
{
	...
	constructor(
		notebookCellOutlineDataSourceRef:
...
export declare class NotebookOutlinePaneProvider
...
export declare class NotebookBreadcrumbsProvider
...
export declare class NotebookOutlineCreator
