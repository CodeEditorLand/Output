...
export declare class CodeActionParticipantUtils {
	static checkAndRunFormatCodeAction(
		accessor: ServicesAccessor,
		notebookModel: NotebookTextModel,
		progress: IProgress<IProgressStep>,
		token: CancellationToken,
	): Promise<boolean>;
	static applyOnSaveGenericCodeActions(
		accessor: ServicesAccessor,
		model: ITextModel,
	...
	static applyOnSaveFormatCodeAction(
		accessor: ServicesAccessor,
		model: ITextModel,
	...
	static getActionsToRun(
		...
		import("../../../../../../editor/contrib/codeAction/common/types.js").CodeActionSet
	>;
}
export declare class SaveParticipantsContribution
	extends Disposable
