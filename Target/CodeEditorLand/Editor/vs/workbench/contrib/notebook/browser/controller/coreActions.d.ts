...
export declare const NOTEBOOK_EDITOR_WIDGET_ACTION_WEIGHT =
...
export declare function getContextFromActiveEditor(
	editorService: IEditorService,
): INotebookActionContext | undefined;
export declare function getContextFromUri(
	...
	| undefined;
export declare function findTargetCellEditor(
...
export declare abstract class NotebookCellAction<
...
export declare const executeNotebookCondition:
	| import("../../../../../platform/contextkey/common/contextkey.js").ContextKeyExpression
	| undefined;
export declare function getEditorFromArgsOrActivePane(
	accessor: ServicesAccessor,
	context?: UriComponents,
): IActiveNotebookEditor | undefined;
export declare function parseMultiCellExecutionArgs(
	accessor: ServicesAccessor,
	...args: any[]
): INotebookCommandContext | undefined;
