...
declare class PropertyHeader extends Disposable {
	...
	constructor(
		...
		propertyHeaderContainer: HTMLElement,
...
export declare class NotebookDocumentMetadataElement extends Disposable {
	...
	constructor(
		notebookEditor: INotebookTextDiffEditor,
		viewModel: NotebookDocumentMetadataViewModel,
...
declare abstract class AbstractElementRenderer extends Disposable {
	...
	constructor(
		notebookEditor: INotebookTextDiffEditor,
		cell: DiffElementCellViewModelBase,
		templateData:
			| CellDiffSingleSideRenderTemplate
			| CellDiffSideBySideRenderTemplate,
...
export declare class CollapsedCellOverlayWidget
	extends Disposable
...
export declare class UnchangedCellOverlayWidget
	extends Disposable
	implements IDiffCellMarginOverlay
{
	private readonly container;
