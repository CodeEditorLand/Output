...
export declare class NotebookDocumentMetadataViewModel extends DiffElementViewModelBase {
	...
	constructor(
		originalDocumentTextModel: INotebookTextModel,
		modifiedDocumentTextModel: INotebookTextModel,
		type: "unchangedMetadata" | "modifiedMetadata",
		editorEventDispatcher: NotebookDiffEditorEventDispatcher,
		initData: {
			metadataStatusHeight: number;
			outputStatusHeight: number;
...
export declare abstract class DiffElementCellViewModelBase extends DiffElementViewModelBase {
	...
	constructor(
		...
		type: "unchanged" | "insert" | "delete" | "modified",
		editorEventDispatcher: NotebookDiffEditorEventDispatcher,
		initData: {
			metadataStatusHeight: number;
			outputStatusHeight: number;
	...
	private _fireLayoutChangeEvent;
	abstract checkIfInputModified():
		| false
		| {
				reason: string | undefined;
		  };
	abstract checkIfOutputsModified():
		| false
		| {
				reason: string | undefined;
		  };
	abstract checkMetadataIfModified():
		| false
		| {
				reason: string | undefined;
		  };
...
export declare class SideBySideDiffElementViewModel extends DiffElementCellViewModelBase {
	...
	constructor(
		...
		otherDocumentTextModel: NotebookTextModel,
...
export declare function outputEqual(
	a: ICellOutput,
	b: ICellOutput,
): OutputComparison;
export declare function getStreamOutputData(
