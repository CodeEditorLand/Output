...
export declare class NotebookCellTextDiffListDelegate
...
export declare class CellDiffPlaceholderRenderer
	implements
		IListRenderer<
			DiffElementPlaceholderViewModel,
			CellDiffPlaceholderRenderTemplate
...
export declare class NotebookDocumentMetadataDiffRenderer
	implements
		IListRenderer<
			NotebookDocumentMetadataViewModel,
			NotebookDocumentDiffElementRenderTemplate
...
export declare class CellDiffSingleSideRenderer
	implements
		IListRenderer<
			SingleSideDiffElementViewModel,
...
export declare class CellDiffSideBySideRenderer
	implements
		IListRenderer<
			SideBySideDiffElementViewModel,
			CellDiffSideBySideRenderTemplate
...
export declare class NotebookTextDiffList
	...
	implements IDisposable, IStyleController
{
	...
	updateElementHeight2(
		element: IDiffElementViewModelBase,
		size: number,
	): void;
