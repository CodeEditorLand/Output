...
export declare const EXPAND_CELL_INPUT_COMMAND_ID =
...
export declare const EXPAND_CELL_OUTPUT_COMMAND_ID =
...
export declare const KERNEL_RECOMMENDATIONS: Map<
	string,
...
export type NotebookViewCellsSplice = [number, number, ICellViewModel[]];
...
export declare function getNotebookEditorFromEditorPane(
 ...
 */
export declare function expandCellRangesWithHiddenCells(
	editor: INotebookEditor,
	ranges: ICellRange[],
): ICellRange[];
export declare function cellRangeToViewCells(
