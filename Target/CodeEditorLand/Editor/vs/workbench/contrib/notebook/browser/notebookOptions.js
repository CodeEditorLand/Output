...
let NotebookOptions = class extends Disposable {
  constructor(targetWindow, isReadonly, overrides, configurationService, notebookExecutionStateService, codeEditorService) {
    ...
    const markupFontFamily = this.configurationService.getValue(
  ...
  previousModelToCompare = observableValue("previousModelToCompare", void 0);
  ...
  _updateConfiguration(e) {
    ...
    const markupFontFamily = e.affectsConfiguration(
      NotebookSetting.markupFontFamily
    );
    ...
    if (markupFontFamily) {
      configuration.markupFontFamily = this.configurationService.getValue(
        NotebookSetting.markupFontFamily
      );
    }
