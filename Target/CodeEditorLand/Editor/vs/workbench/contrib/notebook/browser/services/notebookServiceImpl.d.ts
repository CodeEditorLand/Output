...
export declare class NotebookProviderInfoStore extends Disposable {
	...
	constructor(
		...
		_editorResolverService: IEditorResolverService,
		_configurationService: IConfigurationService,
		_accessibilityService: IAccessibilityService,
		_instantiationService: IInstantiationService,
		_fileService: IFileService,
		_notebookEditorModelResolverService: INotebookEditorModelResolverService,
	...
	implements INotebookService
{
	...
	constructor(
		...
		_notebookDocumentService: INotebookDocumentService,
	);
