import{getWindow as A}from"../../../../../../base/browser/dom.js";import{$$b as q}from"../../../../../../base/common/arrays.js";import{$ui as O,$ni as K}from"../../../../../../base/common/async.js";import{$qj as V}from"../../../../../../base/common/buffer.js";import{$xf as X}from"../../../../../../base/common/event.js";import{$ED as Y,$GD as Q}from"../../../../../../base/common/mime.js";import{$th as Z,Schemas as h,$ih as R,$jh as ee}from"../../../../../../base/common/network.js";import{$Mp as te}from"../../../../../../base/common/objects.js";import*as ie from"../../../../../../base/common/path.js";import{$n as oe,$s as se}from"../../../../../../base/common/platform.js";import{$Hh as g,$Gh as re,$Bh as ne,$Ih as ae}from"../../../../../../base/common/resources.js";import{URI as b}from"../../../../../../base/common/uri.js";import*as C from"../../../../../../base/common/uuid.js";import{$yG as P}from"../../../../../../editor/common/languages.js";import{$zG as de}from"../../../../../../editor/common/languages/language.js";import{$kM as ue}from"../../../../../../editor/common/languages/supports/tokenization.js";import{$2jb as le}from"../../../../../../editor/common/languages/textToHtmlTokenizer.js";import*as v from"../../../../../../nls.js";import{$TH as ce}from"../../../../../../platform/actions/common/actions.js";import{$0l as pe}from"../../../../../../platform/configuration/common/configuration.js";import{$xo as he}from"../../../../../../platform/contextkey/common/contextkey.js";import{$7kb as fe}from"../../../../../../platform/contextview/browser/contextView.js";import{$Up as be}from"../../../../../../platform/dialogs/common/dialogs.js";import{$vk as me}from"../../../../../../platform/files/common/files.js";import{$1Q as ge}from"../../../../../../platform/opener/common/opener.js";import{$np as ke}from"../../../../../../platform/storage/common/storage.js";import{$vp as ve}from"../../../../../../platform/telemetry/common/telemetry.js";import{$gr as we,$ir as ye}from"../../../../../../platform/theme/common/colorRegistry.js";import{$wu as Ie,$Eu as Ce}from"../../../../../../platform/theme/common/themeService.js";import{$Ml as G}from"../../../../../../platform/workspace/common/workspace.js";import{$uJ as Me}from"../../../../../../platform/workspace/common/workspaceTrust.js";import{CellEditState as Ee}from"../../notebookBrowser.js";import{$gJb as $e}from"../notebookCellList.js";import{$jJb as xe}from"./webviewPreloads.js";import{$kJb as Oe}from"./webviewThemeMapping.js";import{$ZIb as M}from"../../viewModel/markupCellViewModel.js";import{CellUri as Re}from"../../../common/notebookCommon.js";import{$bR as Ge}from"../../../common/notebookLoggingService.js";import{$sFb as Se}from"../../../common/notebookService.js";import{$IFb as We,$KFb as Ne}from"../../../../webview/browser/webview.js";import{$mJb as Pe}from"../../../../webview/browser/webviewWindowDragMonitor.js";import{$qJb as Le,$pJb as w}from"../../../../webview/common/webview.js";import{$RM as De}from"../../../../../services/editor/common/editorGroupsService.js";import{$4Q as Be}from"../../../../../services/environment/common/environmentService.js";import{$F3 as Ue}from"../../../../../services/path/common/pathService.js";import{$uJb as Fe,$tJb as He,$wJb as Te}from"../../viewModel/cellOutputTextHelper.js";var J=function(c,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,t,o);else for(var n=c.length-1;n>=0;n--)(s=c[n])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i},l=function(c,e){return function(t,o){e(t,o,c)}},E;const ze=/:([\d]+)(?::([\d]+))?$/,_e=/line=(\d+)$/,je=/^(.*)#([^#]*)$/;let S=class extends Ce{static{E=this}static b(e){return this.a??=new Ne("notebook.backlayerWebview.origins",e),this.a}constructor(e,t,o,r,i,s,n,a,d,u,p,m,f,y,k,$,L,D,B,U,F,H,T,z,_){super(z),this.notebookEditor=e,this.F=t,this.notebookViewType=o,this.documentUri=r,this.G=i,this.H=s,this.I=n,this.J=a,this.L=d,this.M=u,this.N=p,this.O=m,this.P=f,this.Q=y,this.R=k,this.S=$,this.U=L,this.W=D,this.X=B,this.Y=U,this.Z=F,this.$=H,this.ab=T,this.bb=_,this.webview=void 0,this.insetMapping=new Map,this.pendingWebviewIdleCreationRequest=new Map,this.pendingWebviewIdleInsetMapping=new Map,this.c=new Map,this.markupPreviewMapping=new Map,this.f=new Set,this.g=new Map,this.j=void 0,this.m=this.D(new X),this.r=new Set,this.onMessage=this.m.event,this.s=!1,this.u=!0,this.C=C.$mn(),this.cb("Creating backlayer webview for notebook"),this.element=document.createElement("div"),this.element.style.height="1400px",this.element.style.position="absolute",s&&(this.D(s),s.receiveMessageHandler=(x,I)=>!this.webview||this.s?Promise.resolve(!1):(this.Eb({__vscode_notebook_message:!0,type:"customRendererMessage",rendererId:x,message:I}),Promise.resolve(!0))),this.D($.onDidChangeTrust(x=>{const I=this.jb(this.lb(),void 0),j=this.gb(I.toString());this.webview?.setHtml(j)})),this.D(P.onDidChange(()=>{this.Eb({type:"tokenizedStylesChanged",css:N()})}))}updateOptions(e){this.G=e,this.db(),this.eb()}cb(e){this.ab.debug("BacklayerWebview",`${this.documentUri} (${this.F}) - ${e}`)}db(){this.Eb({type:"notebookStyles",styles:this.fb()})}eb(){this.Eb({type:"notebookOptions",options:{dragAndDropEnabled:this.G.dragAndDropEnabled},renderOptions:{lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError}})}fb(){return{"notebook-output-left-margin":`${this.G.leftMargin+this.G.runGutter}px`,"notebook-output-width":`calc(100% - ${this.G.leftMargin+this.G.rightMargin+this.G.runGutter}px)`,"notebook-output-node-padding":`${this.G.outputNodePadding}px`,"notebook-run-gutter":`${this.G.runGutter}px`,"notebook-preview-node-padding":`${this.G.previewNodePadding}px`,"notebook-markdown-left-margin":`${this.G.markdownLeftMargin}px`,"notebook-output-node-left-padding":`${this.G.outputNodeLeftPadding}px`,"notebook-markdown-min-height":`${this.G.previewNodePadding*2}px`,"notebook-markup-font-size":typeof this.G.markupFontSize=="number"&&this.G.markupFontSize>0?`${this.G.markupFontSize}px`:`calc(${this.G.fontSize}px * 1.2)`,"notebook-markdown-line-height":typeof this.G.markdownLineHeight=="number"&&this.G.markdownLineHeight>0?`${this.G.markdownLineHeight}px`:"normal","notebook-cell-output-font-size":`${this.G.outputFontSize||this.G.fontSize}px`,"notebook-cell-output-line-height":`${this.G.outputLineHeight}px`,"notebook-cell-output-max-height":`${this.G.outputLineHeight*this.G.outputLineLimit+2}px`,"notebook-cell-output-font-family":this.G.outputFontFamily||this.G.fontFamily,"notebook-cell-markup-empty-content":v.localize(12808,null),"notebook-cell-renderer-not-found-error":v.localize(12809,null),"notebook-cell-renderer-fallbacks-exhausted":v.localize(12810,null),"notebook-markup-font-family":this.G.markupFontFamily}}gb(e){const t=this.hb(),o=this.ib(),r={lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError},i=xe({...this.G,tokenizationCss:N()},{dragAndDropEnabled:this.G.dragAndDropEnabled},r,t,o,this.S.isWorkspaceTrusted(),this.C),s=this.U.getValue("notebook.experimental.enableCsp"),n=this.z(we),a=this.z(ye);return`
		<html lang="en">
			<head>
				<meta charset="UTF-8">
				<base href="${e}/" />
