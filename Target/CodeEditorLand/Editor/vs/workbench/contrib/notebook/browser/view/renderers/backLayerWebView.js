import{getWindow as q}from"../../../../../../base/browser/dom.js";import{$$b as K}from"../../../../../../base/common/arrays.js";import{$ui as x,$ni as V}from"../../../../../../base/common/async.js";import{$qj as J}from"../../../../../../base/common/buffer.js";import{$xf as X}from"../../../../../../base/common/event.js";import{$xD as Q,$zD as Y}from"../../../../../../base/common/mime.js";import{$th as Z,Schemas as h,$ih as R,$jh as ee}from"../../../../../../base/common/network.js";import{$Gp as te}from"../../../../../../base/common/objects.js";import*as ie from"../../../../../../base/common/path.js";import{$n as oe,$s as se}from"../../../../../../base/common/platform.js";import{$Hh as g,$Gh as re,$Bh as ne,$Ih as ae}from"../../../../../../base/common/resources.js";import{URI as b}from"../../../../../../base/common/uri.js";import*as C from"../../../../../../base/common/uuid.js";import{$rG as P}from"../../../../../../editor/common/languages.js";import{$sG as de}from"../../../../../../editor/common/languages/language.js";import{$$L as ue}from"../../../../../../editor/common/languages/supports/tokenization.js";import{$8ib as le}from"../../../../../../editor/common/languages/textToHtmlTokenizer.js";import*as v from"../../../../../../nls.js";import{$MH as ce}from"../../../../../../platform/actions/common/actions.js";import{$0l as pe}from"../../../../../../platform/configuration/common/configuration.js";import{$ro as he}from"../../../../../../platform/contextkey/common/contextkey.js";import{$akb as fe}from"../../../../../../platform/contextview/browser/contextView.js";import{$Op as be}from"../../../../../../platform/dialogs/common/dialogs.js";import{$vk as me}from"../../../../../../platform/files/common/files.js";import{$NQ as ge}from"../../../../../../platform/opener/common/opener.js";import{$hp as ke}from"../../../../../../platform/storage/common/storage.js";import{$pp as ve}from"../../../../../../platform/telemetry/common/telemetry.js";import{$ar as we,$cr as Ie}from"../../../../../../platform/theme/common/colorRegistry.js";import{$qu as ye,$yu as Ce}from"../../../../../../platform/theme/common/themeService.js";import{$Ml as G}from"../../../../../../platform/workspace/common/workspace.js";import{$iJ as Me}from"../../../../../../platform/workspace/common/workspaceTrust.js";import{CellEditState as Ee}from"../../notebookBrowser.js";import{$iIb as $e}from"../notebookCellList.js";import{$lIb as Oe}from"./webviewPreloads.js";import{$mIb as xe}from"./webviewThemeMapping.js";import{$2Hb as M}from"../../viewModel/markupCellViewModel.js";import{CellUri as Re}from"../../../common/notebookCommon.js";import{$1Q as Ge}from"../../../common/notebookLoggingService.js";import{$wEb as Ne}from"../../../common/notebookService.js";import{$MEb as Se,$OEb as We}from"../../../../webview/browser/webview.js";import{$oIb as Pe}from"../../../../webview/browser/webviewWindowDragMonitor.js";import{$sIb as Le,$rIb as w}from"../../../../webview/common/webview.js";import{$EM as De}from"../../../../../services/editor/common/editorGroupsService.js";import{$QQ as Be}from"../../../../../services/environment/common/environmentService.js";import{$52 as He}from"../../../../../services/path/common/pathService.js";import{$wIb as Ue,$vIb as Te,$yIb as ze}from"../../viewModel/cellOutputTextHelper.js";var A=function(c,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,t,o);else for(var n=c.length-1;n>=0;n--)(s=c[n])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i},l=function(c,e){return function(t,o){e(t,o,c)}},E;const Fe=/:([\d]+)(?::([\d]+))?$/,_e=/line=(\d+)$/,je=/^(.*)#([^#]*)$/;let N=class extends Ce{static{E=this}static b(e){return this.a??=new We("notebook.backlayerWebview.origins",e),this.a}constructor(e,t,o,r,i,s,n,a,d,u,p,m,f,I,k,$,L,D,B,H,U,T,z,F,_){super(F),this.notebookEditor=e,this.F=t,this.notebookViewType=o,this.documentUri=r,this.G=i,this.H=s,this.I=n,this.J=a,this.L=d,this.M=u,this.N=p,this.O=m,this.P=f,this.Q=I,this.R=k,this.S=$,this.U=L,this.W=D,this.X=B,this.Y=H,this.Z=U,this.$=T,this.ab=z,this.bb=_,this.webview=void 0,this.insetMapping=new Map,this.pendingWebviewIdleCreationRequest=new Map,this.pendingWebviewIdleInsetMapping=new Map,this.c=new Map,this.markupPreviewMapping=new Map,this.f=new Set,this.g=new Map,this.j=void 0,this.m=this.D(new X),this.r=new Set,this.onMessage=this.m.event,this.s=!1,this.u=!0,this.C=C.$ln(),this.cb("Creating backlayer webview for notebook"),this.element=document.createElement("div"),this.element.style.height="1400px",this.element.style.position="absolute",s&&(this.D(s),s.receiveMessageHandler=(O,y)=>!this.webview||this.s?Promise.resolve(!1):(this.Eb({__vscode_notebook_message:!0,type:"customRendererMessage",rendererId:O,message:y}),Promise.resolve(!0))),this.D($.onDidChangeTrust(O=>{const y=this.jb(this.lb(),void 0),j=this.gb(y.toString());this.webview?.setHtml(j)})),this.D(P.onDidChange(()=>{this.Eb({type:"tokenizedStylesChanged",css:W()})}))}updateOptions(e){this.G=e,this.db(),this.eb()}cb(e){this.ab.debug("BacklayerWebview",`${this.documentUri} (${this.F}) - ${e}`)}db(){this.Eb({type:"notebookStyles",styles:this.fb()})}eb(){this.Eb({type:"notebookOptions",options:{dragAndDropEnabled:this.G.dragAndDropEnabled},renderOptions:{lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError}})}fb(){return{"notebook-output-left-margin":`${this.G.leftMargin+this.G.runGutter}px`,"notebook-output-width":`calc(100% - ${this.G.leftMargin+this.G.rightMargin+this.G.runGutter}px)`,"notebook-output-node-padding":`${this.G.outputNodePadding}px`,"notebook-run-gutter":`${this.G.runGutter}px`,"notebook-preview-node-padding":`${this.G.previewNodePadding}px`,"notebook-markdown-left-margin":`${this.G.markdownLeftMargin}px`,"notebook-output-node-left-padding":`${this.G.outputNodeLeftPadding}px`,"notebook-markdown-min-height":`${this.G.previewNodePadding*2}px`,"notebook-markup-font-size":typeof this.G.markupFontSize=="number"&&this.G.markupFontSize>0?`${this.G.markupFontSize}px`:`calc(${this.G.fontSize}px * 1.2)`,"notebook-markdown-line-height":typeof this.G.markdownLineHeight=="number"&&this.G.markdownLineHeight>0?`${this.G.markdownLineHeight}px`:"normal","notebook-cell-output-font-size":`${this.G.outputFontSize||this.G.fontSize}px`,"notebook-cell-output-line-height":`${this.G.outputLineHeight}px`,"notebook-cell-output-max-height":`${this.G.outputLineHeight*this.G.outputLineLimit+2}px`,"notebook-cell-output-font-family":this.G.outputFontFamily||this.G.fontFamily,"notebook-cell-markup-empty-content":v.localize(11960,null),"notebook-cell-renderer-not-found-error":v.localize(11961,null),"notebook-cell-renderer-fallbacks-exhausted":v.localize(11962,null),"notebook-markup-font-family":this.G.markupFontFamily}}gb(e){const t=this.hb(),o=this.ib(),r={lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError},i=Oe({...this.G,tokenizationCss:W()},{dragAndDropEnabled:this.G.dragAndDropEnabled},r,t,o,this.S.isWorkspaceTrusted(),this.C),s=this.U.getValue("notebook.experimental.enableCsp"),n=this.z(we),a=this.z(Ie);return`
		<html lang="en">
			<head>
				<meta charset="UTF-8">
				<base href="${e}/" />
