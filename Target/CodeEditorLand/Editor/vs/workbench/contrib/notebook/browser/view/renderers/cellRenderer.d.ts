...
export declare class NotebookCellListDelegate
	extends Disposable
...
declare abstract class AbstractCellRenderer {
	...
	constructor(
		...
		language: string,
		dndController: CellDragAndDropController | undefined,
	);
	dispose(): void;
}
export declare class MarkupCellRenderer
	...
	implements IListRenderer<MarkupCellViewModel, MarkdownCellRenderTemplate>
{
	...
	constructor(
		...
		renderedEditors: Map<ICellViewModel, ICodeEditor>,
		contextKeyServiceProvider: (
			container: HTMLElement,
		) => IScopedContextKeyService,
		configurationService: IConfigurationService,
...
export declare class CodeCellRenderer
	extends AbstractCellRenderer
