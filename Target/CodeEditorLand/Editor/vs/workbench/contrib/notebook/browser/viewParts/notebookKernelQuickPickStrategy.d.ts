...
declare abstract class KernelPickerStrategyBase
	implements IKernelPickerStrategy
{
	...
	protected _showKernelExtension(
	...
	protected _getKernelRecommendationsQuickPickItems(
		notebookTextModel: NotebookTextModel,
		extensionWorkbenchService: IExtensionsWorkbenchService,
	): Promise<
