...
export declare class MoveCellEdit implements IResourceUndoRedoElement {
	...
	constructor(
		...
		length: number,
		toIndex: number,
		editingDelegate: ITextCellEditingDelegate,
		beforedSelections: ISelectionState | undefined,
...
export declare class SpliceCellsEdit implements IResourceUndoRedoElement {
	...
	constructor(
		resource: URI,
		diffs: [number, NotebookCellTextModel[], NotebookCellTextModel[]][],
		editingDelegate: ITextCellEditingDelegate,
		beforeHandles: ISelectionState | undefined,
		endHandles: ISelectionState | undefined,
	);
	undo(): void;
	redo(): void;
}
export declare class CellMetadataEdit implements IResourceUndoRedoElement {
	...
	constructor(
		resource: URI,
		index: number,
		oldMetadata: NotebookCellMetadata,
