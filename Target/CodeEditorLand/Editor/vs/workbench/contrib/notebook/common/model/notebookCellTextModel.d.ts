...
export declare class NotebookCellTextModel extends Disposable implements ICell {
	...
	constructor(
		...
		collapseState: NotebookCellCollapseState | undefined,
		transientOptions: TransientOptions,
		_languageService: ILanguageService,
		_languageDetectionService?: ILanguageDetectionService | undefined,
	);
...
export declare function cloneNotebookCellTextModel(
...
export declare function getFormattedMetadataJSON(
