...
export declare const NOTEBOOK_DIFF_EDITOR_ID =
	"workbench.editor.notebookTextDiffEditor";
export declare const NOTEBOOK_MULTI_DIFF_EDITOR_ID =
	"workbench.editor.notebookMultiTextDiffEditor";
export declare const INTERACTIVE_WINDOW_EDITOR_ID =
 ...
 */
export declare const RENDERER_EQUIVALENT_EXTENSIONS: ReadonlyMap<
	string,
	ReadonlySet<string>
>;
...
export declare namespace CellUri {
	...
	function parseCellOutputUri(uri: URI):
		...
		| undefined;
	function generateCellPropertyUri(
		notebook: URI,
		handle: number,
		scheme: string,
	): URI;
...
export declare function isDocumentExcludePattern(
	filenamePattern:
		| string
		| glob.IRelativePattern
		| INotebookExclusiveDocumentFilter,
...
export declare function notebookDocumentFilterMatch(
