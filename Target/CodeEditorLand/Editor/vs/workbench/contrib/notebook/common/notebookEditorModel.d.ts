...
export declare class SimpleNotebookEditorModel
	extends EditorModel
	implements INotebookEditorModel
{
	...
	constructor(
		resource: URI,
		_hasAssociatedFilePath: boolean,
		viewType: string,
		_workingCopyManager: IFileWorkingCopyManager<
			NotebookFileWorkingCopyModel,
			NotebookFileWorkingCopyModel
		>,
		scratchpad: boolean,
		_filesConfigurationService: IFilesConfigurationService,
	);
	dispose(): void;
...
export declare class NotebookFileWorkingCopyModel
	extends Disposable
	implements IStoredFileWorkingCopyModel, IUntitledFileWorkingCopyModel
{
	...
	save:
		...
		| undefined;
	constructor(
		_notebookModel: NotebookTextModel,
		_notebookService: INotebookService,
		_configurationService: IConfigurationService,
		_telemetryService: ITelemetryService,
		_notebookLogService: INotebookLoggingService,
	);
...
export declare class NotebookFileWorkingCopyModelFactory
	implements
