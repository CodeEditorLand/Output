...
export declare class NotebookOutputRendererInfo
	implements INotebookRendererInfo
{
	readonly id: string;
...
export declare class NotebookStaticPreloadInfo
	implements INotebookStaticPreloadInfo
{
