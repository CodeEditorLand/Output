      ...
      registerAction2(
        class extends Action2 {
          ...
          run(accessor, ...args) {
            ...
            const groupId = getEditorGroupFromArguments(
              accessor,
              args
            )?.id;
    ...
    this._register(
      registerAction2(
        class extends Action2 {
          ...
          run(accessor, ...args) {
            const group = getEditorGroupFromArguments(
              accessor,
              args
            );
...
let SettingsEditorTitleContribution = class extends Disposable {
  ...
  static ID = "workbench.contrib.settingsEditorTitleBarActions";
    ...
    const registerOpenUserSettingsEditorFromJsonAction = /* @__PURE__ */ __name(() => {
      ...
      registerOpenUserSettingsEditorFromJsonActionDisposables.value = registerAction2(
        class extends Action2 {
          ...
          run(accessor, ...args) {
            const sanitizedArgs = sanitizeOpenSettingsArgs(
              args[0]
            );
            const groupId = getEditorGroupFromArguments(
              accessor,
