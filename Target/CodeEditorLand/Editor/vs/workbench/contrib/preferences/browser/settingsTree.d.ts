...
export declare function resolveSettingsTree(
...
export declare function resolveConfiguredUntrustedSettings(
	groups: ISettingsGroup[],
	target: SettingsTarget,
	languageFilter: string | undefined,
	configurationService: IWorkbenchConfigurationService,
): ISetting[];
export declare function createTocTreeForExtensionSettings(
...
export declare abstract class AbstractSettingRenderer
	extends Disposable
	implements ITreeRenderer<SettingsTreeElement, never, any>
{
	...
	constructor(
		...
		_extensionsService: IExtensionService,
...
export declare class SettingNewExtensionsRenderer
	implements
		ITreeRenderer<
			SettingsTreeNewExtensionsElement,
			never,
...
export declare class SettingComplexRenderer
...
export declare class SettingTreeRenderers extends Disposable {
	...
	constructor(
		...
		_contextMenuService: IContextMenuService,
		_contextViewService: IContextViewService,
		_userDataSyncEnablementService: IUserDataSyncEnablementService,
	);
...
export declare class SettingsTreeFilter
	implements ITreeFilter<SettingsTreeElement>
{
	private viewState;
...
export declare class NonCollapsibleObjectTreeModel<
	T,
> extends ObjectTreeModel<T> {
