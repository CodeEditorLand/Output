...
export declare class SettingsTreeModel {
	...
	constructor(
		...
		_isWorkspaceTrusted: boolean,
		_configurationService: IWorkbenchConfigurationService,
		_languageService: ILanguageService,
		_userDataProfileService: IUserDataProfileService,
...
export declare function inspectSetting(
	key: string,
	target: SettingsTarget,
	languageFilter: string | undefined,
	configurationService: IWorkbenchConfigurationService,
): IInspectResult;
export declare function settingKeyToDisplayFormat(
	key: string,
	groupId?: string,
...
export declare function objectSettingSupportsRemoveDefaultValue(
	key: string,
): boolean;
