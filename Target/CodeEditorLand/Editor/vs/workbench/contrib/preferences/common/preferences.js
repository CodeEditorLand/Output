...
const PREVIEW_INDICATOR_DESCRIPTION = localize("previewIndicatorDescription", "This setting controls a feature that is in active development.");
const EXPERIMENTAL_INDICATOR_DESCRIPTION = localize("experimentalIndicatorDescription", "This setting controls a feature that may change or be removed in the future. Adjusting this setting may result in instability.");
export {
