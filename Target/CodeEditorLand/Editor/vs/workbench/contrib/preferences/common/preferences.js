...
const PREVIEW_INDICATOR_DESCRIPTION = localize("previewIndicatorDescription", "This setting controls a new feature that is still under refinement yet ready to use. Feedback is welcome.");
const EXPERIMENTAL_INDICATOR_DESCRIPTION = localize("experimentalIndicatorDescription", "This setting controls a new feature that is actively being developed and may be unstable. It is subject to change or removal.");
export {
