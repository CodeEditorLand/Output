...
export declare class ActionButtonRenderer
	implements
		ICompressibleTreeRenderer<
			ISCMActionButton,
			FuzzyScore,
...
export declare class SCMTreeKeyboardNavigationLabelProvider
...
export declare class SCMAccessibilityProvider
...
export declare class SCMViewPane extends ViewPane {
	...
	constructor(
		...
		scmViewService: ISCMViewService,
