...
export type INotebookFileMatch =
	...
	| INotebookFileMatchNoModel;
export declare function getIDFromINotebookCellMatch(
	match: INotebookCellMatch,
): string;
...
export declare function isINotebookFileMatchWithModel(
	object: any,
): object is INotebookFileMatchWithModel;
export declare function isINotebookCellMatchWithModel(
	object: any,
): object is INotebookCellMatchWithModel;
export declare function contentMatchesToTextSearchMatches(
	contentMatches: FindMatch[],
	cell: ICellViewModel,
): ITextSearchMatch[];
export declare function webviewMatchesToTextSearchMatches(
