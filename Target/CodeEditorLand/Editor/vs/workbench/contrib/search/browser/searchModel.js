...
let TextSearchResult = class extends Disposable {
  ...
  add(allRaw, searchInstanceID, ai, silent = false) {
    ...
    byFolder.forEach((raw) => {
      ...
      folderMatch?.addFileMatch(
        raw,
        silent,
        searchInstanceID,
        this.isAIContributed
      );
    });
    if (!ai) {
...
TextSearchResult = __decorateClass([
  __decorateParam(3, IInstantiationService),
  __decorateParam(4, IUriIdentityService)
], TextSearchResult);
let ReplaceableTextSearchResult = class extends TextSearchResult {
  ...
  static {
    __name(this, "ReplaceableTextSearchResult");
  }
  replace(match) {
...
ReplaceableTextSearchResult = __decorateClass([
  __decorateParam(3, IInstantiationService),
  __decorateParam(4, IUriIdentityService),
...
let SearchResult = class extends Disposable {
  ...
  add(allRaw, searchInstanceID, ai, silent = false) {
    ...
    if (ai) {
      ...
      this._plainTextSearchResult.add(
        allRaw,
        searchInstanceID,
        ai,
        silent
