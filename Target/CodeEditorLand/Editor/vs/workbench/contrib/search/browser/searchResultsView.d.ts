...
export declare class SearchDelegate
	implements IListVirtualDelegate<RenderableMatch>
{
	static ITEM_HEIGHT: number;
	getHeight(element: RenderableMatch): number;
	getTemplateId(element: RenderableMatch): string;
}
export declare class TextSearchResultRenderer
	extends Disposable
	implements
		...
		>
{
	...
	disposeCompressedElements?(
		node: ITreeNode<ICompressedTreeNode<TextSearchResult>, any>,
		index: number,
	...
	renderElement(
		node: ITreeNode<TextSearchResult, any>,
		index: number,
...
export declare class FolderMatchRenderer
	extends Disposable
	implements
...
export declare class FileMatchRenderer
	extends Disposable
...
export declare class MatchRenderer
	extends Disposable
...
export declare class SearchAccessibilityProvider
