...
export declare class SearchView extends ViewPane {
	...
	constructor(
		...
		searchViewModelWorkbenchService: ISearchViewModelWorkbenchService,
	...
	refreshTreePromiseSerializer: Promise<void>;
	...
	getControl(): WorkbenchCompressibleAsyncDataTree<
		SearchResult,
		RenderableMatch,
		void
	>;
...
export declare function getEditorSelectionFromMatch(
	element: FileMatchOrMatch,
	viewModel: SearchModel,
):
	| import("../../../../editor/common/core/range.js").Range
	| {
	...
	| undefined;
export declare function getSelectionTextFromEditor(
