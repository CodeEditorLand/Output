...
let SearchView = class extends ViewPane {
  ...
  _onQueryChanged(preserveFocus, triggeredOnType = false, shouldKeepAIResults = false) {
  ...
  onQueryTriggered(query, options, excludePatternText, includePatternText, triggeredOnType, shouldKeepAIResults) {
    ...
    this.currentSearchQ = this.currentSearchQ.then(() => this.doSearch(query, excludePatternText, includePatternText, triggeredOnType, shouldKeepAIResults)).then(() => void 0, () => void 0);
  }
  ...
  doSearch(query, excludePatternText, includePatternText, triggeredOnType, shouldKeepAIResults) {
    let progressComplete;
