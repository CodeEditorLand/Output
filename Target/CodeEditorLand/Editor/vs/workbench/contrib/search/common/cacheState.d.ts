...
export declare class FileQueryCacheState {
	...
	private loadPromise;
	constructor(
		cacheQuery: (cacheKey: string) => IFileQuery,
		loadFn: (query: IFileQuery) => Promise<any>,
		disposeFn: (cacheKey: string) => Promise<void>,
		previousCacheState: FileQueryCacheState | undefined,
	);
