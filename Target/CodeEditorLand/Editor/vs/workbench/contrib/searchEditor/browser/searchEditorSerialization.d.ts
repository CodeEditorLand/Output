...
export declare const serializeSearchConfiguration: (
	config: Partial<SearchConfiguration>,
) => string;
export declare const extractSearchQueryFromModel: (
	model: ITextModel,
) => SearchConfiguration;
export declare const defaultSearchConfig: () => SearchConfiguration;
export declare const extractSearchQueryFromLines: (
	lines: string[],
) => SearchConfiguration;
export declare const serializeSearchResultForEditor: (
...
export declare const parseSavedSearchEditor: (
