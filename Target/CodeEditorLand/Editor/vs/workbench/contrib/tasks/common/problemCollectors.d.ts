...
export declare abstract class AbstractProblemCollector
	extends Disposable
...
export declare class StartStopProblemCollector
	...
	implements IProblemMatcher
{
	...
	constructor(
		...
		markerService: IMarkerService,
		modelService: IModelService,
		_strategy?: ProblemHandlingStrategy,
		fileService?: IFileService,
	);
	protected processLineInternal(line: string): Promise<void>;
}
export declare class WatchingProblemCollector
	extends AbstractProblemCollector
	implements IProblemMatcher
{
