...
export declare function isNamedProblemMatcher(
...
export declare function createLineMatcher(
	matcher: ProblemMatcher,
	fileService?: IFileService,
): ILineMatcher;
export declare namespace Config {
	...
	function isNamedProblemMatcher(
...
export declare class ExtensionRegistryReporter implements IProblemReporter {
	...
	constructor(
		_collector: ExtensionMessageCollector,
