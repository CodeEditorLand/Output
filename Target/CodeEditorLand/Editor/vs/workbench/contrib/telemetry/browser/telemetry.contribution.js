  ...
  reportTelemetry(key, target) {
    ...
    switch (key) {
      ...
      case "window.commandCenter":
        this.telemetryService.publicLog2("window.commandCenter", { settingValue: this.getValueToReport(key, target), source });
        return;
      case "chat.commandCenter.enabled":
        this.telemetryService.publicLog2("chat.commandCenter.enabled", { settingValue: this.getValueToReport(key, target), source });
        return;
