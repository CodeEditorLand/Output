...
export declare class EnvironmentVariableInfoStale
	implements IEnvironmentVariableInfo
{
	...
	constructor(
		_diff: IMergedEnvironmentVariableCollectionDiff,
		_terminalId: number,
		_collection: IMergedEnvironmentVariableCollection,
...
export declare class EnvironmentVariableInfoChangesActive
	implements IEnvironmentVariableInfo
{
	private readonly _collection;
