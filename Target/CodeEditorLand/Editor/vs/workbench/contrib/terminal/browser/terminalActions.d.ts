 ...
 */
export declare function registerTerminalAction(
 ...
 */
export declare function registerContextualInstanceAction(
	options: IAction2Options & {
		/**
 ...
 */
export declare function registerActiveInstanceAction(
	options: IAction2Options & {
		run: (
 ...
 */
export declare function registerActiveXtermAction(
	options: IAction2Options & {
		run: (
...
export declare function refreshTerminalActions(
 ...
 */
export declare function shrinkWorkspaceFolderCwdPairs(
