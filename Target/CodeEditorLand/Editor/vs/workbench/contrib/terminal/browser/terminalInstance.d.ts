	...
	implements ITerminalInstance
{
	...
	constructor(
		_terminalShellTypeContextKey: IContextKey<string>,
...
export declare function parseExitResult(
	...
	| undefined;
export declare class TerminalInstanceColorProvider
	implements IXtermColorProvider
{
	private readonly _target;
	private readonly _viewDescriptorService;
	constructor(
		_target: IReference<TerminalLocation | undefined>,
		_viewDescriptorService: IViewDescriptorService,
	);
	getBackgroundColor(
		theme: IColorTheme,
	): import("../../../../base/common/color.js").Color | undefined;
}
export {};
