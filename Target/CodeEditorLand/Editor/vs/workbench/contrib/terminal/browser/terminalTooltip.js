import{localize as s}from"../../../../nls.js";import"./terminal.js";import{asArray as d}from"../../../../base/common/arrays.js";import{MarkdownString as g}from"../../../../base/common/htmlContent.js";import{TerminalCapability as c}from"../../../../platform/terminal/common/capabilities/capabilities.js";import{TerminalStatus as u}from"./terminalStatusList.js";import I from"../../../../base/common/severity.js";import{StorageScope as h,StorageTarget as f}from"../../../../platform/storage/common/storage.js";import{TerminalStorageKeys as p}from"../common/terminalStorageKeys.js";import{basename as S}from"../../../../base/common/path.js";function x(e,l){const t=parseInt(l.get(p.TabsShowDetailed,h.APPLICATION)??"0");let i="";const a=e.statusList.statuses,o=[];for(const n of a)t?(n.detailedTooltip??n.tooltip)&&(i+=`
...
`+t.map(r=>`- ${r}`).join(`
`):"";e.statusList.add({id:u.ShellIntegrationInfo,severity:I.Info,tooltip:`${s("shellIntegration","Shell integration")}: ${l}`,detailedTooltip:`${s("shellIntegration","Shell integration")}: ${l}${o}`})}export{x as getInstanceHoverInfo,b as getShellProcessTooltip,H as refreshShellIntegrationInfoStatus};
