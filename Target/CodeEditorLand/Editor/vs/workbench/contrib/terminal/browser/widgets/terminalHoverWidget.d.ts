...
export declare class TerminalHover
	extends Disposable
	implements ITerminalWidget
{
	...
	readonly id = "hover";
	constructor(
		_targetOptions: ILinkHoverTargetOptions,
		_text: IMarkdownString,
		_actions: IHoverAction[] | undefined,
		_linkHandler: (url: string) => unknown,
