 ...
 */
export declare abstract class BasePty
	extends Disposable
	implements Partial<ITerminalChildProcess>
{
	...
	readonly onProcessData: import("../../../workbench.web.main.internal.js").Event<
		string | IProcessDataEvent
	>;
	...
	readonly onDidChangeProperty: import("../../../workbench.web.main.internal.js").Event<
		IProcessProperty<any>
	>;
	protected readonly _onProcessExit: Emitter<number | undefined>;
	readonly onProcessExit: import("../../../workbench.web.main.internal.js").Event<
		number | undefined
	>;
