...
export declare function getCommandHistory(
	accessor: ServicesAccessor,
): ITerminalPersistedHistory<{
	shellType: TerminalShellType | undefined;
}>;
export declare function getDirectoryHistory(
	accessor: ServicesAccessor,
): ITerminalPersistedHistory<{
	remoteAuthority?: string;
}>;
export declare function getShellFileHistory(
	accessor: ServicesAccessor,
	shellType: TerminalShellType | undefined,
): Promise<string[]>;
export declare function clearShellFileHistory(): void;
export declare class TerminalPersistedHistory<T>
	extends Disposable
...
export declare function fetchBashHistory(
	accessor: ServicesAccessor,
): Promise<IterableIterator<string> | undefined>;
export declare function fetchZshHistory(
	accessor: ServicesAccessor,
): Promise<SetIterator<string> | undefined>;
export declare function fetchPythonHistory(
	accessor: ServicesAccessor,
): Promise<IterableIterator<string> | undefined>;
export declare function fetchPwshHistory(
	accessor: ServicesAccessor,
): Promise<SetIterator<string> | undefined>;
export declare function fetchFishHistory(
	accessor: ServicesAccessor,
): Promise<SetIterator<string> | undefined>;
