...
export declare function mergeEnvironments(
	parent: IProcessEnvironment,
	other: ITerminalEnvironment | undefined,
): void;
export declare function addTerminalEnvironmentKeys(
	env: IProcessEnvironment,
	version: string | undefined,
	locale: string | undefined,
	detectLocale: "auto" | "off" | "on",
): void;
export declare function shouldSetLangEnvVariable(
	env: IProcessEnvironment,
	detectLocale: "auto" | "off" | "on",
): boolean;
export declare function getLangEnvVariable(locale?: string): string;
export declare function getCwd(
...
export declare function createVariableResolver(
	lastActiveWorkspace: IWorkspaceFolder | undefined,
	env: IProcessEnvironment,
	configurationResolverService: IConfigurationResolverService | undefined,
): VariableResolver | undefined;
export declare function createTerminalEnvironment(
 ...
 */
export declare function preparePathForShell(
	resource: string | URI,
	...
	isWindowsFrontend?: boolean,
): Promise<string>;
export declare function getWorkspaceForTerminal(
