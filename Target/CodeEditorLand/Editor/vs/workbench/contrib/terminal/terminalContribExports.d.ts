...
export declare const defaultTerminalContribCommandsToSkipShell: (
	...
	| import("../terminalContrib/find/common/terminal.find.js").TerminalFindCommandId
	| import("../terminalContrib/history/common/terminal.history.js").TerminalHistoryCommandId
	| import("../terminalContrib/suggest/common/terminal.suggest.js").TerminalSuggestCommandId
)[];
