 ...
 */
export declare function convertLinkRangeToBuffer(
	lines: IBufferLine[],
	bufferWidth: number,
	range: IRange,
	startLine: number,
): IBufferRange;
export declare function convertBufferRangeToViewport(
	bufferRange: IBufferRange,
	viewportY: number,
): IViewportRange;
export declare function getXtermLineContent(
	buffer: IBuffer,
	lineStart: number,
	lineEnd: number,
	cols: number,
): string;
export declare function getXtermRangesByAttr(
	buffer: IBuffer,
	lineStart: number,
	lineEnd: number,
	cols: number,
 ...
 */
export declare function updateLinkWithRelativeCwd(
