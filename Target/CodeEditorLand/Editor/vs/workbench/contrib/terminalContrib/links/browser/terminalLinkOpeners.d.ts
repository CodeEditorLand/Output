...
export declare class TerminalLocalFileLinkOpener
...
export declare class TerminalLocalFolderInWorkspaceLinkOpener
	implements ITerminalLinkOpener
{
...
export declare class TerminalLocalFolderOutsideWorkspaceLinkOpener
	implements ITerminalLinkOpener
{
...
export declare class TerminalSearchLinkOpener implements ITerminalLinkOpener {
	...
	constructor(
		...
		_initialCwd: string,
		_localFileOpener: TerminalLocalFileLinkOpener,
		_localFolderInWorkspaceOpener: TerminalLocalFolderInWorkspaceLinkOpener,
		_getOS: () => OperatingSystem,
