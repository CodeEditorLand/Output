...
export declare class SuggestAddon
	extends Disposable
	implements ITerminalAddon, ISuggestController
{
	...
	constructor(
		_cachedPwshCommands: Set<SimpleCompletionItem>,
		_capabilities: ITerminalCapabilityStore,
		_terminalSuggestWidgetVisibleContextKey: IContextKey<boolean>,
...
export declare function parseCompletionsFromShell(
	rawCompletions:
		| PwshCompletion
		| PwshCompletion[]
