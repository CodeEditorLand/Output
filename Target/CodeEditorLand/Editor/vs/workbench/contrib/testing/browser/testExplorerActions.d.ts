...
export declare const discoverAndRunTests: (
...
declare abstract class RunOrDebugLastRun extends Action2 {
	...
	protected getLastTestRunRequest(
		accessor: ServicesAccessor,
		runId?: string,
	): import("../common/testTypes.js").ResolvedTestRunRequest | undefined;
	/** @inheritdoc */
...
export declare const allTestActions: (
	| typeof UnhideTestAction
	| typeof DebugAction
	| typeof RunUsingProfileAction
	| typeof SelectDefaultTestProfiles
	| typeof StopContinuousRunAction
	| typeof TestingViewAsListAction
	| typeof RunTestsUnderUri
	| typeof GoToRelatedTest
	| typeof GoToRelatedCode
)[];
export {};
