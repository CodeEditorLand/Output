	...
	implements IPeekOutputRenderer
{
	...
	private clear;
	layout(
		dimensions: dom.IDimension,
		hasMultipleFrames: boolean,
	): number | undefined;
	onScrolled(evt: ScrollEvent): void;
	protected getOptions(isMultiline: boolean): IDiffEditorOptions;
}
export declare class MarkdownTestMessagePeek
	extends Disposable
	implements IPeekOutputRenderer
{
	private readonly container;
...
export declare class PlainTextMessagePeek
	extends Disposable
	implements IPeekOutputRenderer
{
	private readonly editor;
...
export declare class TerminalMessagePeek
	extends Disposable
	implements IPeekOutputRenderer
{
	private readonly container;
