...
export declare const getMessageArgs: (
	test: TestResultItem,
...
export declare const inspectSubjectHasStack: (
	subject: InspectSubject | undefined,
) => boolean;
export declare class MessageSubject implements ISubjectCommon {
	...
	get stack():
		| import("../../common/testTypes.js").ITestMessageStackFrame[]
		| undefined;
	constructor(
		result: ITestResult,
		test: TestResultItem,
...
export declare const equalsSubject: (
	a: InspectSubject,
	b: InspectSubject,
) => boolean;
export declare const mapFindTestMessage: <T>(
	test: TestResultItem,
	fn: (
		task: ITestTaskState,
		message: ITestMessage,
...
export declare const getSubjectTestItem: (
