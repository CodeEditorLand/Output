...
declare class CachedDecorations {
	...
	getById(
		decorationId: string,
	): RunTestDecoration | TestMessageDecoration | undefined;
	/** Iterate over all decorations */
	[Symbol.iterator](): IterableIterator<ITestDecoration>;
}
export declare class TestingDecorationService
	extends Disposable
	implements ITestingDecorationsService
{
	...
	getDecoratedTestPosition(
		...
		| import("../../../../editor/common/core/position.js").Position
		| undefined;
	private invalidate;
	/**
...
export declare class TestingDecorations
	extends Disposable
	implements IEditorContribution
{
	...
	constructor(
		...
		codeEditorService: ICodeEditorService,
		testService: ITestService,
		decorations: ITestingDecorationsService,
...
declare class TestMessageDecoration implements ITestDecoration {
	...
	constructor(
		testMessage: ITestMessage,
		messageUri: URI | undefined,
		textModel: ITextModel,
		peekOpener: ITestingPeekOpener,
