...
export declare const getTestingConfiguration: <K extends TestingConfigKeys>(
	config: IConfigurationService,
	key: K,
) => ITestingConfiguration[K];
export declare const observeTestingConfiguration: <K extends TestingConfigKeys>(
	config: IConfigurationService,
	key: K,
) => import("../../../../base/common/observable.js").IObservable<
	ITestingConfiguration[K],
	unknown
>;
