...
export declare class TestCoverage {
	...
	readonly didAddCoverage: import("../../../../base/common/observable.js").IObservableSignal<
		IPrefixTreeNode<AbstractFileCoverage>[]
	>;
	...
	filterTreeForTest(
		testId: TestId,
	): WellDefinedPrefixTree<AbstractFileCoverage>;
	/**
...
export declare const getTotalCoveragePercent: (
...
export declare const totalFromCoverageDetails: (
	uri: URI,
