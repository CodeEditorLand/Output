...
export declare class TaskRawOutput implements ITaskRawOutput {
	...
	getRangeIter(
		start: number,
		length: number,
	): Generator<VSBuffer, void, unknown>;
	/**
...
export declare const resultItemParents: (
	results: ITestResult,
	item: TestResultItem,
) => Generator<TestResultItem, void, unknown>;
export declare const maxCountPriority: (
	counts: Readonly<TestStateCount>,
) => TestResultState;
