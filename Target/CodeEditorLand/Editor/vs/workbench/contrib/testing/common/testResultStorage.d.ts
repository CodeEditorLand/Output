...
export declare abstract class BaseTestResultStorage
	extends Disposable
	implements ITestResultStorage
{
	...
	protected readonly stored: StoredValue<
		readonly {
			rev: number;
			id: string;
			bytes: number;
	...
	getResultOutputWriter(
		resultId: string,
	): import("../../../../base/common/stream.js").WriteableStream<VSBuffer>;
	/**
	 * @override
	 */
	persist(results: ReadonlyArray<ITestResult>): Promise<void>;
...
export declare class InMemoryResultStorage extends BaseTestResultStorage {
	...
	protected readForResultId(
		id: string,
	): Promise<ISerializedTestResults | undefined>;
	protected storeForResultId(
		id: string,
		contents: ISerializedTestResults,
	): Promise<void>;
...
export declare class TestResultStorage extends BaseTestResultStorage {
	...
	protected storeForResultId(
		...
		import("../../../../platform/files/common/files.js").IFileStatWithMetadata
	>;
