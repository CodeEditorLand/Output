...
export declare const testCollectionIsEmpty: (
	collection: IMainThreadTestCollection,
) => boolean;
export declare const getContextForTestItem: (
	collection: IMainThreadTestCollection,
	id: string | TestId,
) =>
	| ITestItemContext
 ...
 * undefined.
 */
export declare const expandAndGetTestById: (
	collection: IMainThreadTestCollection,
	id: string,
	ct?: Readonly<CancellationToken>,
) => Promise<IncrementalTestCollectionItem | undefined>;
/**
 * Iterator that expands to and iterates through tests in the file. Iterates
 * in strictly descending order.
 */
export declare const testsInFile: (
 ...
 * the URI.
 */
export declare const testsUnderUri: (
	testService: ITestService,
	ident: IUriIdentityService,
	uri: URI,
	waitForIdle?: boolean,
 ...
 */
export declare const simplifyTestsToExecute: (
	collection: IMainThreadTestCollection,
