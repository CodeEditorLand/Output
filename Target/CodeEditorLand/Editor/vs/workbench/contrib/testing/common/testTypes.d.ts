...
export declare const isStartControllerTests: (
	t: ICallProfileRunHandler | IStartControllerTests,
) => t is IStartControllerTests;
/**
...
export declare const namespaceTestTag: (
	ctrlId: string,
	tagId: string,
) => string;
...
export declare const applyTestItemUpdate: (
 ...
 */
export declare abstract class AbstractIncrementalTestCollection<
