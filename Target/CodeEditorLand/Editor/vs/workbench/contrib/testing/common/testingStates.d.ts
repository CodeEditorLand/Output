...
export declare const isFailedState: (
	s: TestResultState,
) => s is TestResultState.Failed | TestResultState.Errored;
export declare const isStateWithResult: (
	s: TestResultState,
) => s is
...
export declare const cmpPriority: (
	a: TestResultState,
	b: TestResultState,
) => number;
export declare const maxPriority: (
	...states: TestResultState[]
) => TestResultState | undefined;
