...
export declare const TRUSTED_DOMAINS_STORAGE_KEY =
	"http.linkProtectionTrustedDomains";
export declare const TRUSTED_DOMAINS_CONTENT_STORAGE_KEY =
...
export declare function configureOpenerTrustedDomainsHandler(
...
export declare function readTrustedDomains(
	accessor: ServicesAccessor,
): Promise<IStaticTrustedDomains>;
export declare function readStaticTrustedDomains(
	accessor: ServicesAccessor,
