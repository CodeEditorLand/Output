...
export declare function isProfileResourceTypeElement(
	element: IProfileChildElement,
): element is IProfileResourceTypeElement;
export declare function isProfileResourceChildElement(
	element: IProfileChildElement,
...
export declare abstract class AbstractUserDataProfileElement extends Disposable {
	...
	protected getChildrenFromProfile(
...
export declare class UserDataProfileElement extends AbstractUserDataProfileElement {
	...
	constructor(
		_profile: IUserDataProfile,
		titleButtons: [Action[], Action[]],
...
export declare class UserDataProfilesEditorModel extends EditorModel {
	...
	readonly onDidChange: import("../../../workbench.web.main.internal.js").Event<
		AbstractUserDataProfileElement | undefined
	>;
	private templates;
	constructor(
		userDataProfileService: IUserDataProfileService,
