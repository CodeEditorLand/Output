...
export declare function reviveWebviewExtensionDescription(
	extensionId: string | undefined,
	extensionLocation: UriComponents | undefined,
): WebviewExtensionDescription | undefined;
export declare function restoreWebviewOptions(
	options: SerializedWebviewOptions,
): WebviewOptions;
export declare function restoreWebviewContentOptions(
	options: SerializedWebviewOptions,
): WebviewContentOptions;
export {};
