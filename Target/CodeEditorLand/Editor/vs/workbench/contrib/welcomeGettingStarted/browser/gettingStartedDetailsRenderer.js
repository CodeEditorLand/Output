var k=Object.defineProperty;var w=Object.getOwnPropertyDescriptor;var h=(c,e,n,t)=>{for(var o=t>1?void 0:t?w(e,n):e,r=c.length-1,i;r>=0;r--)(i=c[r])&&(o=(t?i(e,n,o):i(o))||o);return t&&o&&k(e,n,o),o},a=(c,e)=>(n,t)=>e(n,t,c);import{generateUuid as d}from"../../../../base/common/uuid.js";import{generateTokensCSSForColorMap as p}from"../../../../editor/common/languages/supports/tokenization.js";import{TokenizationRegistry as g}from"../../../../editor/common/languages.js";import{DEFAULT_MARKDOWN_STYLES as u,renderMarkdownDocument as $}from"../../markdown/browser/markdownDocumentRenderer.js";import"../../../../base/common/uri.js";import{language as y}from"../../../../base/common/platform.js";import{joinPath as b}from"../../../../base/common/resources.js";import{assertIsDefined as f}from"../../../../base/common/types.js";import{asWebviewUri as I}from"../../webview/common/webview.js";import{ResourceMap as v}from"../../../../base/common/map.js";import{IFileService as P}from"../../../../platform/files/common/files.js";import{INotificationService as U}from"../../../../platform/notification/common/notification.js";import{ILanguageService as L}from"../../../../editor/common/languages/language.js";import{IExtensionService as E}from"../../../services/extensions/common/extensions.js";import{gettingStartedContentRegistry as q}from"../common/gettingStartedContent.js";let l=class{constructor(e,n,t,o){this.fileService=e;this.notificationService=n;this.extensionService=t;this.languageService=o}mdCache=new v;svgCache=new v;async renderMarkdown(e,n){const t=await this.readAndCacheStepMarkdown(e,n),o=d(),r=g.getColorMap(),i=r?p(r):"";return`<!DOCTYPE html>
		...
		</html>`}async renderSVG(e){const n=await this.readAndCacheSVGFile(e),t=d(),o=g.getColorMap(),r=o?p(o):"";return`<!DOCTYPE html>
		<html>
			<head>
				<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
		...
		</html>`}async renderVideo(e,n){const t=d();return`<!DOCTYPE html>
		<html>
			<head>
				<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
				<meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src https:; media-src https:; script-src 'nonce-${t}'; style-src 'nonce-${t}';">
				<style nonce="${t}">
					video {
						max-width: 100%;
						max-height: 100%;
