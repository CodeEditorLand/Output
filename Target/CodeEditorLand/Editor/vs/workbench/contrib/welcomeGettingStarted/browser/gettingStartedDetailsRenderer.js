var C=Object.defineProperty;var w=Object.getOwnPropertyDescriptor;var m=(c,e,n,t)=>{for(var o=t>1?void 0:t?w(e,n):e,r=c.length-1,i;r>=0;r--)(i=c[r])&&(o=(t?i(e,n,o):i(o))||o);return t&&o&&C(e,n,o),o},s=(c,e)=>(n,t)=>e(n,t,c);import{ResourceMap as h}from"../../../../base/common/map.js";import{language as g}from"../../../../base/common/platform.js";import{joinPath as b}from"../../../../base/common/resources.js";import{assertIsDefined as p}from"../../../../base/common/types.js";import"../../../../base/common/uri.js";import{generateUuid as u}from"../../../../base/common/uuid.js";import{TokenizationRegistry as f}from"../../../../editor/common/languages.js";import{ILanguageService as $}from"../../../../editor/common/languages/language.js";import{generateTokensCSSForColorMap as y}from"../../../../editor/common/languages/supports/tokenization.js";import{IFileService as I}from"../../../../platform/files/common/files.js";import{INotificationService as L}from"../../../../platform/notification/common/notification.js";import{IExtensionService as P}from"../../../services/extensions/common/extensions.js";import{DEFAULT_MARKDOWN_STYLES as v,renderMarkdownDocument as U}from"../../markdown/browser/markdownDocumentRenderer.js";import{asWebviewUri as E}from"../../webview/common/webview.js";import{gettingStartedContentRegistry as M}from"../common/gettingStartedContent.js";let l=class{constructor(e,n,t,o){this.fileService=e;this.notificationService=n;this.extensionService=t;this.languageService=o}mdCache=new h;svgCache=new h;async renderMarkdown(e,n){const t=await this.readAndCacheStepMarkdown(e,n),o=u(),r=f.getColorMap(),i=r?y(r):"";return`<!DOCTYPE html>
		<html>
			<head>
