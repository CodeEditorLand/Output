var $=Object.defineProperty;var k=Object.getOwnPropertyDescriptor;var h=(c,e,n,t)=>{for(var o=t>1?void 0:t?k(e,n):e,r=c.length-1,i;r>=0;r--)(i=c[r])&&(o=(t?i(e,n,o):i(o))||o);return t&&o&&$(e,n,o),o},a=(c,e)=>(n,t)=>e(n,t,c);import{ResourceMap as g}from"../../../../base/common/map.js";import{language as p}from"../../../../base/common/platform.js";import{joinPath as w}from"../../../../base/common/resources.js";import{assertIsDefined as u}from"../../../../base/common/types.js";import"../../../../base/common/uri.js";import{generateUuid as d}from"../../../../base/common/uuid.js";import{TokenizationRegistry as y}from"../../../../editor/common/languages.js";import{ILanguageService as b}from"../../../../editor/common/languages/language.js";import{generateTokensCSSForColorMap as f}from"../../../../editor/common/languages/supports/tokenization.js";import{IFileService as I}from"../../../../platform/files/common/files.js";import{INotificationService as P}from"../../../../platform/notification/common/notification.js";import{IExtensionService as U}from"../../../services/extensions/common/extensions.js";import{DEFAULT_MARKDOWN_STYLES as v,renderMarkdownDocument as L}from"../../markdown/browser/markdownDocumentRenderer.js";import{asWebviewUri as E}from"../../webview/common/webview.js";import{gettingStartedContentRegistry as q}from"../common/gettingStartedContent.js";let l=class{constructor(e,n,t,o){this.fileService=e;this.notificationService=n;this.extensionService=t;this.languageService=o}mdCache=new g;svgCache=new g;async renderMarkdown(e,n){const t=await this.readAndCacheStepMarkdown(e,n),o=d(),r=y.getColorMap(),i=r?f(r):"";return`<!DOCTYPE html>
		<html>
			<head>
		...
		</html>`}async renderSVG(e){const n=await this.readAndCacheSVGFile(e),t=d(),o=y.getColorMap(),r=o?f(o):"";return`<!DOCTYPE html>
		<html>
			<head>
				<meta http-equiv="Content-type" content="text/html;charset=UTF-8">
		...
		</html>`}async readAndCacheSVGFile(e){if(!this.svgCache.has(e)){const n=await this.readContentsOfPath(e,!1);this.svgCache.set(e,n)}return u(this.svgCache.get(e))}async readAndCacheStepMarkdown(e,n){if(!this.mdCache.has(e)){const t=await this.readContentsOfPath(e),o=await L(M(t,n),this.extensionService,this.languageService,{allowUnknownProtocols:!0});this.mdCache.set(e,o)}return u(this.mdCache.get(e))}async readContentsOfPath(e,n=!0){try{const t=JSON.parse(e.query).moduleId;if(n&&t)return await new Promise((r,i)=>{const s=q.getProvider(t);s?r(s()):i(`Getting started: no provider registered for ${t}`)})}catch{}try{const t=e.with({path:e.path.replace(/\.md$/,`.nls.${p}.md`)}),o=p?.replace(/-.*$/,""),r=e.with({path:e.path.replace(/\.md$/,`.nls.${o}.md`)}),i=S=>this.fileService.stat(S).then(C=>!!C.size).catch(()=>!1),[s,m]=await Promise.all([i(t),i(r)]);return(await this.fileService.readFile(s?t:m?r:e)).value.toString()}catch(t){return this.notificationService.error("Error reading markdown document at `"+e+"`: "+t),""}}};l=h([a(0,I),a(1,P),a(2,U),a(3,b)],l);const x=(c,e)=>{const n=w(e,c);return E(n).toString(!0)},M=(c,e)=>c.replace(/src="([^"]*)"/g,(n,t)=>t.startsWith("https://")?`src="${t}"`:`src="${x(t,e)}"`).replace(/!\[([^\]]*)\]\(([^)]*)\)/g,(n,t,o)=>o.startsWith("https://")?`![${t}](${o})`:`![${t}](${x(o,e)})`);export{l as GettingStartedDetailsRenderer};
