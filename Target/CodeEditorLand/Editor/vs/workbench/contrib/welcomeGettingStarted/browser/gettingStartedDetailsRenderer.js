import{$mn as l}from"../../../../base/common/uuid.js";import{$kM as m}from"../../../../editor/common/languages/supports/tokenization.js";import{$yG as h}from"../../../../editor/common/languages.js";import{$Awc as p,$Bwc as w}from"../../markdown/browser/markdownDocumentRenderer.js";import{$A as u}from"../../../../base/common/platform.js";import{$Ih as k}from"../../../../base/common/resources.js";import{$gd as f}from"../../../../base/common/types.js";import{$qJb as C}from"../../webview/common/webview.js";import{$Oc as y}from"../../../../base/common/map.js";import{$vk as L}from"../../../../platform/files/common/files.js";import{$UI as S}from"../../../../platform/notification/common/notification.js";import{$zG as q}from"../../../../editor/common/languages/language.js";import{$nT as E}from"../../../services/extensions/common/extensions.js";import{$gNc as P}from"../common/gettingStartedContent.js";var b=function(i,e,n,t){var o=arguments.length,r=o<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,n):t,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,e,n,t);else for(var s=i.length-1;s>=0;s--)(c=i[s])&&(r=(o<3?c(r):o>3?c(e,n,r):c(e,n))||r);return o>3&&r&&Object.defineProperty(e,n,r),r},a=function(i,e){return function(n,t){e(n,t,i)}};let g=class{constructor(e,n,t,o){this.c=e,this.d=n,this.f=t,this.g=o,this.a=new y,this.b=new y}async renderMarkdown(e,n){const t=await this.i(e,n),o=l(),r=h.getColorMap(),c=r?m(r):"";return`<!DOCTYPE html>
		<html>
			<head>
