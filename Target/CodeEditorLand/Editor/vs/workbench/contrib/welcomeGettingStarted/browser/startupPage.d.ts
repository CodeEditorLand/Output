...
export declare const restoreWalkthroughsConfigurationKey =
...
export declare class StartupPageEditorResolverContribution
...
export declare class StartupPageRunnerContribution
	extends Disposable
	implements IWorkbenchContribution
{
