	...
	implements IExtensionService
{
	...
	constructor(
		...
		_browserEnvironmentService: IBrowserWorkbenchEnvironmentService,
		...
		_userDataInitializationService: IUserDataInitializationService,
...
export declare class BrowserExtensionHostKindPicker
