...
export declare abstract class AbstractExtensionService
	extends Disposable
	implements IExtensionService
{
	...
	readonly onDidChangeExtensionsStatus: import("../../../workbench.web.main.internal.js").Event<
		ExtensionIdentifier[]
	>;
	...
	constructor(
		...
		_extensionHostFactory: IExtensionHostFactory,
		_extensionHostKindPicker: IExtensionHostKindPicker,
		...
		_extensionManifestPropertiesService: IExtensionManifestPropertiesService,
		_logService: ILogService,
		_remoteAgentService: IRemoteAgentService,
		_remoteExtensionsScannerService: IRemoteExtensionsScannerService,
...
export declare class ResolvedExtensions {
	...
	constructor(
		local: IExtensionDescription[],
		remote: IExtensionDescription[],
 ...
 */
export declare function checkEnabledAndProposedAPI(
 ...
 * @argument ignoreWorkspaceTrust Do not take workspace trust into account.
 */
export declare function filterEnabledExtensions(
	logService: ILogService,
	extensionEnablementService: IWorkbenchExtensionEnablementService,
	extensions: IExtensionDescription[],
	ignoreWorkspaceTrust: boolean,
 ...
 * @argument ignoreWorkspaceTrust Do not take workspace trust into account.
 */
export declare function extensionIsEnabled(
	logService: ILogService,
	extensionEnablementService: IWorkbenchExtensionEnablementService,
 ...
 */
export declare class ImplicitActivationAwareReader
	implements IActivationEventsReader
{
