...
export declare class DeltaExtensionsResult {
	...
	constructor(
		versionId: number,
		removedDueToLooping: IExtensionDescription[],
	);
}
	...
	implements IReadOnlyExtensionDescriptionRegistry
{
	...
	constructor(
		_activationEventsReader: IActivationEventsReader,
...
export declare class LockableExtensionDescriptionRegistry
	implements IReadOnlyExtensionDescriptionRegistry
{
...
export declare class ExtensionDescriptionRegistryLock extends Disposable {
	...
	private _isDisposed;
	constructor(
		_registry: LockableExtensionDescriptionRegistry,
		lock: IDisposable,
	);
