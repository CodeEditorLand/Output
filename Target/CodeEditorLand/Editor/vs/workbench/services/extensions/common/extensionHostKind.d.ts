...
export declare function extensionHostKindToString(
...
export declare function extensionRunningPreferenceToString(
...
export declare function determineExtensionHostKinds(
