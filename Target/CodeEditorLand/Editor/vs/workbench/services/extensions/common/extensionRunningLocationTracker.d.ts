...
export declare class ExtensionRunningLocationTracker {
	...
	constructor(
		_registry: IReadOnlyExtensionDescriptionRegistry,
...
export declare function filterExtensionDescriptions(
	extensions: readonly IExtensionDescription[],
...
export declare function filterExtensionIdentifiers(
