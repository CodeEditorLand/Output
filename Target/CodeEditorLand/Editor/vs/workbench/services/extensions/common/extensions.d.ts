...
export declare const nullExtensionDescription: Readonly<
	Readonly<
		import("../../../../platform/extensions/common/extensions.js").IRelaxedExtensionDescription
	>
>;
...
export declare function isProposedApiEnabled(
	extension: IExtensionDescription,
	proposal: ApiProposalName,
): boolean;
export declare function checkProposedApiEnabled(
	extension: IExtensionDescription,
	proposal: ApiProposalName,
): void;
/**
...
export declare function toExtension(
...
export declare class NullExtensionService implements IExtensionService {
	...
	setRemoteEnvironment(_env: { [key: string]: string | null }): Promise<void>;
