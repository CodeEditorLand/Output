...
export declare class RemoteExtensionHost
	extends Disposable
	implements IExtensionHost
{
	...
	constructor(
		runningLocation: RemoteRunningLocation,
		_initDataProvider: IRemoteExtensionHostDataProvider,
