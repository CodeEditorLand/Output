...
export declare class NativeLocalProcessExtensionHost implements IExtensionHost {
	...
	constructor(
		runningLocation: LocalProcessRunningLocation,
		startup:
			| ExtensionHostStartup.EagerAutoStart
			| ExtensionHostStartup.EagerManualStart,
		...
		_environmentService: INativeWorkbenchEnvironmentService,
		_userDataProfilesService: IUserDataProfilesService,
		_telemetryService: ITelemetryService,
		_logService: ILogService,
		_loggerService: ILoggerService,
		_labelService: ILabelService,
		_extensionHostDebugService: IExtensionHostDebugService,
		_hostService: IHostService,
		_productService: IProductService,
		_shellEnvironmentService: IShellEnvironmentService,
		_extensionHostStarter: IExtensionHostStarter,
	);
	dispose(): void;
