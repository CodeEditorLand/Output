...
export declare function validateSettingsEditorOptions(
...
export declare const DEFINE_KEYBINDING_EDITOR_CONTRIB_ID =
...
export declare const DEFAULT_SETTINGS_EDITOR_SETTING =
