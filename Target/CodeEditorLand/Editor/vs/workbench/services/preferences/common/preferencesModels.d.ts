...
export declare class SettingsEditorModel
...
export declare class Settings2EditorModel
	extends AbstractSettingsModel
	implements ISettingsEditorModel
{
...
export declare class DefaultSettings extends Disposable {
	...
	constructor(
		_mostCommonlyUsedSettingsKeys: string[],
...
export declare class DefaultSettingsEditorModel
	extends AbstractSettingsModel
	implements ISettingsEditorModel
{
	private _uri;
...
export declare function defaultKeybindingsContents(
	keybindingService: IKeybindingService,
): string;
export declare class DefaultKeybindingsEditorModel
