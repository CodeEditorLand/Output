...
export declare function mapHasAddress<T>(
	map: Map<string, T>,
	host: string,
	port: number,
): T | undefined;
export declare function mapHasAddressLocalhostOrAllInterfaces<T>(
	map: Map<string, T>,
	host: string,
	port: number,
): T | undefined;
...
export declare function isCandidatePort(
	candidate: any,
): candidate is CandidatePort;
