...
export declare function isISearchPatternBuilder<U extends UriComponents>(
	object: ISearchPatternBuilder<U> | ISearchPathPatternBuilder,
): object is ISearchPatternBuilder<U>;
export declare function globPatternToISearchPatternBuilder(
 ...
 */
export declare function resolveResourcesForSearchIncludes(
	resources: URI[],
