...
export declare function resultIsMatch(
...
export declare function isProgressMessage(
...
export declare function getExcludes(
	configuration: ISearchConfiguration,
	includeSearchExcludes?: boolean,
): glob.IExpression | undefined;
export declare function pathIncludedInQuery(
 ...
 */
export declare function resolvePatternsForProvider(
...
export declare function hasSiblingPromiseFn(
	siblingsFn?: () => Promise<string[]>,
): ((name: string) => Promise<boolean>) | undefined;
export declare function hasSiblingFn(
	siblingsFn?: () => string[],
): ((name: string) => boolean) | undefined;
export declare function excludeToGlobPattern(
	excludesForFolder: {
