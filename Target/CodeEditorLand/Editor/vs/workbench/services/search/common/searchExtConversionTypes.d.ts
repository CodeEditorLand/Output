...
export declare class OldFileSearchProviderConverter
	implements FileSearchProviderNew
{
	private provider;
...
export declare function newToOldPreviewOptions(
	options:
		| {
				matchLines?: number;
				charsPerLine?: number;
...
export declare function oldToNewTextSearchResult(
	result: TextSearchResult,
): TextSearchResultNew;
export declare class OldTextSearchProviderConverter
	implements TextSearchProviderNew
{
	private provider;
...
export declare class OldAITextSearchProviderConverter
...
export declare function extensionResultIsMatch(
