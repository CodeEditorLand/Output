...
export declare class TextMateTokenizationSupport
	extends Disposable
	implements ITokenizationSupport
{
	...
	constructor(
		_grammar: IGrammar,
		_initialState: StateStack,
		_containsEmbeddedLanguages: boolean,
		_createBackgroundTokenizer:
			...
			| undefined,
		_backgroundTokenizerShouldOnlyVerifyTokens: () => boolean,
		_reportTokenizationTime: (
			timeMs: number,
			lineLength: number,
			isRandomSample: boolean,
		) => void,
		_reportSlowTokenization: boolean,
	);
