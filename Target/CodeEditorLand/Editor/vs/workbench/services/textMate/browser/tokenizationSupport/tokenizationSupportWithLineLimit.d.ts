...
export declare class TokenizationSupportWithLineLimit
	extends Disposable
	implements ITokenizationSupport
{
	...
	constructor(
		_encodedLanguageId: LanguageId,
		_actual: ITokenizationSupport,
		disposable: IDisposable,
		_maxTokenizationLineLength: IObservable<number>,
	);
