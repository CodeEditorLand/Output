...
export type UTF_ENCODING =
	...
	| typeof UTF16be
	| typeof UTF16le;
export declare function isUTFEncoding(
	encoding: string,
): encoding is UTF_ENCODING;
...
export declare function detectEncodingByBOMFromBuffer(
...
export declare function detectEncodingFromBuffer(
