...
export declare const COLOR_THEME_CONFIGURATION_SETTINGS_TAG =
	"colorThemeConfiguration";
export declare function updateColorThemeConfigurationSchemas(
	themes: IWorkbenchColorTheme[],
): void;
export declare function updateFileIconThemeConfigurationSchemas(
	themes: IWorkbenchFileIconTheme[],
): void;
export declare function updateProductIconThemeConfigurationSchemas(
