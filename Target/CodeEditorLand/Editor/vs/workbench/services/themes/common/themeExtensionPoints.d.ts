...
export declare function registerColorThemeExtensionPoint(): IExtensionPoint<
	IThemeExtensionPoint[]
>;
export declare function registerFileIconThemeExtensionPoint(): IExtensionPoint<
	IThemeExtensionPoint[]
>;
export declare function registerProductIconThemeExtensionPoint(): IExtensionPoint<
	IThemeExtensionPoint[]
>;
	...
	implements IDisposable
{
	...
	constructor(
		themesExtPoint: IExtensionPoint<IThemeExtensionPoint[]>,
		create: (
