...
export declare class FileWorkingCopyManager<
		S extends IStoredFileWorkingCopyModel,
		U extends IUntitledFileWorkingCopyModel,
	>
	extends Disposable
	implements IFileWorkingCopyManager<S, U>
{
	...
	constructor(
		...
		storedWorkingCopyModelFactory: IStoredFileWorkingCopyModelFactory<S>,
		untitledWorkingCopyModelFactory: IUntitledFileWorkingCopyModelFactory<U>,
