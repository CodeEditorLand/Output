...
export declare function isStoredFileWorkingCopySaveEvent(
	e: IWorkingCopySaveEvent,
): e is IStoredFileWorkingCopySaveEvent;
export declare class StoredFileWorkingCopy<
		M extends IStoredFileWorkingCopyModel,
	>
	...
	implements IStoredFileWorkingCopy<M>
{
	...
	constructor(
		...
		resource: URI,
		name: string,
		modelFactory: IStoredFileWorkingCopyModelFactory<M>,
		externalResolver: IStoredFileWorkingCopyResolver,
