...
export declare class UntitledFileWorkingCopy<
		M extends IUntitledFileWorkingCopyModel,
	>
	extends Disposable
	implements IUntitledFileWorkingCopy<M>
{
	...
	constructor(
		...
		initialContents: IUntitledFileWorkingCopyInitialContents | undefined,
		modelFactory: IUntitledFileWorkingCopyModelFactory<M>,
		saveDelegate: IUntitledFileWorkingCopySaveDelegate<M>,
