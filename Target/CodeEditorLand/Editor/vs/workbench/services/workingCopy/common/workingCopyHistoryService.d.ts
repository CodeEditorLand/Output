...
export declare class WorkingCopyHistoryModel {
	...
	constructor(
		...
		historyHome: URI,
		entryAddedEmitter: Emitter<IWorkingCopyHistoryEvent>,
		entryChangedEmitter: Emitter<IWorkingCopyHistoryEvent>,
		entryReplacedEmitter: Emitter<IWorkingCopyHistoryEvent>,
		entryRemovedEmitter: Emitter<IWorkingCopyHistoryEvent>,
		options: IWorkingCopyHistoryModelOptions,
...
export declare abstract class WorkingCopyHistoryService
	extends Disposable
