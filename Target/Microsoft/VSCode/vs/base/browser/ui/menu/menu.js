...
.monaco-menu .action-item {
	cursor: default;
		...
		`;const i=c.scrollbarShadow;i&&(t+=`
			...
			`)}return t}export{F as $17,I as $V7,A as $W7,ke as $X7,x as $Y7,ie as $Z7,y as HorizontalDirection,L as VerticalDirection};
