...
.monaco-menu .action-item {
	cursor: default;
		...
		`;const i=c.scrollbarShadow;i&&(t+=`
			...
			`)}return t}export{_ as $A9,I as $v9,A as $w9,ke as $x9,x as $y9,ie as $z9,y as HorizontalDirection,L as VerticalDirection};
