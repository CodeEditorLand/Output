...
.monaco-menu .action-item {
	cursor: default;
		...
		`;const i=c.scrollbarShadow;i&&(t+=`
			...
			`)}return t}export{I as $C8,A as $D8,ke as $E8,x as $F8,ie as $G8,_ as $H8,y as HorizontalDirection,L as VerticalDirection};
