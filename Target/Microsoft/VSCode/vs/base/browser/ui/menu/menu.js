...
.monaco-menu .action-item {
	cursor: default;
		...
		`;const i=c.scrollbarShadow;i&&(t+=`
			...
			`)}return t}export{I as $G9,A as $H9,ke as $I9,x as $J9,ie as $K9,_ as $L9,y as HorizontalDirection,L as VerticalDirection};
