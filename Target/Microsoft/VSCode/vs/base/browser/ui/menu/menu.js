...
.monaco-menu .action-item {
	cursor: default;
		...
		`;const i=c.scrollbarShadow;i&&(t+=`
			...
			`)}return t}export{I as $M7,A as $N7,ke as $O7,x as $P7,ie as $Q7,_ as $R7,y as HorizontalDirection,L as VerticalDirection};
