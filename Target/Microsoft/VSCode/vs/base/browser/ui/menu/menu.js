...
.monaco-menu .action-item {
	cursor: default;
		...
		`;const i=c.scrollbarShadow;i&&(t+=`
			...
			`)}return t}export{I as $L8,A as $M8,ke as $N8,x as $O8,ie as $P8,_ as $Q8,y as HorizontalDirection,L as VerticalDirection};
