...
let AccessibleDiffViewer = class AccessibleDiffViewer2 extends Disposable {
  static {
    __name(this, "AccessibleDiffViewer");
  }
  static {
    this._ttPolicy = createTrustedTypesPolicy("diffReview", { createHTML: /* @__PURE__ */ __name((value) => value, "createHTML") });
  }
...
let ViewModel = class ViewModel2 extends Disposable {
  static {
...
let View = class View2 extends Disposable {
  static {
    __name(this, "View");
  }
    ...
    this._register(autorun((reader) => {
      ...
      if (this._model.canClose.read(reader)) {
        this._actionBar.push(toAction({
          ...
          enabled: true,
          run: /* @__PURE__ */ __name(async () => _model.close(), "run")
  ...
  _getLineHtml(model, options, tabSize, lineNumber, languageIdCodec) {
    ...
    ), fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, [], tabSize, 0, fontInfo.spaceWidth, fontInfo.middotWidth, fontInfo.wsmiddotWidth, options.get(
      122
