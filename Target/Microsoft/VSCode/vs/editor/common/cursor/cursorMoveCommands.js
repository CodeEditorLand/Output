...
class CursorMoveCommands {
  ...
  static moveToBeginningOfLine(viewModel, cursors, inSelectionMode) {
    ...
    for (let i = 0, len = cursors.length; i < len; i++) {
      const cursor = cursors[i];
      result[i] = CursorMoveCommands._moveToLineStart(
        viewModel,
        cursor,
        inSelectionMode
      );
  ...
  static _moveToLineStart(viewModel, cursor, inSelectionMode) {
    ...
    if (!isFirstLineOfWrappedLine && !isBeginningOfViewLine) {
      return CursorMoveCommands._moveToLineStartByView(
        viewModel,
        cursor,
        inSelectionMode
      );
    } else {
      return CursorMoveCommands._moveToLineStartByModel(
        viewModel,
        cursor,
        inSelectionMode
      );
  ...
  static moveToEndOfLine(viewModel, cursors, inSelectionMode, sticky) {
    ...
    for (let i = 0, len = cursors.length; i < len; i++) {
      const cursor = cursors[i];
      result[i] = CursorMoveCommands._moveToLineEnd(
        viewModel,
        cursor,
        inSelectionMode,
        sticky
  ...
  static _moveToLineEnd(viewModel, cursor, inSelectionMode, sticky) {
    ...
    if (isEndOfViewLine || isEndLineOfWrappedLine) {
      return CursorMoveCommands._moveToLineEndByModel(
        viewModel,
        cursor,
        inSelectionMode,
        sticky
      ...
      return CursorMoveCommands._moveToLineEndByView(
        viewModel,
        cursor,
        inSelectionMode,
        sticky
  ...
  static moveTo(viewModel, cursor, inSelectionMode, _position, _viewPosition) {
    if (inSelectionMode) {
      if (cursor.modelState.selectionStartKind === SelectionStartKind.Word) {
        return CursorMoveCommands.word(
          viewModel,
          cursor,
          inSelectionMode,
          _position
      ...
      if (cursor.modelState.selectionStartKind === SelectionStartKind.Line) {
        return CursorMoveCommands.line(
          viewModel,
          cursor,
          inSelectionMode,
          _position,
    ...
    switch (direction) {
      case CursorMove.Direction.Left: {
        if (unit === CursorMove.Unit.HalfLine) {
          return CursorMoveCommands._moveHalfLineLeft(
            viewModel,
            cursors,
            inSelectionMode
          );
        } else {
          return CursorMoveCommands._moveLeft(
            viewModel,
            cursors,
            inSelectionMode,
            value
      ...
      case CursorMove.Direction.Right: {
        if (unit === CursorMove.Unit.HalfLine) {
          return CursorMoveCommands._moveHalfLineRight(
            viewModel,
            cursors,
            inSelectionMode
          );
        } else {
          return CursorMoveCommands._moveRight(
            viewModel,
            cursors,
            inSelectionMode,
            value
      ...
      case CursorMove.Direction.Up: {
        if (unit === CursorMove.Unit.WrappedLine) {
          return CursorMoveCommands._moveUpByViewLines(
            viewModel,
            cursors,
            inSelectionMode,
            value
          ...
          return CursorMoveCommands._moveUpByModelLines(
            viewModel,
            cursors,
            inSelectionMode,
            value
      ...
      case CursorMove.Direction.Down: {
        if (unit === CursorMove.Unit.WrappedLine) {
          return CursorMoveCommands._moveDownByViewLines(
            viewModel,
            cursors,
            inSelectionMode,
            value
          ...
          return CursorMoveCommands._moveDownByModelLines(
            viewModel,
            cursors,
            inSelectionMode,
            value
      ...
      case CursorMove.Direction.WrappedLineStart: {
        return CursorMoveCommands._moveToViewMinColumn(
          viewModel,
          cursors,
          inSelectionMode
        );
      ...
      case CursorMove.Direction.WrappedLineFirstNonWhitespaceCharacter: {
        return CursorMoveCommands._moveToViewFirstNonWhitespaceColumn(
          viewModel,
          cursors,
          inSelectionMode
        );
      ...
      case CursorMove.Direction.WrappedLineColumnCenter: {
        return CursorMoveCommands._moveToViewCenterColumn(
          viewModel,
          cursors,
          inSelectionMode
        );
      ...
      case CursorMove.Direction.WrappedLineEnd: {
        return CursorMoveCommands._moveToViewMaxColumn(
          viewModel,
          cursors,
          inSelectionMode
        );
      ...
      case CursorMove.Direction.WrappedLineLastNonWhitespaceCharacter: {
        return CursorMoveCommands._moveToViewLastNonWhitespaceColumn(
          viewModel,
          cursors,
          inSelectionMode
        );
  ...
  static viewportMove(viewModel, cursors, direction, inSelectionMode, value) {
    ...
    switch (direction) {
      case CursorMove.Direction.ViewPortTop: {
        const modelLineNumber = CursorMoveCommands._firstLineNumberInRange(
          viewModel.model,
          visibleModelRange,
          value
        );
        ...
        return [
          CursorMoveCommands._moveToModelPosition(
            viewModel,
            cursors[0],
            inSelectionMode,
            modelLineNumber,
      ...
      case CursorMove.Direction.ViewPortBottom: {
        const modelLineNumber = CursorMoveCommands._lastLineNumberInRange(
          viewModel.model,
          visibleModelRange,
          value
        );
      ...
      case CursorMove.Direction.ViewPortIfOutside: {
        ...
        for (let i = 0, len = cursors.length; i < len; i++) {
          const cursor = cursors[i];
          result[i] = CursorMoveCommands.findPositionInViewportIfOutside(
            viewModel,
            cursor,
            visibleViewRange,
            inSelectionMode
  ...
  static _moveToViewMinColumn(viewModel, cursors, inSelectionMode) {
    ...
    for (let i = 0, len = cursors.length; i < len; i++) {
      ...
      result[i] = CursorMoveCommands._moveToViewPosition(
        viewModel,
        cursor,
        inSelectionMode,
        viewLineNumber,
