...
let TextModel = class TextModel2 extends Disposable {
  ...
  setValue(value, reason = EditReasons.setValue()) {
    this._assertNotDisposed();
  ...
  setEOL(eol) {
    ...
    ], this._versionId, false, false), this._createContentChanged2(new Range(1, 1, endLineNumber, endColumn), 0, oldModelValueLength, new Position(endLineNumber, endColumn), this.getValue(), false, false, false, true, EditReasons.eolChange()));
  }
  _onBeforeEOLChange() {
