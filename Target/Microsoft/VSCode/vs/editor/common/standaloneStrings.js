...
((AccessibilityHelpNLS2) => {
  ...
  AccessibilityHelpNLS2.defaultWindowTitleIncludesEditorState = nls.localize(
  ...
  AccessibilityHelpNLS2.defaultWindowTitleExcludingEditorState = nls.localize(
  ...
  AccessibilityHelpNLS2.toolbar = nls.localize(
    "toolbar",
  ...
  AccessibilityHelpNLS2.suggestActions = nls.localize(
    "suggestActionsKb",
    "Trigger the suggest widget{0} to show possible code completions.",
    "<keybinding:editor.action.triggerSuggest>"
  );
  AccessibilityHelpNLS2.acceptSuggestAction = nls.localize(
    "acceptSuggestAction",
    "Accept suggestion{0} to accept the currently selected suggestion.",
    "<keybinding:acceptSelectedSuggestion>"
  );
  AccessibilityHelpNLS2.toggleSuggestionFocus = nls.localize(
  ...
  AccessibilityHelpNLS2.chatEditorModification = nls.localize(
    "chatEditorModification",
    "The editor contains pending modifications that have been made by chat."
  );
  AccessibilityHelpNLS2.chatEditorRequestInProgress = nls.localize(
    "chatEditorRequestInProgress",
    "The editor is currently waiting for modifications to be made by chat."
  );
  AccessibilityHelpNLS2.chatEditActions = nls.localize(
    "chatEditing.navigation",
    "Navigate between edits in the editor with navigate previous{0} and next{1} and accept{2}, reject{3} or view the diff{4} for the current change.",
