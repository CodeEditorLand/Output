...
const inlineEditIndicatorForeground = registerColor(
...
const inlineEditIndicatorBorder = registerColor(
...
class InlineEditsIndicator extends Disposable {
  ...
  isHoverVisible = constObservable(false);
}
export {
