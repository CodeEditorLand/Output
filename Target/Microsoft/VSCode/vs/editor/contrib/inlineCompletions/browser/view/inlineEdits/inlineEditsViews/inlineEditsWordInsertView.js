          ...
          n.div(
            {
              style: {
                position: "absolute",
                ...rectToProps(
                  (reader2) => layout.read(reader2).lowerBackground
                ),
                borderRadius: "4px",
          ...
          n.div(
            {
              style: {
                position: "absolute",
                ...rectToProps(
                  (reader2) => layout.read(reader2).modified
                ),
                borderRadius: "4px",
                padding: "0px",
                textAlign: "center",
          ...
          n.div(
            {
              style: {
                position: "absolute",
                ...rectToProps(
                  (reader2) => layout.read(reader2).background
                ),
                borderRadius: "4px",
          ...
          n.svg(
            {
              ...
              style: {
                position: "absolute",
                left: derived(
                  (reader2) => layout.read(reader2).center.x - 9
                ),
                top: derived(
                  (reader2) => layout.read(reader2).center.y + 4
                ),
