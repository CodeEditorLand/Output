import n from"assert";import{ensureNoDisposablesAreLeakedInTestSuite as k}from"../../../../base/test/common/utils.js";import"../../../common/core/position.js";import{Range as r}from"../../../common/core/range.js";import"../../../common/languages.js";import{EditorWorker as p}from"../../../common/services/editorWebWorker.js";import"../../../common/services/textModelSync/textModelSync.impl.js";suite("EditorWebWorker",()=>{k();class m extends p{getModel(e){return this._getModel(e)}addModel(e,a=`
