...
class Sound {
  ...
  static requestSent = Sound.register({
    fileName: "requestSent.mp3"
  });
  static responseReceived1 = Sound.register({
    fileName: "responseReceived1.mp3"
  });
  static responseReceived2 = Sound.register({
    fileName: "responseReceived2.mp3"
  });
  static responseReceived3 = Sound.register({
    fileName: "responseReceived3.mp3"
  });
  static responseReceived4 = Sound.register({
  ...
  static chatEditModifiedFile = Sound.register({
    fileName: "chatEditModifiedFile.mp3"
  });
  static editsKept = Sound.register({
    fileName: "editsKept.mp3"
  });
  static editsUndone = Sound.register({
...
class AccessibilitySignal {
  ...
  static get allAccessibilitySignals() {
    return [...AccessibilitySignal._signals];
  }
