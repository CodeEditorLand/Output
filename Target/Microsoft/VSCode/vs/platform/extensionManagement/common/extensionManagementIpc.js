  ...
  constructor(channel, productService, allowedExtensionsService) {
    ...
    this._register(
      this.channel.listen("onInstallExtension")(
        (e) => this.onInstallExtensionEvent({
          ...e,
    ...
    this._register(
      this.channel.listen(
        ...
        (results) => this.onDidInstallExtensionsEvent(
          results.map((e) => ({
            ...e,
    ...
    this._register(
      this.channel.listen(
        ...
        (e) => this.onUninstallExtensionEvent({
          ...e,
          profileLocation: URI.revive(e.profileLocation)
        })
      )
    ...
    this._register(
      this.channel.listen(
        ...
        (e) => this.onDidUninstallExtensionEvent({
          ...e,
          profileLocation: URI.revive(e.profileLocation)
        })
      )
    ...
    this._register(
      this.channel.listen(
        ...
        (e) => this.onDidUpdateExtensionMetadataEvent({
          profileLocation: URI.revive(e.profileLocation),
