...
import { DidUninstallMcpServerEvent, IGalleryMcpServer, ILocalMcpServer, IMcpGalleryService, IMcpManagementService, IMcpServerManifest, InstallMcpServerEvent, InstallMcpServerResult, PackageType, UninstallMcpServerEvent, InstallOptions, UninstallOptions, IInstallableMcpServer } from './mcpManagement.js';
...
export declare abstract class AbstractMcpResourceManagementService extends Disposable implements IMcpManagementService {
    ...
    get onDidInstallMcpServers(): import("../../../base/common/event.js").Event<InstallMcpServerResult[]>;
    protected readonly _onDidUpdateMcpServers: Emitter<InstallMcpServerResult[]>;
    get onDidUpdateMcpServers(): import("../../../base/common/event.js").Event<InstallMcpServerResult[]>;
    protected readonly _onUninstallMcpServer: Emitter<UninstallMcpServerEvent>;
    get onUninstallMcpServer(): import("../../../base/common/event.js").Event<UninstallMcpServerEvent>;
    protected _onDidUninstallMcpServer: Emitter<DidUninstallMcpServerEvent>;
    get onDidUninstallMcpServer(): import("../../../base/common/event.js").Event<DidUninstallMcpServerEvent>;
