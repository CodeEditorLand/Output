...
async function startPtyHost() {
  ...
  process.env.VSCODE_RECONNECT_GRACE_TIME = void 0;
  process.env.VSCODE_RECONNECT_SHORT_GRACE_TIME = void 0;
  process.env.VSCODE_RECONNECT_SCROLLBACK = void 0;
  process.env.VSCODE_LATENCY = void 0;
  process.env.VSCODE_STARTUP_DELAY = void 0;
  if (startupDelay) {
