...
}`,e);let a=await t.sync(await e.getResourceManifest(),!0);n.strictEqual(t.status,h.Syncing),a=await t.accept(a.resourcePreviews[0].previewResource),a=await t.apply(!1);const{content:i}=await e.read(t.resource);n.ok(i!==null);const l=g(i);n.deepStrictEqual(l,`{
	// Always
	"files.autoSave": "afterDelay",
	"files.simpleDialog.enable": true,
