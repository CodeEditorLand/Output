...
`),i=0),n.push(r),n.push("`")}}function U(t){const e=[];return k(t,e),e}function k(t,e){if(h(t.node)==="link"&&f(t)){const s=a(t.node,!0),o=m(t.node),c=t.node.description?.value||"";e.push(`- [${s}](${o})${c?" - "+c:""}`)}for(const s of t.children)k(s,e)}export{A as $RA};
