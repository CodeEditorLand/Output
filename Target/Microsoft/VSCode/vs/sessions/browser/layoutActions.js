...
class ToggleSecondarySidebarVisibilityAction extends Action2 {
  static {
    __name(this, "ToggleSecondarySidebarVisibilityAction");
  }
  static {
    this.ID = "workbench.action.agentToggleSecondarySidebarVisibility";
  }
  static {
    this.LABEL = localize("compositePart.hideSecondarySideBarLabel", "Hide Secondary Side Bar");
  }
  constructor() {
    super({
  ...
  run(accessor) {
    ...
    const alertMessage = isCurrentlyVisible ? localize("secondarySidebarHidden", "Secondary Side Bar hidden") : localize("secondarySidebarVisible", "Secondary Side Bar shown");
    alert(alertMessage);
  }
}
class TogglePanelVisibilityAction extends Action2 {
  static {
    __name(this, "TogglePanelVisibilityAction");
  }
  static {
    this.ID = "workbench.action.agentTogglePanelVisibility";
  }
  constructor() {
    super({
