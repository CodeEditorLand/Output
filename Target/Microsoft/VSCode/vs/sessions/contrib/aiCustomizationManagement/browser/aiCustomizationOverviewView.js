...
let AICustomizationOverviewView = class AICustomizationOverviewView2 extends ViewPane {
  ...
  constructor(options, keybindingService, contextMenuService, configurationService, contextKeyService, viewDescriptorService, instantiationService, openerService, themeService, hoverService, editorGroupsService, promptsService, workspaceContextService, activeSessionService) {
...
AICustomizationOverviewView = __decorate([
  ...
  __param(13, ISessionsManagementService)
