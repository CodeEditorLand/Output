...
let SessionsAuxiliaryBarContribution = class SessionsAuxiliaryBarContribution2 extends Disposable {
  static {
    __name(this, "SessionsAuxiliaryBarContribution");
  }
  static {
    this.ID = "workbench.contrib.sessionsAuxiliaryBarContribution";
  }
  constructor(layoutService, sessionManagementService, chatEditingService, agentSessionsService, chatService) {
    super();
  ...
  hasSessionChanges(sessionResource) {
    ...
    if (!isBackgroundSession) {
      const sessions = this.chatEditingService.editingSessionsObs.read(void 0);
      const editingSession = sessions.find((candidate) => isEqual(candidate.chatSessionResource, sessionResource));
      editingSessionCount = editingSession ? editingSession.entries.read(void 0).length : 0;
    }
  ...
  syncAuxiliaryBarVisibility(hasChanges) {
    ...
    const isAuxiliaryBarVisible = this.layoutService.isVisible(
      "workbench.parts.auxiliarybar"
      /* Parts.AUXILIARYBAR_PART */
    );
    ...
    this.layoutService.setPartHidden(
      shouldHideAuxiliaryBar,
      "workbench.parts.auxiliarybar"
      /* Parts.AUXILIARYBAR_PART */
    );
  }
};
SessionsAuxiliaryBarContribution = __decorate([
...
//# sourceMappingURL=sessionsAuxiliaryBarContribution.js.map
