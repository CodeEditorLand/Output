...
let ExtensionBackedInlineCompletionsProvider = class ExtensionBackedInlineCompletionsProvider2 extends Disposable {
  static {
...
__name(extractEngineFromCorrelationId, "extractEngineFromCorrelationId");
export {
