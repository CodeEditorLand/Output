...
let MainThreadLanguageFeatures = MainThreadLanguageFeatures_1 = class MainThreadLanguageFeatures2 extends Disposable {
  ...
  constructor(extHostContext, _languageService, _languageConfigurationService, _languageFeaturesService, _uriIdentService, _telemetryService) {
    super();
  ...
  $registerInlineCompletionsSupport(handle, selector, supportsHandleEvents, extensionId, extensionVersion, groupId, yieldsToExtensionIds, displayName, debounceDelayMs, eventHandle) {
    const provider = {
      ...
      handleEndOfLifetime: /* @__PURE__ */ __name(async (completions, item, reason, lifetimeSummary) => {
        ...
        const endOfLifeSummary = {
          ...
          reason: reason.kind === InlineCompletionEndOfLifeReasonKind.Accepted ? "accepted" : reason.kind === InlineCompletionEndOfLifeReasonKind.Rejected ? "rejected" : "ignored"
        };
        this._telemetryService.publicLog2("inlineCompletion.endOfLife", endOfLifeSummary);
      }, "handleEndOfLifetime"),
      disposeInlineCompletions: /* @__PURE__ */ __name((completions, reason) => {
