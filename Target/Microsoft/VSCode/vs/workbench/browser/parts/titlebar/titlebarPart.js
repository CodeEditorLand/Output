...
let BrowserTitlebarPart = class BrowserTitlebarPart2 extends Part {
  ...
  get editorActionsEnabled() {
    return !this.isCompact && this.editorGroupService.partOptions.editorActionsLocation === "titleBar" || this.editorGroupService.partOptions.editorActionsLocation === "default" && this.editorGroupService.partOptions.showTabs === "none";
  }
