...
let ViewContainerMenuActions = class ViewContainerMenuActions2 extends CompositeMenuActions {
  static {
...
let ViewPaneContainer = class ViewPaneContainer2 extends Component {
  static {
  ...
  get orientation() {
    switch (this.viewDescriptorService.getViewContainerLocation(this.viewContainer)) {
      ...
      case 2:
        return 0;
      case 1: {
        return isHorizontal(this.layoutService.getPanelPosition()) ? 1 : 0;
      }
    }
    return 0;
  }
