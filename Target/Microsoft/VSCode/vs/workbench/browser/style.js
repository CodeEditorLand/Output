import"./media/style.css";import{$Wt as i}from"../../platform/theme/common/themeService.js";import{$Oub as d,$Swb as a}from"../common/theme.js";import{$s as l,$v as u}from"../../base/common/platform.js";import{$S6 as b}from"../../base/browser/dom.js";import{$S5 as f,$W5 as $}from"../../base/browser/browser.js";import{$Mp as k}from"../../platform/theme/common/colorRegistry.js";import{$D5 as s}from"../../base/browser/window.js";i((t,e)=>{const n=d(t);e.addRule(`.monaco-workbench { background-color: ${n}; }`);const r=t.getColor(k);if(r&&e.addRule(`.monaco-workbench ::selection { background-color: ${r}; }`),l){const m=t.getColor(a);if(m){const c="monaco-workbench-meta-theme-color";let o=s.document.getElementById(c);o||(o=b(),o.name="theme-color",o.id=c),o.content=m.toString()}}f&&e.addRule(`
			body.web {
				touch-action: none;
			}
