...
const IsAuxiliaryTitleBarContext = new RawContextKey("isAuxiliaryTitleBar", false, localize("isAuxiliaryTitleBar", "Title bar is in an auxiliary window"));
...
let ResourceContextKey = class ResourceContextKey2 {
  static {
