...
class PanelChatAccessibilityHelp {
  ...
  getProvider(accessor) {
    return getChatAccessibilityHelpProvider(accessor, void 0, "panelChat");
  }
}
class QuickChatAccessibilityHelp {
  ...
  getProvider(accessor) {
    return getChatAccessibilityHelpProvider(accessor, void 0, "quickChat");
  }
}
class EditsChatAccessibilityHelp {
  ...
  getProvider(accessor) {
    return getChatAccessibilityHelpProvider(accessor, void 0, "editsView");
  }
}
class AgentChatAccessibilityHelp {
  ...
  getProvider(accessor) {
    return getChatAccessibilityHelpProvider(accessor, void 0, "agentView");
  }
}
function getAccessibilityHelpText(type, keybindingService) {
  ...
  if (type === "panelChat" || type === "quickChat" || type === "agentView") {
    ...
    content.push(localize("chat.focusMostRecentTerminal", "To focus the last chat terminal that ran a tool, invoke the Focus Most Recent Chat Terminal command{0}.", `<keybinding:${"workbench.action.terminal.chat.focusMostRecentChatTerminal"}>`));
...
function getChatAccessibilityHelpProvider(accessor, editor, type) {
  ...
  return new AccessibleContentProvider(
    ...
    type === "inlineChat" ? "accessibility.verbosity.inlineChat" : "accessibility.verbosity.panelChat"
