...
let ImplicitContextAttachmentWidget = class ImplicitContextAttachmentWidget2 extends Disposable {
  ...
  render() {
    ...
    const attachmentTypeName = this.attachment.isPromptFile === false ? file.scheme === Schemas.vscodeNotebookCell ? localize("cell.lowercase", "cell") : localize("file.lowercase", "file") : localize("prompt.lowercase", "prompt");
