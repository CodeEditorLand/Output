  ...
  initAttachedContext(container) {
    ...
    for (const attachment of this.variables) {
      ...
      if (attachment.kind === "tool" || attachment.kind === "toolset") {
        ...
        widget = this.instantiationService.createInstance(PromptTextAttachmentWidget, attachment, void 0, { shouldFocusClearButton: false, supportsDeletion: false }, container, this._contextResourceLabels, hoverDelegate);
