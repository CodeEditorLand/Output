...
`).join(`
`);this.a.openEditor({resource:void 0,contents:f,languageId:"markdown"}),this.b.publicLog2("openedChatCodeCitations")})),this.domNode=i.root}hasSameContent(t,o,e){return t.kind==="codeCitations"}};s=b([l(2,$),l(3,g)],s);export{s as $wMb};
