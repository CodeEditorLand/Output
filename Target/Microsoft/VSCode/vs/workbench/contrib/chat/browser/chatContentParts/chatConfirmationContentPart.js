...
let ChatConfirmationContentPart = class ChatConfirmationContentPart2 extends Disposable {
  ...
  constructor(confirmation, context, instantiationService, chatService, chatWidgetService) {
    ...
    const confirmationWidget = this._register(this.instantiationService.createInstance(ChatConfirmationWidget, confirmation.title, void 0, confirmation.message, buttons, context.container));
