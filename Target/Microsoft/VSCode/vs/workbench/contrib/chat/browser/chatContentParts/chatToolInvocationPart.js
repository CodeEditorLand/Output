...
let ChatToolInvocationSubPart = class ChatToolInvocationSubPart2 extends Disposable {
  ...
  constructor(toolInvocation, context, renderer, listPool, editorPool, currentWidthDelegate, codeBlockModelCollection, codeBlockStartIndex, instantiationService, keybindingService, modelService, languageService, contextKeyService, languageModelToolsService, commandService, markerService, chatWidgetService) {
    super();
    this.toolInvocation = toolInvocation;
