...
let ChatEditingNotebookCellEntry = class ChatEditingNotebookCellEntry2 extends ObservableDisposable {
  static {
    __name(this, "ChatEditingNotebookCellEntry");
  }
  static {
    ChatEditingNotebookCellEntry_1 = this;
  }
  static {
  ...
  async _updateDiffInfo() {
    ...
    const diff = await this._editorWorkerService.computeDiff(this.originalModel.uri, this.modifiedModel.uri, { ignoreTrimWhitespace, computeMoves: false, maxComputationTimeMs: 3e3 }, "advanced");
    if (this.originalModel.isDisposed() || this.modifiedModel.isDisposed()) {
      return;
    }
