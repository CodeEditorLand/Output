  ...
  renderAgentWidget(args, store) {
    ...
    if (args.isClickable) {
      ...
      store.add(button.onDidClick(() => {
        ...
        this.chatService.sendRequest(widget.viewModel.sessionId, agent2.metadata.sampleRequest ?? "", {
