...
const chatRequestBubbleHoverBackground = registerColor("chat.requestBubbleHoverBackground", { dark: editorSelectionBackground, light: editorSelectionBackground, hcDark: null, hcLight: null }, localize("chat.requestBubbleHoverBackground", "Background color of the chat request bubble on hover."), true);
