...
let ChatEntitlementRequests = ChatEntitlementRequests_1 = class ChatEntitlementRequests2 extends Disposable {
  ...
  async signIn(options) {
    ...
    const session = await this.authenticationService.createSession(providerId, defaultChat.providerScopes[0], options?.useAlternateProvider ? { provider: defaultChat.alternativeProviderId } : void 0);
