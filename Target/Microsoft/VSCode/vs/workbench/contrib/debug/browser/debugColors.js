import{$sp as e,$Ep as a,$qq as x,$nq as g,$Gp as Co,$Wp as ko,$Xp as po,$9s as wo,$Kp as $o,$1r as So,$ir as Fo}from"../../../../platform/theme/common/colorRegistry.js";import{$Wt as mo}from"../../../../platform/theme/common/themeService.js";import{ThemeIcon as r}from"../../../../base/common/themables.js";import{$lp as fo}from"../../../../base/common/color.js";import{localize as c}from"../../../../nls.js";import*as n from"./debugIcons.js";import{$Ot as vo}from"../../../../platform/theme/common/theme.js";const Vo=e("debugToolBar.background",{dark:"#333333",light:"#F3F3F3",hcDark:"#000000",hcLight:"#FFFFFF"},c(6548,null)),To=e("debugToolBar.border",null,c(6549,null)),xo=e("debugIcon.startForeground",{dark:"#89D185",light:"#388A34",hcDark:"#89D185",hcLight:"#388A34"},c(6550,null));function Ro(){const L=e("debugTokenExpression.name",{dark:"#c586c0",light:"#9b46b0",hcDark:a,hcLight:a},"Foreground color for the token names shown in the debug views (ie. the Variables or Watch view)."),I=e("debugTokenExpression.type",{dark:"#4A90E2",light:"#4A90E2",hcDark:a,hcLight:a},"Foreground color for the token types shown in the debug views (ie. the Variables or Watch view)."),E=e("debugTokenExpression.value",{dark:"#cccccc99",light:"#6c6c6ccc",hcDark:a,hcLight:a},"Foreground color for the token values shown in the debug views (ie. the Variables or Watch view)."),D=e("debugTokenExpression.string",{dark:"#ce9178",light:"#a31515",hcDark:"#f48771",hcLight:"#a31515"},"Foreground color for strings in the debug views (ie. the Variables or Watch view)."),A=e("debugTokenExpression.boolean",{dark:"#4e94ce",light:"#0000ff",hcDark:"#75bdfe",hcLight:"#0000ff"},"Foreground color for booleans in the debug views (ie. the Variables or Watch view)."),B=e("debugTokenExpression.number",{dark:"#b5cea8",light:"#098658",hcDark:"#89d185",hcLight:"#098658"},"Foreground color for numbers in the debug views (ie. the Variables or Watch view)."),V=e("debugTokenExpression.error",{dark:"#f48771",light:"#e51400",hcDark:"#f48771",hcLight:"#e51400"},"Foreground color for expression errors in the debug views (ie. the Variables or Watch view) and for error logs shown in the debug console."),T=e("debugView.exceptionLabelForeground",{dark:a,light:"#FFF",hcDark:a,hcLight:a},"Foreground color for a label shown in the CALL STACK view when the debugger breaks on an exception."),R=e("debugView.exceptionLabelBackground",{dark:"#6C2022",light:"#A31515",hcDark:"#6C2022",hcLight:"#A31515"},"Background color for a label shown in the CALL STACK view when the debugger breaks on an exception."),y=e("debugView.stateLabelForeground",a,"Foreground color for a label in the CALL STACK view showing the current session's or thread's state."),W=e("debugView.stateLabelBackground","#88888844","Background color for a label in the CALL STACK view showing the current session's or thread's state."),O=e("debugView.valueChangedHighlight","#569CD6","Color used to highlight value changes in the debug views (ie. in the Variables view)."),P=e("debugConsole.infoForeground",{dark:x,light:x,hcDark:a,hcLight:a},"Foreground color for info messages in debug REPL console."),H=e("debugConsole.warningForeground",{dark:g,light:g,hcDark:"#008000",hcLight:g},"Foreground color for warning messages in debug REPL console."),K=e("debugConsole.errorForeground",Co,"Foreground color for error messages in debug REPL console."),N=e("debugConsole.sourceForeground",a,"Foreground color for source filenames in debug REPL console."),d=e("debugConsoleInputIcon.foreground",a,"Foreground color for debug console input marker icon."),q=e("debugIcon.pauseForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6551,null)),z=e("debugIcon.stopForeground",{dark:"#F48771",light:"#A1260D",hcDark:"#F48771",hcLight:"#A1260D"},c(6552,null)),j=e("debugIcon.disconnectForeground",{dark:"#F48771",light:"#A1260D",hcDark:"#F48771",hcLight:"#A1260D"},c(6553,null)),_=e("debugIcon.restartForeground",{dark:"#89D185",light:"#388A34",hcDark:"#89D185",hcLight:"#388A34"},c(6554,null)),G=e("debugIcon.stepOverForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6555,null)),X=e("debugIcon.stepIntoForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6556,null)),J=e("debugIcon.stepOutForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6557,null)),M=e("debugIcon.continueForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6558,null)),Q=e("debugIcon.stepBackForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6559,null));mo((o,t)=>{const s=o.getColor(ko),i=o.getColor(po),U=o.getColor(wo),u=o.getColor(T),b=o.getColor(R),Y=o.getColor(y),Z=o.getColor(W),l=o.getColor(O),oo=o.getColor(Fo);t.addRule(`
		...
		`);const so=o.getColor(So)||fo.fromHex("#80808060"),io=o.getColor(P),go=o.getColor(H),uo=o.getColor(K),bo=o.getColor(N),ho=o.getColor(d);t.addRule(`
		...
		`),o.defines(d)||t.addRule(`
			...
			`);const C=o.getColor(xo);C&&t.addRule(`.monaco-workbench ${r.asCSSSelector(n.$lCb)} { color: ${C}; }`);const k=o.getColor(q);k&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$hCb)}, .monaco-workbench ${r.asCSSSelector(n.$hCb)} { color: ${k}; }`);const p=o.getColor(z);p&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$aCb)},.monaco-workbench ${r.asCSSSelector(n.$aCb)} { color: ${p}; }`);const w=o.getColor(j);w&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$bCb)},.monaco-workbench .debug-view-content ${r.asCSSSelector(n.$bCb)}, .monaco-workbench .debug-toolbar ${r.asCSSSelector(n.$bCb)}, .monaco-workbench .command-center-center ${r.asCSSSelector(n.$bCb)} { color: ${w}; }`);const $=o.getColor(_);$&&t.addRule(`.monaco-workbench ${r.asCSSSelector(n.$cCb)}, .monaco-workbench ${r.asCSSSelector(n.$_Bb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$cCb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$_Bb)} { color: ${$}; }`);const S=o.getColor(G);S&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$dCb)}, .monaco-workbench ${r.asCSSSelector(n.$dCb)} { color: ${S}; }`);const F=o.getColor(X);F&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$eCb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$eCb)}, .monaco-workbench ${r.asCSSSelector(n.$eCb)} { color: ${F}; }`);const m=o.getColor(J);m&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$fCb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$fCb)}, .monaco-workbench ${r.asCSSSelector(n.$fCb)} { color: ${m}; }`);const f=o.getColor(M);f&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$iCb)}, .monaco-workbench ${r.asCSSSelector(n.$iCb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$jCb)}, .monaco-workbench ${r.asCSSSelector(n.$jCb)} { color: ${f}; }`);const v=o.getColor(Q);v&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$gCb)}, .monaco-workbench ${r.asCSSSelector(n.$gCb)} { color: ${v}; }`)})}export{Vo as $CCb,To as $DCb,xo as $ECb,Ro as $FCb};
