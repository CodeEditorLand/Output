import{$dp as e,$pp as a,$aq as v,$0p as g,$rp as ko,$Hp as po,$Ip as Co,$Ss as wo,$vp as $o,$Kr as So,$5q as Fo}from"../../../../platform/theme/common/colorRegistry.js";import{$Gt as mo}from"../../../../platform/theme/common/themeService.js";import{ThemeIcon as r}from"../../../../base/common/themables.js";import{$9o as xo}from"../../../../base/common/color.js";import{localize as c}from"../../../../nls.js";import*as n from"./debugIcons.js";import{$yt as fo}from"../../../../platform/theme/common/theme.js";const Vo=e("debugToolBar.background",{dark:"#333333",light:"#F3F3F3",hcDark:"#000000",hcLight:"#FFFFFF"},c(6231,null)),To=e("debugToolBar.border",null,c(6232,null)),vo=e("debugIcon.startForeground",{dark:"#89D185",light:"#388A34",hcDark:"#89D185",hcLight:"#388A34"},c(6233,null));function Ro(){const L=e("debugTokenExpression.name",{dark:"#c586c0",light:"#9b46b0",hcDark:a,hcLight:a},"Foreground color for the token names shown in the debug views (ie. the Variables or Watch view)."),I=e("debugTokenExpression.type",{dark:"#4A90E2",light:"#4A90E2",hcDark:a,hcLight:a},"Foreground color for the token types shown in the debug views (ie. the Variables or Watch view)."),E=e("debugTokenExpression.value",{dark:"#cccccc99",light:"#6c6c6ccc",hcDark:a,hcLight:a},"Foreground color for the token values shown in the debug views (ie. the Variables or Watch view)."),D=e("debugTokenExpression.string",{dark:"#ce9178",light:"#a31515",hcDark:"#f48771",hcLight:"#a31515"},"Foreground color for strings in the debug views (ie. the Variables or Watch view)."),A=e("debugTokenExpression.boolean",{dark:"#4e94ce",light:"#0000ff",hcDark:"#75bdfe",hcLight:"#0000ff"},"Foreground color for booleans in the debug views (ie. the Variables or Watch view)."),B=e("debugTokenExpression.number",{dark:"#b5cea8",light:"#098658",hcDark:"#89d185",hcLight:"#098658"},"Foreground color for numbers in the debug views (ie. the Variables or Watch view)."),V=e("debugTokenExpression.error",{dark:"#f48771",light:"#e51400",hcDark:"#f48771",hcLight:"#e51400"},"Foreground color for expression errors in the debug views (ie. the Variables or Watch view) and for error logs shown in the debug console."),T=e("debugView.exceptionLabelForeground",{dark:a,light:"#FFF",hcDark:a,hcLight:a},"Foreground color for a label shown in the CALL STACK view when the debugger breaks on an exception."),R=e("debugView.exceptionLabelBackground",{dark:"#6C2022",light:"#A31515",hcDark:"#6C2022",hcLight:"#A31515"},"Background color for a label shown in the CALL STACK view when the debugger breaks on an exception."),y=e("debugView.stateLabelForeground",a,"Foreground color for a label in the CALL STACK view showing the current session's or thread's state."),W=e("debugView.stateLabelBackground","#88888844","Background color for a label in the CALL STACK view showing the current session's or thread's state."),O=e("debugView.valueChangedHighlight","#569CD6","Color used to highlight value changes in the debug views (ie. in the Variables view)."),H=e("debugConsole.infoForeground",{dark:v,light:v,hcDark:a,hcLight:a},"Foreground color for info messages in debug REPL console."),P=e("debugConsole.warningForeground",{dark:g,light:g,hcDark:"#008000",hcLight:g},"Foreground color for warning messages in debug REPL console."),K=e("debugConsole.errorForeground",ko,"Foreground color for error messages in debug REPL console."),N=e("debugConsole.sourceForeground",a,"Foreground color for source filenames in debug REPL console."),u=e("debugConsoleInputIcon.foreground",a,"Foreground color for debug console input marker icon."),Z=e("debugIcon.pauseForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6234,null)),q=e("debugIcon.stopForeground",{dark:"#F48771",light:"#A1260D",hcDark:"#F48771",hcLight:"#A1260D"},c(6235,null)),z=e("debugIcon.disconnectForeground",{dark:"#F48771",light:"#A1260D",hcDark:"#F48771",hcLight:"#A1260D"},c(6236,null)),X=e("debugIcon.restartForeground",{dark:"#89D185",light:"#388A34",hcDark:"#89D185",hcLight:"#388A34"},c(6237,null)),Y=e("debugIcon.stepOverForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6238,null)),G=e("debugIcon.stepIntoForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6239,null)),j=e("debugIcon.stepOutForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6240,null)),J=e("debugIcon.continueForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6241,null)),M=e("debugIcon.stepBackForeground",{dark:"#75BEFF",light:"#007ACC",hcDark:"#75BEFF",hcLight:"#007ACC"},c(6242,null));mo((o,t)=>{const s=o.getColor(po),i=o.getColor(Co),Q=o.getColor(wo),d=o.getColor(T),b=o.getColor(R),U=o.getColor(y),_=o.getColor(W),l=o.getColor(O),oo=o.getColor(Fo);t.addRule(`
		...
		`);const so=o.getColor(So)||xo.fromHex("#80808060"),io=o.getColor(H),go=o.getColor(P),uo=o.getColor(K),bo=o.getColor(N),ho=o.getColor(u);t.addRule(`
		...
		`),o.defines(u)||t.addRule(`
			...
			`);const k=o.getColor(vo);k&&t.addRule(`.monaco-workbench ${r.asCSSSelector(n.$0xb)} { color: ${k}; }`);const p=o.getColor(Z);p&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$6xb)}, .monaco-workbench ${r.asCSSSelector(n.$6xb)} { color: ${p}; }`);const C=o.getColor(q);C&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$Yxb)},.monaco-workbench ${r.asCSSSelector(n.$Yxb)} { color: ${C}; }`);const w=o.getColor(z);w&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$Zxb)},.monaco-workbench .debug-view-content ${r.asCSSSelector(n.$Zxb)}, .monaco-workbench .debug-toolbar ${r.asCSSSelector(n.$Zxb)}, .monaco-workbench .command-center-center ${r.asCSSSelector(n.$Zxb)} { color: ${w}; }`);const $=o.getColor(X);$&&t.addRule(`.monaco-workbench ${r.asCSSSelector(n.$1xb)}, .monaco-workbench ${r.asCSSSelector(n.$Xxb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$1xb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$Xxb)} { color: ${$}; }`);const S=o.getColor(Y);S&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$2xb)}, .monaco-workbench ${r.asCSSSelector(n.$2xb)} { color: ${S}; }`);const F=o.getColor(G);F&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$3xb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$3xb)}, .monaco-workbench ${r.asCSSSelector(n.$3xb)} { color: ${F}; }`);const m=o.getColor(j);m&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$4xb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$4xb)}, .monaco-workbench ${r.asCSSSelector(n.$4xb)} { color: ${m}; }`);const x=o.getColor(J);x&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$7xb)}, .monaco-workbench ${r.asCSSSelector(n.$7xb)}, .monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$8xb)}, .monaco-workbench ${r.asCSSSelector(n.$8xb)} { color: ${x}; }`);const f=o.getColor(M);f&&t.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${r.asCSSSelector(n.$5xb)}, .monaco-workbench ${r.asCSSSelector(n.$5xb)} { color: ${f}; }`)})}export{Vo as $oyb,To as $pyb,vo as $qyb,Ro as $ryb};
