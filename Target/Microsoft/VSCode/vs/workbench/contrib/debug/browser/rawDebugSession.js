...
let RawDebugSession = class {
    ...
    this.debugAdapter.onEvent((event) => {
      switch (event.event) {
        ...
        case "stopped":
          ...
          break;
        case "continued":
          this.allThreadsContinued = event.body.allThreadsContinued !== false;
  ...
  async dispatchRequest(request) {
    ...
    const safeSendResponse = /* @__PURE__ */ __name((response2) => this.debugAdapter?.sendResponse(response2), "safeSendResponse");
