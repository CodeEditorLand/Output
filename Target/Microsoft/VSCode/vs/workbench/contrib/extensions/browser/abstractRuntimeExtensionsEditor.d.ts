...
declare class st extends Q {
    constructor();
    run(a: any): Promise<void>;
}
import { $KI as Q } from "../../../../platform/actions/common/actions.js";
export { M as $sjc, st as $tjc };
//# sourceMappingURL=abstractRuntimeExtensionsEditor.d.ts.map