...
let InlineChatWidget = class InlineChatWidget2 {
  ...
  constructor(location, _options, _instantiationService, _contextKeyService, _keybindingService, _accessibilityService, _configurationService, _accessibleViewService, _textModelResolverService, _chatService, _hoverService) {
    ...
    this._chatWidget = scopedInstaService.createInstance(ChatWidget, location, void 0, {
      autoScroll: true,
...
let HunkAccessibleDiffViewer = HunkAccessibleDiffViewer_1 = class HunkAccessibleDiffViewer2 extends AccessibleDiffViewer {
  static {
  ...
  constructor(parentNode, session, hunk, models, instantiationService) {
    ...
    const height = models.getModifiedOptions().get(
      68
    ...
    this._store.add(session.textModelN.onDidChangeContent(() => {
      diff.set(HunkAccessibleDiffViewer_1._asMapping(hunk), void 0);
    }));
  }
