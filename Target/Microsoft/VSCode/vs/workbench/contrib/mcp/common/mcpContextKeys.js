...
var McpContextKeys;
((McpContextKeys2) => {
  McpContextKeys2.serverCount = new RawContextKey(
    "mcp.serverCount",
    void 0,
    {
      type: "number",
  ...
  McpContextKeys2.hasUnknownTools = new RawContextKey(
    "mcp.hasUnknownTools",
    void 0,
    {
      type: "boolean",
  ...
  McpContextKeys2.hasServersWithErrors = new RawContextKey(
  ...
  McpContextKeys2.toolsCount = new RawContextKey(
    "mcp.toolsCount",
    void 0,
    {
      type: "number",
  ...
  constructor(mcpService, contextKeyService) {
    ...
    this._store.add(
      autorun((r) => {
        ...
        ctxHasUnknownTools.set(
          mcpService.lazyCollectionState.read(r) !== LazyCollectionState.AllKnown || servers.some((s) => {
