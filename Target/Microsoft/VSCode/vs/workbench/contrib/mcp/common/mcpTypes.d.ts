...
export declare const enum McpServerStaticToolAvailability {
 ...
 */
export declare const enum McpToolVisibility {
...
export declare const enum McpServerEnablementState {
    Disabled = 0,
    DisabledByAccess = 1,
    Enabled = 2
}
export declare const enum McpServerInstallState {
    Installing = 0,
    Installed = 1,
    Uninstalling = 2,
    Uninstalled = 3
}
export declare const enum McpServerEditorTab {
    Readme = "readme",
    Manifest = "manifest",
...
export declare const enum ElicitationKind {
    Form = 0,
    URL = 1
}
