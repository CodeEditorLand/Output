...
let ResultCodeEditorView = class ResultCodeEditorView2 extends CodeEditorView {
  ...
  constructor(viewModel, instantiationService, _labelService, configurationService) {
    ...
    this.decorations = derived(this, (reader) => {
      ...
      const baseRangeWithStoreAndTouchingDiffs = join(model.modifiedBaseRanges.read(reader), model.baseResultDiffs.read(reader), (baseRange, diff) => baseRange.baseRange.touches(diff.inputRange) ? CompareResult.neitherLessOrGreaterThan : LineRange.compareByStart(baseRange.baseRange, diff.inputRange));
