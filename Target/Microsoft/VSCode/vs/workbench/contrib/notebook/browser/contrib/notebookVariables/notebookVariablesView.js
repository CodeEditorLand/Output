...
let NotebookVariablesView = class NotebookVariablesView2 extends ViewPane {
  ...
  static {
    NotebookVariablesView_1 = this;
  }
  static {
    this.ID = "notebookVariablesView";
  }
  static {
    this.NOTEBOOK_TITLE = nls.localize2("notebook.notebookVariables", "Notebook Variables");
  }
  static {
    this.REPL_TITLE = nls.localize2("notebook.ReplVariables", "REPL Variables");
  }
