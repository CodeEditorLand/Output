import{getWindow as A}from"../../../../../../base/browser/dom.js";import{$5b as K}from"../../../../../../base/common/arrays.js";import{$8h as R,$1h as V}from"../../../../../../base/common/async.js";import{$4i as J}from"../../../../../../base/common/buffer.js";import{$cf as X}from"../../../../../../base/common/event.js";import{$4B as Y}from"../../../../../../base/common/mime.js";import{$7g as Q,Schemas as p,$Vg as x,$Wg as Z}from"../../../../../../base/common/network.js";import{$6o as ee}from"../../../../../../base/common/objects.js";import*as te from"../../../../../../base/common/path.js";import{$m as ie,$r as oe}from"../../../../../../base/common/platform.js";import{$ih as g,$hh as se,$ch as re,$jh as ne}from"../../../../../../base/common/resources.js";import{URI as b}from"../../../../../../base/common/uri.js";import*as C from"../../../../../../base/common/uuid.js";import{$xD as N}from"../../../../../../editor/common/languages.js";import{$yD as ae}from"../../../../../../editor/common/languages/language.js";import{$DPb as de}from"../../../../../../editor/common/languages/supports/tokenization.js";import{$jdb as ue}from"../../../../../../editor/common/languages/textToHtmlTokenizer.js";import*as v from"../../../../../../nls.js";import{$aI as le}from"../../../../../../platform/actions/common/actions.js";import{$El as ce}from"../../../../../../platform/configuration/common/configuration.js";import{$Vn as he}from"../../../../../../platform/contextkey/common/contextkey.js";import{$2eb as pe}from"../../../../../../platform/contextview/browser/contextView.js";import{$bp as fe}from"../../../../../../platform/dialogs/common/dialogs.js";import{$6j as be}from"../../../../../../platform/files/common/files.js";import{$E$ as me}from"../../../../../../platform/opener/common/opener.js";import{$Ho as ge}from"../../../../../../platform/storage/common/storage.js";import{$Po as ke}from"../../../../../../platform/telemetry/common/telemetry.js";import{$wq as ve,$yq as we}from"../../../../../../platform/theme/common/colorRegistry.js";import{$Lt as ye,$St as Ie}from"../../../../../../platform/theme/common/themeService.js";import{$hl as S}from"../../../../../../platform/workspace/common/workspace.js";import{$IM as Ce}from"../../../../../../platform/workspace/common/workspaceTrust.js";import{CellEditState as Me}from"../../notebookBrowser.js";import{$ETb as Ee}from"../notebookCellList.js";import{$HTb as $e}from"./webviewPreloads.js";import{$ITb as Oe}from"./webviewThemeMapping.js";import{$5Sb as M}from"../../viewModel/markupCellViewModel.js";import{CellUri as Re}from"../../../common/notebookCommon.js";import{$JTb as xe}from"../../../common/notebookLoggingService.js";import{$pyb as Se}from"../../../common/notebookService.js";import{$Fyb as Pe,$Hyb as We}from"../../../../webview/browser/webview.js";import{$LTb as Ge}from"../../../../webview/browser/webviewWindowDragMonitor.js";import{$PTb as Ne,$OTb as w}from"../../../../webview/common/webview.js";import{$hI as Be}from"../../../../../services/editor/common/editorGroupsService.js";import{$eX as Le}from"../../../../../services/environment/common/environmentService.js";import{$wX as Te}from"../../../../../services/path/common/pathService.js";var q=function(c,e,t,s){var r=arguments.length,i=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,t,s);else for(var n=c.length-1;n>=0;n--)(o=c[n])&&(i=(r<3?o(i):r>3?o(e,t,i):o(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i},l=function(c,e){return function(t,s){e(t,s,c)}},E;const He=/:([\d]+)(?::([\d]+))?$/,Ue=/line=(\d+)$/,De=/^(.*)#([^#]*)$/;let P=class extends Ie{static{E=this}static b(e){return this.a??=new We("notebook.backlayerWebview.origins",e),this.a}constructor(e,t,s,r,i,o,n,a,d,u,h,m,f,y,k,$,B,L,T,H,U,D,F,_,z){super(_),this.notebookEditor=e,this.F=t,this.notebookViewType=s,this.documentUri=r,this.G=i,this.H=o,this.I=n,this.J=a,this.L=d,this.M=u,this.N=h,this.O=m,this.P=f,this.Q=y,this.R=k,this.S=$,this.U=B,this.W=L,this.X=T,this.Y=H,this.Z=U,this.$=D,this.ab=F,this.bb=z,this.webview=void 0,this.insetMapping=new Map,this.pendingWebviewIdleCreationRequest=new Map,this.pendingWebviewIdleInsetMapping=new Map,this.c=new Map,this.markupPreviewMapping=new Map,this.f=new Set,this.g=new Map,this.j=void 0,this.m=this.B(new X),this.r=new Set,this.onMessage=this.m.event,this.s=!1,this.u=!0,this.D=C.$Rm(),this.cb("Creating backlayer webview for notebook"),this.element=document.createElement("div"),this.element.style.height="1400px",this.element.style.position="absolute",o&&(this.B(o),o.receiveMessageHandler=(O,I)=>!this.webview||this.s?Promise.resolve(!1):(this.Eb({__vscode_notebook_message:!0,type:"customRendererMessage",rendererId:O,message:I}),Promise.resolve(!0))),this.B($.onDidChangeTrust(O=>{const I=this.jb(this.lb(),void 0),j=this.gb(I.toString());this.webview?.setHtml(j)})),this.B(N.onDidChange(()=>{this.Eb({type:"tokenizedStylesChanged",css:G()})}))}updateOptions(e){this.G=e,this.db(),this.eb()}cb(e){this.ab.debug("BacklayerWebview",`${this.documentUri} (${this.F}) - ${e}`)}db(){this.Eb({type:"notebookStyles",styles:this.fb()})}eb(){this.Eb({type:"notebookOptions",options:{dragAndDropEnabled:this.G.dragAndDropEnabled},renderOptions:{lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError}})}fb(){return{"notebook-output-left-margin":`${this.G.leftMargin+this.G.runGutter}px`,"notebook-output-width":`calc(100% - ${this.G.leftMargin+this.G.rightMargin+this.G.runGutter}px)`,"notebook-output-node-padding":`${this.G.outputNodePadding}px`,"notebook-run-gutter":`${this.G.runGutter}px`,"notebook-preview-node-padding":`${this.G.previewNodePadding}px`,"notebook-markdown-left-margin":`${this.G.markdownLeftMargin}px`,"notebook-output-node-left-padding":`${this.G.outputNodeLeftPadding}px`,"notebook-markdown-min-height":`${this.G.previewNodePadding*2}px`,"notebook-markup-font-size":typeof this.G.markupFontSize=="number"&&this.G.markupFontSize>0?`${this.G.markupFontSize}px`:`calc(${this.G.fontSize}px * 1.2)`,"notebook-markdown-line-height":typeof this.G.markdownLineHeight=="number"&&this.G.markdownLineHeight>0?`${this.G.markdownLineHeight}px`:"normal","notebook-cell-output-font-size":`${this.G.outputFontSize||this.G.fontSize}px`,"notebook-cell-output-line-height":`${this.G.outputLineHeight}px`,"notebook-cell-output-max-height":`${this.G.outputLineHeight*this.G.outputLineLimit+2}px`,"notebook-cell-output-font-family":this.G.outputFontFamily||this.G.fontFamily,"notebook-cell-markup-empty-content":v.localize(9462,null),"notebook-cell-renderer-not-found-error":v.localize(9463,null),"notebook-cell-renderer-fallbacks-exhausted":v.localize(9464,null),"notebook-markup-font-family":this.G.markupFontFamily}}gb(e){const t=this.hb(),s=this.ib(),r={lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError},i=$e({...this.G,tokenizationCss:G()},{dragAndDropEnabled:this.G.dragAndDropEnabled},r,t,s,this.S.isWorkspaceTrusted(),this.D),o=this.U.getValue("notebook.experimental.enableCsp"),n=this.z(ve),a=this.z(we);return`
		<html lang="en">
			<head>
				<meta charset="UTF-8">
				<base href="${e}/" />
