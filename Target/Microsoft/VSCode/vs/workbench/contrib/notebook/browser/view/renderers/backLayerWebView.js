import{getWindow as q}from"../../../../../../base/browser/dom.js";import{$7b as K}from"../../../../../../base/common/arrays.js";import{$0h as x,$3h as V}from"../../../../../../base/common/async.js";import{$3i as J}from"../../../../../../base/common/buffer.js";import{$df as X}from"../../../../../../base/common/event.js";import{$6B as Y}from"../../../../../../base/common/mime.js";import{$8g as Q,Schemas as h,$Wg as R,$Xg as Z}from"../../../../../../base/common/network.js";import{$7o as ee}from"../../../../../../base/common/objects.js";import*as te from"../../../../../../base/common/path.js";import{$n as ie,$s as oe}from"../../../../../../base/common/platform.js";import{$jh as g,$ih as se,$dh as re,$kh as ne}from"../../../../../../base/common/resources.js";import{URI as b}from"../../../../../../base/common/uri.js";import*as C from"../../../../../../base/common/uuid.js";import{$zD as T}from"../../../../../../editor/common/languages.js";import{$AD as ae}from"../../../../../../editor/common/languages/language.js";import{$yQb as de}from"../../../../../../editor/common/languages/supports/tokenization.js";import{$Vdb as ue}from"../../../../../../editor/common/languages/textToHtmlTokenizer.js";import*as v from"../../../../../../nls.js";import{$tI as le}from"../../../../../../platform/actions/common/actions.js";import{$El as ce}from"../../../../../../platform/configuration/common/configuration.js";import{$Vn as pe}from"../../../../../../platform/contextkey/common/contextkey.js";import{$Bfb as he}from"../../../../../../platform/contextview/browser/contextView.js";import{$cp as fe}from"../../../../../../platform/dialogs/common/dialogs.js";import{$5j as be}from"../../../../../../platform/files/common/files.js";import{$e_ as me}from"../../../../../../platform/opener/common/opener.js";import{$Io as ge}from"../../../../../../platform/storage/common/storage.js";import{$Qo as ke}from"../../../../../../platform/telemetry/common/telemetry.js";import{$yq as ve,$Aq as we}from"../../../../../../platform/theme/common/colorRegistry.js";import{$Nt as ye,$Ut as Ie}from"../../../../../../platform/theme/common/themeService.js";import{$hl as S}from"../../../../../../platform/workspace/common/workspace.js";import{$OM as Ce}from"../../../../../../platform/workspace/common/workspaceTrust.js";import{CellEditState as Me}from"../../notebookBrowser.js";import{$dTb as Ee}from"../notebookCellList.js";import{$gTb as $e}from"./webviewPreloads.js";import{$hTb as Oe}from"./webviewThemeMapping.js";import{$DSb as M}from"../../viewModel/markupCellViewModel.js";import{CellUri as xe,$SL as Re}from"../../../common/notebookCommon.js";import{$iTb as Se}from"../../../common/notebookLoggingService.js";import{$7yb as We}from"../../../common/notebookService.js";import{$kzb as Ne,$mzb as Ge}from"../../../../webview/browser/webview.js";import{$kTb as Te}from"../../../../webview/browser/webviewWindowDragMonitor.js";import{$oTb as Be,$nTb as w}from"../../../../webview/common/webview.js";import{$AI as Pe}from"../../../../../services/editor/common/editorGroupsService.js";import{$DW as Le}from"../../../../../services/environment/common/environmentService.js";import{$pY as Ue}from"../../../../../services/path/common/pathService.js";import{$sTb as De,$rTb as He,$uTb as ze}from"../../viewModel/cellOutputTextHelper.js";var A=function(c,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,t,o);else for(var n=c.length-1;n>=0;n--)(s=c[n])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i},l=function(c,e){return function(t,o){e(t,o,c)}},E;const Fe=/:([\d]+)(?::([\d]+))?$/,_e=/line=(\d+)$/,je=/^(.*)#([^#]*)$/;let W=class extends Ie{static{E=this}static b(e){return this.a??=new Ge("notebook.backlayerWebview.origins",e),this.a}constructor(e,t,o,r,i,s,n,a,d,u,p,m,f,y,k,$,B,P,L,U,D,H,z,F,_){super(F),this.notebookEditor=e,this.F=t,this.notebookViewType=o,this.documentUri=r,this.G=i,this.H=s,this.I=n,this.J=a,this.L=d,this.M=u,this.N=p,this.O=m,this.P=f,this.Q=y,this.R=k,this.S=$,this.U=B,this.W=P,this.X=L,this.Y=U,this.Z=D,this.$=H,this.ab=z,this.bb=_,this.webview=void 0,this.insetMapping=new Map,this.pendingWebviewIdleCreationRequest=new Map,this.pendingWebviewIdleInsetMapping=new Map,this.c=new Map,this.markupPreviewMapping=new Map,this.f=new Set,this.g=new Map,this.j=void 0,this.m=this.B(new X),this.r=new Set,this.onMessage=this.m.event,this.s=!1,this.u=!0,this.D=C.$Rm(),this.cb("Creating backlayer webview for notebook"),this.element=document.createElement("div"),this.element.style.height="1400px",this.element.style.position="absolute",s&&(this.B(s),s.receiveMessageHandler=(O,I)=>!this.webview||this.s?Promise.resolve(!1):(this.Eb({__vscode_notebook_message:!0,type:"customRendererMessage",rendererId:O,message:I}),Promise.resolve(!0))),this.B($.onDidChangeTrust(O=>{const I=this.jb(this.lb(),void 0),j=this.gb(I.toString());this.webview?.setHtml(j)})),this.B(T.onDidChange(()=>{this.Eb({type:"tokenizedStylesChanged",css:G()})}))}updateOptions(e){this.G=e,this.db(),this.eb()}cb(e){this.ab.debug("BacklayerWebview",`${this.documentUri} (${this.F}) - ${e}`)}db(){this.Eb({type:"notebookStyles",styles:this.fb()})}eb(){this.Eb({type:"notebookOptions",options:{dragAndDropEnabled:this.G.dragAndDropEnabled},renderOptions:{lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError}})}fb(){return{"notebook-output-left-margin":`${this.G.leftMargin+this.G.runGutter}px`,"notebook-output-width":`calc(100% - ${this.G.leftMargin+this.G.rightMargin+this.G.runGutter}px)`,"notebook-output-node-padding":`${this.G.outputNodePadding}px`,"notebook-run-gutter":`${this.G.runGutter}px`,"notebook-preview-node-padding":`${this.G.previewNodePadding}px`,"notebook-markdown-left-margin":`${this.G.markdownLeftMargin}px`,"notebook-output-node-left-padding":`${this.G.outputNodeLeftPadding}px`,"notebook-markdown-min-height":`${this.G.previewNodePadding*2}px`,"notebook-markup-font-size":typeof this.G.markupFontSize=="number"&&this.G.markupFontSize>0?`${this.G.markupFontSize}px`:`calc(${this.G.fontSize}px * 1.2)`,"notebook-markdown-line-height":typeof this.G.markdownLineHeight=="number"&&this.G.markdownLineHeight>0?`${this.G.markdownLineHeight}px`:"normal","notebook-cell-output-font-size":`${this.G.outputFontSize||this.G.fontSize}px`,"notebook-cell-output-line-height":`${this.G.outputLineHeight}px`,"notebook-cell-output-max-height":`${this.G.outputLineHeight*this.G.outputLineLimit+2}px`,"notebook-cell-output-font-family":this.G.outputFontFamily||this.G.fontFamily,"notebook-cell-markup-empty-content":v.localize(9683,null),"notebook-cell-renderer-not-found-error":v.localize(9684,null),"notebook-cell-renderer-fallbacks-exhausted":v.localize(9685,null),"notebook-markup-font-family":this.G.markupFontFamily}}gb(e){const t=this.hb(),o=this.ib(),r={lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError},i=$e({...this.G,tokenizationCss:G()},{dragAndDropEnabled:this.G.dragAndDropEnabled},r,t,o,this.S.isWorkspaceTrusted(),this.D),s=this.U.getValue("notebook.experimental.enableCsp"),n=this.z(ve),a=this.z(we);return`
		<html lang="en">
			<head>
				<meta charset="UTF-8">
				<base href="${e}/" />
