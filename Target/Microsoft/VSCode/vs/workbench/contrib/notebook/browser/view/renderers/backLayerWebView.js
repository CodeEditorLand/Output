import{getWindow as A}from"../../../../../../base/browser/dom.js";import{$Kb as K}from"../../../../../../base/common/arrays.js";import{$4h as x,$Wh as V}from"../../../../../../base/common/async.js";import{$Vi as J}from"../../../../../../base/common/buffer.js";import{$af as X}from"../../../../../../base/common/event.js";import{$QB as Y}from"../../../../../../base/common/mime.js";import{$4g as Q,Schemas as h,$Sg as O,$Tg as Z}from"../../../../../../base/common/network.js";import{$Vo as ee}from"../../../../../../base/common/objects.js";import*as te from"../../../../../../base/common/path.js";import{$m as ie,$r as oe}from"../../../../../../base/common/platform.js";import{$fh as g,$eh as se,$_g as re,$gh as ne}from"../../../../../../base/common/resources.js";import{URI as b}from"../../../../../../base/common/uri.js";import*as C from"../../../../../../base/common/uuid.js";import{$ED as B}from"../../../../../../editor/common/languages.js";import{$GD as ae}from"../../../../../../editor/common/languages/language.js";import{$GNb as de}from"../../../../../../editor/common/languages/supports/tokenization.js";import{$kcb as ue}from"../../../../../../editor/common/languages/textToHtmlTokenizer.js";import*as v from"../../../../../../nls.js";import{$UH as le}from"../../../../../../platform/actions/common/actions.js";import{$ul as ce}from"../../../../../../platform/configuration/common/configuration.js";import{$Ln as pe}from"../../../../../../platform/contextkey/common/contextkey.js";import{$3db as he}from"../../../../../../platform/contextview/browser/contextView.js";import{$4o as fe}from"../../../../../../platform/dialogs/common/dialogs.js";import{$Vj as be}from"../../../../../../platform/files/common/files.js";import{$F0 as me}from"../../../../../../platform/opener/common/opener.js";import{$xo as ge}from"../../../../../../platform/storage/common/storage.js";import{$Fo as ke}from"../../../../../../platform/telemetry/common/telemetry.js";import{$mq as ve,$oq as we}from"../../../../../../platform/theme/common/colorRegistry.js";import{$Bt as ye,$It as Ie}from"../../../../../../platform/theme/common/themeService.js";import{$0k as W}from"../../../../../../platform/workspace/common/workspace.js";import{$bM as Ce}from"../../../../../../platform/workspace/common/workspaceTrust.js";import{CellEditState as Me}from"../../notebookBrowser.js";import{$QRb as Ee}from"../notebookCellList.js";import{$TRb as $e}from"./webviewPreloads.js";import{$URb as Re}from"./webviewThemeMapping.js";import{$eRb as M}from"../../viewModel/markupCellViewModel.js";import{CellUri as xe}from"../../../common/notebookCommon.js";import{$VRb as Oe}from"../../../common/notebookLoggingService.js";import{$nxb as We}from"../../../common/notebookService.js";import{$Dxb as Ge,$Fxb as Se}from"../../../../webview/browser/webview.js";import{$XRb as Ne}from"../../../../webview/browser/webviewWindowDragMonitor.js";import{$2Rb as Be,$1Rb as w}from"../../../../webview/common/webview.js";import{$2H as Pe}from"../../../../../services/editor/common/editorGroupsService.js";import{$eW as Le}from"../../../../../services/environment/common/environmentService.js";import{$wW as He}from"../../../../../services/path/common/pathService.js";var q=function(c,e,t,s){var r=arguments.length,i=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,t,s);else for(var n=c.length-1;n>=0;n--)(o=c[n])&&(i=(r<3?o(i):r>3?o(e,t,i):o(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i},l=function(c,e){return function(t,s){e(t,s,c)}},E;const Ue=/:([\d]+)(?::([\d]+))?$/,De=/line=(\d+)$/,Fe=/^(.*)#([^#]*)$/;let G=class extends Ie{static{E=this}static b(e){return this.a??=new Se("notebook.backlayerWebview.origins",e),this.a}constructor(e,t,s,r,i,o,n,a,d,u,p,m,f,y,k,$,P,L,H,U,D,F,T,_,z){super(_),this.notebookEditor=e,this.F=t,this.notebookViewType=s,this.documentUri=r,this.G=i,this.H=o,this.I=n,this.J=a,this.L=d,this.M=u,this.N=p,this.O=m,this.P=f,this.Q=y,this.R=k,this.S=$,this.U=P,this.W=L,this.X=H,this.Y=U,this.Z=D,this.$=F,this.ab=T,this.bb=z,this.webview=void 0,this.insetMapping=new Map,this.pendingWebviewIdleCreationRequest=new Map,this.pendingWebviewIdleInsetMapping=new Map,this.c=new Map,this.markupPreviewMapping=new Map,this.f=new Set,this.g=new Map,this.j=void 0,this.m=this.B(new X),this.r=new Set,this.onMessage=this.m.event,this.s=!1,this.u=!0,this.D=C.$Hm(),this.cb("Creating backlayer webview for notebook"),this.element=document.createElement("div"),this.element.style.height="1400px",this.element.style.position="absolute",o&&(this.B(o),o.receiveMessageHandler=(R,I)=>!this.webview||this.s?Promise.resolve(!1):(this.Eb({__vscode_notebook_message:!0,type:"customRendererMessage",rendererId:R,message:I}),Promise.resolve(!0))),this.B($.onDidChangeTrust(R=>{const I=this.jb(this.lb(),void 0),j=this.gb(I.toString());this.webview?.setHtml(j)})),this.B(B.onDidChange(()=>{this.Eb({type:"tokenizedStylesChanged",css:N()})}))}updateOptions(e){this.G=e,this.db(),this.eb()}cb(e){this.ab.debug("BacklayerWebview",`${this.documentUri} (${this.F}) - ${e}`)}db(){this.Eb({type:"notebookStyles",styles:this.fb()})}eb(){this.Eb({type:"notebookOptions",options:{dragAndDropEnabled:this.G.dragAndDropEnabled},renderOptions:{lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError}})}fb(){return{"notebook-output-left-margin":`${this.G.leftMargin+this.G.runGutter}px`,"notebook-output-width":`calc(100% - ${this.G.leftMargin+this.G.rightMargin+this.G.runGutter}px)`,"notebook-output-node-padding":`${this.G.outputNodePadding}px`,"notebook-run-gutter":`${this.G.runGutter}px`,"notebook-preview-node-padding":`${this.G.previewNodePadding}px`,"notebook-markdown-left-margin":`${this.G.markdownLeftMargin}px`,"notebook-output-node-left-padding":`${this.G.outputNodeLeftPadding}px`,"notebook-markdown-min-height":`${this.G.previewNodePadding*2}px`,"notebook-markup-font-size":typeof this.G.markupFontSize=="number"&&this.G.markupFontSize>0?`${this.G.markupFontSize}px`:`calc(${this.G.fontSize}px * 1.2)`,"notebook-markdown-line-height":typeof this.G.markdownLineHeight=="number"&&this.G.markdownLineHeight>0?`${this.G.markdownLineHeight}px`:"normal","notebook-cell-output-font-size":`${this.G.outputFontSize||this.G.fontSize}px`,"notebook-cell-output-line-height":`${this.G.outputLineHeight}px`,"notebook-cell-output-max-height":`${this.G.outputLineHeight*this.G.outputLineLimit+2}px`,"notebook-cell-output-font-family":this.G.outputFontFamily||this.G.fontFamily,"notebook-cell-markup-empty-content":v.localize(9260,null),"notebook-cell-renderer-not-found-error":v.localize(9261,null),"notebook-cell-renderer-fallbacks-exhausted":v.localize(9262,null),"notebook-markup-font-family":this.G.markupFontFamily}}gb(e){const t=this.hb(),s=this.ib(),r={lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError},i=$e({...this.G,tokenizationCss:N()},{dragAndDropEnabled:this.G.dragAndDropEnabled},r,t,s,this.S.isWorkspaceTrusted(),this.D),o=this.U.getValue("notebook.experimental.enableCsp"),n=this.z(ve),a=this.z(we);return`
		<html lang="en">
			<head>
				<meta charset="UTF-8">
				<base href="${e}/" />
