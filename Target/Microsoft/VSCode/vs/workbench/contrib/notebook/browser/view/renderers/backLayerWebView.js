import{getWindow as A}from"../../../../../../base/browser/dom.js";import{$4b as K}from"../../../../../../base/common/arrays.js";import{$6h as x,$Yh as V}from"../../../../../../base/common/async.js";import{$2i as J}from"../../../../../../base/common/buffer.js";import{$bf as X}from"../../../../../../base/common/event.js";import{$2B as Y}from"../../../../../../base/common/mime.js";import{$6g as Q,Schemas as h,$Ug as R,$Vg as Z}from"../../../../../../base/common/network.js";import{$4o as ee}from"../../../../../../base/common/objects.js";import*as te from"../../../../../../base/common/path.js";import{$m as ie,$r as oe}from"../../../../../../base/common/platform.js";import{$hh as g,$gh as se,$bh as re,$ih as ne}from"../../../../../../base/common/resources.js";import{URI as b}from"../../../../../../base/common/uri.js";import*as C from"../../../../../../base/common/uuid.js";import{$PD as G}from"../../../../../../editor/common/languages.js";import{$RD as ae}from"../../../../../../editor/common/languages/language.js";import{$kPb as de}from"../../../../../../editor/common/languages/supports/tokenization.js";import{$adb as ue}from"../../../../../../editor/common/languages/textToHtmlTokenizer.js";import*as v from"../../../../../../nls.js";import{$7H as le}from"../../../../../../platform/actions/common/actions.js";import{$Cl as ce}from"../../../../../../platform/configuration/common/configuration.js";import{$Tn as pe}from"../../../../../../platform/contextkey/common/contextkey.js";import{$Seb as he}from"../../../../../../platform/contextview/browser/contextView.js";import{$_o as fe}from"../../../../../../platform/dialogs/common/dialogs.js";import{$4j as be}from"../../../../../../platform/files/common/files.js";import{$v$ as me}from"../../../../../../platform/opener/common/opener.js";import{$Fo as ge}from"../../../../../../platform/storage/common/storage.js";import{$No as ke}from"../../../../../../platform/telemetry/common/telemetry.js";import{$uq as ve,$wq as we}from"../../../../../../platform/theme/common/colorRegistry.js";import{$Jt as ye,$Qt as Ie}from"../../../../../../platform/theme/common/themeService.js";import{$fl as P}from"../../../../../../platform/workspace/common/workspace.js";import{$zM as Ce}from"../../../../../../platform/workspace/common/workspaceTrust.js";import{CellEditState as Me}from"../../notebookBrowser.js";import{$mTb as Ee}from"../notebookCellList.js";import{$pTb as $e}from"./webviewPreloads.js";import{$qTb as Oe}from"./webviewThemeMapping.js";import{$MSb as M}from"../../viewModel/markupCellViewModel.js";import{CellUri as xe}from"../../../common/notebookCommon.js";import{$rTb as Re}from"../../../common/notebookLoggingService.js";import{$gyb as Pe}from"../../../common/notebookService.js";import{$wyb as Se,$yyb as We}from"../../../../webview/browser/webview.js";import{$tTb as Ne}from"../../../../webview/browser/webviewWindowDragMonitor.js";import{$xTb as Ge,$wTb as w}from"../../../../webview/common/webview.js";import{$bI as Be}from"../../../../../services/editor/common/editorGroupsService.js";import{$8W as Te}from"../../../../../services/environment/common/environmentService.js";import{$nX as Le}from"../../../../../services/path/common/pathService.js";var q=function(c,e,t,s){var r=arguments.length,i=r<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,e,t,s);else for(var n=c.length-1;n>=0;n--)(o=c[n])&&(i=(r<3?o(i):r>3?o(e,t,i):o(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i},l=function(c,e){return function(t,s){e(t,s,c)}},E;const Ue=/:([\d]+)(?::([\d]+))?$/,He=/line=(\d+)$/,De=/^(.*)#([^#]*)$/;let S=class extends Ie{static{E=this}static b(e){return this.a??=new We("notebook.backlayerWebview.origins",e),this.a}constructor(e,t,s,r,i,o,n,a,d,u,p,m,f,y,k,$,B,T,L,U,H,D,z,F,_){super(F),this.notebookEditor=e,this.F=t,this.notebookViewType=s,this.documentUri=r,this.G=i,this.H=o,this.I=n,this.J=a,this.L=d,this.M=u,this.N=p,this.O=m,this.P=f,this.Q=y,this.R=k,this.S=$,this.U=B,this.W=T,this.X=L,this.Y=U,this.Z=H,this.$=D,this.ab=z,this.bb=_,this.webview=void 0,this.insetMapping=new Map,this.pendingWebviewIdleCreationRequest=new Map,this.pendingWebviewIdleInsetMapping=new Map,this.c=new Map,this.markupPreviewMapping=new Map,this.f=new Set,this.g=new Map,this.j=void 0,this.m=this.B(new X),this.r=new Set,this.onMessage=this.m.event,this.s=!1,this.u=!0,this.D=C.$Pm(),this.cb("Creating backlayer webview for notebook"),this.element=document.createElement("div"),this.element.style.height="1400px",this.element.style.position="absolute",o&&(this.B(o),o.receiveMessageHandler=(O,I)=>!this.webview||this.s?Promise.resolve(!1):(this.Eb({__vscode_notebook_message:!0,type:"customRendererMessage",rendererId:O,message:I}),Promise.resolve(!0))),this.B($.onDidChangeTrust(O=>{const I=this.jb(this.lb(),void 0),j=this.gb(I.toString());this.webview?.setHtml(j)})),this.B(G.onDidChange(()=>{this.Eb({type:"tokenizedStylesChanged",css:N()})}))}updateOptions(e){this.G=e,this.db(),this.eb()}cb(e){this.ab.debug("BacklayerWebview",`${this.documentUri} (${this.F}) - ${e}`)}db(){this.Eb({type:"notebookStyles",styles:this.fb()})}eb(){this.Eb({type:"notebookOptions",options:{dragAndDropEnabled:this.G.dragAndDropEnabled},renderOptions:{lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError}})}fb(){return{"notebook-output-left-margin":`${this.G.leftMargin+this.G.runGutter}px`,"notebook-output-width":`calc(100% - ${this.G.leftMargin+this.G.rightMargin+this.G.runGutter}px)`,"notebook-output-node-padding":`${this.G.outputNodePadding}px`,"notebook-run-gutter":`${this.G.runGutter}px`,"notebook-preview-node-padding":`${this.G.previewNodePadding}px`,"notebook-markdown-left-margin":`${this.G.markdownLeftMargin}px`,"notebook-output-node-left-padding":`${this.G.outputNodeLeftPadding}px`,"notebook-markdown-min-height":`${this.G.previewNodePadding*2}px`,"notebook-markup-font-size":typeof this.G.markupFontSize=="number"&&this.G.markupFontSize>0?`${this.G.markupFontSize}px`:`calc(${this.G.fontSize}px * 1.2)`,"notebook-markdown-line-height":typeof this.G.markdownLineHeight=="number"&&this.G.markdownLineHeight>0?`${this.G.markdownLineHeight}px`:"normal","notebook-cell-output-font-size":`${this.G.outputFontSize||this.G.fontSize}px`,"notebook-cell-output-line-height":`${this.G.outputLineHeight}px`,"notebook-cell-output-max-height":`${this.G.outputLineHeight*this.G.outputLineLimit+2}px`,"notebook-cell-output-font-family":this.G.outputFontFamily||this.G.fontFamily,"notebook-cell-markup-empty-content":v.localize(9422,null),"notebook-cell-renderer-not-found-error":v.localize(9423,null),"notebook-cell-renderer-fallbacks-exhausted":v.localize(9424,null),"notebook-markup-font-family":this.G.markupFontFamily}}gb(e){const t=this.hb(),s=this.ib(),r={lineLimit:this.G.outputLineLimit,outputScrolling:this.G.outputScrolling,outputWordWrap:this.G.outputWordWrap,linkifyFilePaths:this.G.outputLinkifyFilePaths,minimalError:this.G.minimalError},i=$e({...this.G,tokenizationCss:N()},{dragAndDropEnabled:this.G.dragAndDropEnabled},r,t,s,this.S.isWorkspaceTrusted(),this.D),o=this.U.getValue("notebook.experimental.enableCsp"),n=this.z(ve),a=this.z(we);return`
		<html lang="en">
			<head>
				<meta charset="UTF-8">
				<base href="${e}/" />
