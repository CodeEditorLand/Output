...
const MOST_RECENT_REPL_EDITOR = new RawContextKey(
  "mostRecentReplEditor",
  void 0
);
...
const IS_COMPOSITE_NOTEBOOK = new RawContextKey(
  "isCompositeNotebook",
  false
);
...
const NOTEBOOK_CELL_OUTPUT_MIMETYPE = new RawContextKey(
  "notebookCellOutputMimeType",
  void 0
);
...
const KERNEL_HAS_VARIABLE_PROVIDER = new RawContextKey(
