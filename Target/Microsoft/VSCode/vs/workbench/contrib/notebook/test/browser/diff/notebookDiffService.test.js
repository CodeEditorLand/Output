import o from"assert";import{VSBuffer as a}from"../../../../../../base/common/buffer.js";import{Mimes as s}from"../../../../../../base/common/mime.js";import{ensureNoDisposablesAreLeakedInTestSuite as v}from"../../../../../../base/test/common/utils.js";import{CellKind as e}from"../../../common/notebookCommon.js";import{matchCellBasedOnSimilarties as y}from"../../../common/services/notebookCellMatching.js";import{NotebookWorker as w}from"../../../common/services/notebookWebWorker.js";import{URI as _}from"../../../../../../base/common/uri.js";import"../../../../../../base/common/diff/diff.js";suite("NotebookDiff Diff Service",()=>{v();let l;suiteSetup(()=>{l=new w}),suiteTeardown(()=>{l.dispose()}),test("No changes",async()=>{const{mapping:n,diff:t}=await i([[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]],[[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]]);o.deepStrictEqual(n,[{modified:0,original:0}]),o.deepStrictEqual(t.cellsDiff.changes.length,0)}),test("diff different source",async()=>{const{mapping:n,diff:t}=await i([[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]],[[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]]);o.deepStrictEqual(n,[{modified:0,original:0}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1}])}),test("diff different source (2 cells)",async()=>{const{mapping:n,diff:t}=await i([[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]],[[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["z"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:1,originalLength:1,modifiedStart:1,modifiedLength:1}])}),test("diff different source (first cell changed)",async()=>{const{mapping:n,diff:t}=await i([[["import sys"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]],[[["import pandas"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1}])}),test("diff test small source",async()=>{const{mapping:n,diff:t}=await i([[["123456789"],"javascript",e.Code,[],{}]],[[["987654321"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:0}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1}])}),test("diff test data single cell",async()=>{const{mapping:n,diff:t}=await i([[[`# This version has a bug
`,`def mult(a, b):
`,"    return a / b"],"javascript",e.Code,[],{}]],[[[`def mult(a, b):
`,`    'This version is debugged.'
`,"    return a * b"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:0}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1}])}),test("diff foo/foe (swapped cells)",async()=>{const{mapping:n,diff:t}=await i([[[`def foe(x, y):
`,`    return x + y
`,"foe(3, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([6]))}]}],{metadata:{collapsed:!1},executionOrder:5}],[[`def foo(x, y):
`,`    return x * y
`,"foo(1, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([2]))}]}],{metadata:{collapsed:!1},executionOrder:6}],[[""],"javascript",e.Code,[],{}]],[[[`def foo(x, y):
`,`    return x * y
`,"foo(1, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([2]))}]}],{metadata:{collapsed:!1},executionOrder:6}],[[`def foe(x, y):
`,`    return x + y
`,"foe(3, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([6]))}]}],{metadata:{collapsed:!1},executionOrder:5}],[[""],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:1},{modified:1,original:0},{modified:2,original:2}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:1},{originalStart:1,originalLength:1,modifiedStart:2,modifiedLength:0}])}),test("diff foo/foe (swapped cells with changes in output)",async()=>{const{mapping:n,diff:t}=await i([[[`def foe(x, y):
`,`    return x + y
`,"foe(3, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([6]))}]}],{metadata:{collapsed:!1},executionOrder:5}],[[`def foo(x, y):
`,`    return x * y
`,"foo(1, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([2]))}]}],{metadata:{collapsed:!1},executionOrder:6}],[[""],"javascript",e.Code,[],{}]],[[[`def foo(x, y):
`,`    return x * y
`,"foo(1, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([6]))}]}],{metadata:{collapsed:!1},executionOrder:5}],[[`def foe(x, y):
`,`    return x + y
`,"foe(3, 2)"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([2]))}]}],{metadata:{collapsed:!1},executionOrder:6}],[[""],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:1},{modified:1,original:0},{modified:2,original:2}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:1},{originalStart:0,originalLength:1,modifiedStart:1,modifiedLength:1},{originalStart:1,originalLength:1,modifiedStart:2,modifiedLength:0}])}),test("diff markdown",async()=>{const{mapping:n,diff:t}=await i([[["This is a test notebook with only markdown cells"],"markdown",e.Markup,[],{}],[["Lorem ipsum dolor sit amet"],"markdown",e.Markup,[],{}],[["In other news"],"markdown",e.Markup,[],{}]],[[["This is a test notebook with markdown cells only"],"markdown",e.Markup,[],{}],[["Lorem ipsum dolor sit amet"],"markdown",e.Markup,[],{}],[["In the news"],"markdown",e.Markup,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1},{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1}])}),test("diff insert 1 at the top",async()=>{const{mapping:n,diff:t}=await i([[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}]],[[["var h = 8;"],"javascript",e.Code,[],{}],[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:-1},{modified:1,original:0},{modified:2,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:1}])}),test("diff insert 1 at the top with lots of cells",async()=>{const{mapping:n,diff:t}=await i([[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]],[[["var h = 8;"],"javascript",e.Code,[],{}],[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:-1},{modified:1,original:0},{modified:2,original:1},{modified:3,original:2},{modified:4,original:3},{modified:5,original:4},{modified:6,original:5},{modified:7,original:6}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:1}])}),test("diff insert 3 at the top with lots of cells",async()=>{const{mapping:n,diff:t}=await i([[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]],[[["var h = 8;"],"javascript",e.Code,[],{}],[["var i = 8;"],"javascript",e.Code,[],{}],[["var j = 8;"],"javascript",e.Code,[],{}],[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:-1},{modified:1,original:-1},{modified:2,original:-1},{modified:3,original:0},{modified:4,original:1},{modified:5,original:2},{modified:6,original:3},{modified:7,original:4},{modified:8,original:5},{modified:9,original:6}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:3}])}),test("diff insert 1 in the middle",async()=>{const{mapping:n,diff:t}=await i([[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]],[[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var h = 8;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:-1},{modified:5,original:4},{modified:6,original:5},{modified:7,original:6}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:4,originalLength:0,modifiedStart:4,modifiedLength:1}])}),test("LCS (swap cells with outputs)",async()=>{const{mapping:n,diff:t}=await i([[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:1}],[["x"],"javascript",e.Code,[],{metadata:{collapsed:!1}}]],[[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[],{metadata:{collapsed:!1}}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:1}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1},{originalStart:3,originalLength:1,modifiedStart:3,modifiedLength:1}])}),test("LCS (outputs changed)",async()=>{const{mapping:n,diff:t}=await i([[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:1}],[["y"],"javascript",e.Code,[],{metadata:{collapsed:!1}}]],[[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[],{metadata:{collapsed:!0}}],[["y"],"javascript",e.Code,[],{metadata:{collapsed:!1}}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1}])}),test("Swap cells with output and with same code in each cell",async()=>{const{mapping:n,diff:t}=await i([[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:1}],[["x"],"javascript",e.Code,[],{metadata:{collapsed:!1}}],[["x = 5"],"javascript",e.Code,[],{}],[["x"],"javascript",e.Code,[],{}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([5]))}]}],{}]],[[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[],{metadata:{collapsed:!1}}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:1}],[["x = 5"],"javascript",e.Code,[],{}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([5]))}]}],{}],[["x"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1},{originalStart:3,originalLength:1,modifiedStart:3,modifiedLength:1},{originalStart:5,originalLength:1,modifiedStart:5,modifiedLength:1},{originalStart:6,originalLength:1,modifiedStart:6,modifiedLength:1}])}),test("Change outputs of cells",async()=>{const{mapping:n,diff:t}=await i([[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:1}],[["y"],"javascript",e.Code,[],{metadata:{collapsed:!1}}],[["x = 5"],"javascript",e.Code,[],{}],[["x"],"javascript",e.Code,[],{}],[["y"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([5]))}]}],{}]],[[["# Description"],"markdown",e.Markup,[],{metadata:{}}],[["x = 3"],"javascript",e.Code,[],{metadata:{collapsed:!0},executionOrder:1}],[["x"],"javascript",e.Code,[],{metadata:{collapsed:!1}}],[["y"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:1}],[["x = 5"],"javascript",e.Code,[],{}],[["x"],"javascript",e.Code,[{outputId:"someId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([5]))}]}],{}],[["y"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1},{originalStart:3,originalLength:1,modifiedStart:3,modifiedLength:1},{originalStart:5,originalLength:1,modifiedStart:5,modifiedLength:1},{originalStart:6,originalLength:1,modifiedStart:6,modifiedLength:1}])}),test("Insert a new cell",async()=>{const{mapping:n,diff:t}=await i([[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]],[[["var a = 1;"],"javascript",e.Code,[],{}],[["var b = 2;"],"javascript",e.Code,[],{}],[["var c = 3;"],"javascript",e.Code,[],{}],[["var d = 4;"],"javascript",e.Code,[],{}],[["var h = 8;"],"javascript",e.Code,[],{}],[["var e = 5;"],"javascript",e.Code,[],{}],[["var f = 6;"],"javascript",e.Code,[],{}],[["var g = 7;"],"javascript",e.Code,[],{}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:-1},{modified:5,original:4},{modified:6,original:5},{modified:7,original:6}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:4,originalLength:0,modifiedStart:4,modifiedLength:1}])}),test("diff output",async()=>{const{mapping:n,diff:t}=await i([[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([4]))}]}],{metadata:{collapsed:!1},executionOrder:3}]],[[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([5]))}]}],{metadata:{collapsed:!1},executionOrder:3}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:1,originalLength:1,modifiedStart:1,modifiedLength:1}])}),test("diff output fast check",async()=>{const{mapping:n,diff:t}=await i([[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([4]))}]}],{metadata:{collapsed:!1},executionOrder:3}]],[[["x"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([3]))}]}],{metadata:{collapsed:!1},executionOrder:3}],[["y"],"javascript",e.Code,[{outputId:"someOtherId",outputs:[{mime:s.text,data:a.wrap(new Uint8Array([5]))}]}],{metadata:{collapsed:!1},executionOrder:3}]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:1,originalLength:1,modifiedStart:1,modifiedLength:1}])}),test("No cells",async()=>{const{mapping:n,diff:t}=await i([],[]);o.deepStrictEqual(n,[]),o.deepStrictEqual(t.cellsDiff.changes,[])}),test("No cells and add 1 cell",async()=>{const{mapping:n,diff:t}=await i([],[[['print("Hello world")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:-1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:1}])}),test("One cells and delete 1 cell",async()=>{const{mapping:n,diff:t}=await i([[['print("Hello world")'],"python",e.Code,[],void 0]],[]);o.deepStrictEqual(n,[]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:0}])}),test("No changes with 1 cell",async()=>{const{mapping:n,diff:t}=await i([[['print("Hello world")'],"python",e.Code,[],void 0]],[[['print("Hello world")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0}]),o.deepStrictEqual(t.cellsDiff.changes,[])}),test("One changes with 1 cell",async()=>{const{mapping:n,diff:t}=await i([[['print("Hello world")'],"python",e.Code,[],void 0]],[[['print("Foo Bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1}])}),test("No changes with 2 cells",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[])}),test("One changes with 2 cells, 1st cell changed",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0]],[[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1}])}),test("2 cells, 1st cell deleted",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0]],[[['print("Hello world")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:0}])}),test("2 cells, inserted a cell in the middle",async()=>{const{mapping:n,diff:t}=await i([[['print("Hello world")'],"python",e.Code,[],void 0],[['print("Foo Bar")'],"python",e.Code,[],void 0]],[[['print("Hello world")'],"python",e.Code,[],void 0],[['print("Bar Baz")'],"python",e.Code,[],void 0],[['print("Foo Bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:-1},{modified:2,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:1,originalLength:0,modifiedStart:1,modifiedLength:1}])}),test("One changes with 2 cells, 2nd cell changed",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Foo Bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:1,originalLength:1,modifiedStart:1,modifiedLength:1}])}),test("Two cells, all cells changed",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0]],[[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("Foo Bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:2,modifiedStart:0,modifiedLength:2}])}),test("Insert a md cell and modify the next code cell (few cells)",async()=>{const{mapping:n,diff:t}=await i([[['print("Hello world")'],"python",e.Code,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]],[[["# Description"],"markdown",e.Markup,[],void 0],[['print("Hello worldz")'],"python",e.Code,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:-1},{modified:1,original:0},{modified:2,original:1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:1},{originalStart:0,originalLength:1,modifiedStart:1,modifiedLength:1}])}),test("Insert a md cell and modify the next code cell",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[['print("bar baz1234")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[["# New Markdown cell"],"markdown",e.Markup,[],void 0],[['print("foo baz")'],"python",e.Code,[],void 0],[['print("bar baz1234")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:-1},{modified:4,original:3},{modified:5,original:4}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:3,originalLength:0,modifiedStart:3,modifiedLength:1},{originalStart:3,originalLength:1,modifiedStart:4,modifiedLength:1}])}),test("Delete code cell and insert MD cell, both will not match",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[["import sys"],"python",e.Code,[],void 0],[["sys.executable"],"python",e.Code,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[["import sys"],"python",e.Code,[],void 0],[["# Header"],"python",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:-1},{modified:3,original:3},{modified:4,original:4}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1}])}),test("Delete MD cell and insert code cell, both will not match",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[["import sys"],"python",e.Code,[],void 0],[["sys.executable"],"python",e.Code,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[["import sys"],"python",e.Code,[],void 0],[["# Header"],"python",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:-1},{modified:3,original:3},{modified:4,original:4}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1}])}),test("Insert a md cell and modify the next 2 code cells",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("Foo Bar")'],"python",e.Code,[],void 0],[['print("bar baz")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[["# New Markdown cell"],"markdown",e.Markup,[],void 0],[['print("Foo BaZ")'],"python",e.Code,[],void 0],[['print("bar baz Modified")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:-1},{modified:4,original:3},{modified:5,original:4}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:3,originalLength:0,modifiedStart:3,modifiedLength:1},{originalStart:3,originalLength:1,modifiedStart:4,modifiedLength:1},{originalStart:4,originalLength:1,modifiedStart:5,modifiedLength:1}])}),test("Insert a md cell, delete a cell and modify the next 2 code cells",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("Foo Bar")'],"python",e.Code,[],void 0],[['print("bar baz")'],"python",e.Code,[],void 0],[['print("Fox Trot")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[["# New Markdown cell"],"markdown",e.Markup,[],void 0],[['print("bar baz Modified")'],"python",e.Code,[],void 0],[['print("Fox Trots")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:-1},{modified:4,original:4},{modified:5,original:5}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:3,originalLength:1,modifiedStart:3,modifiedLength:1},{originalStart:4,originalLength:1,modifiedStart:4,modifiedLength:1},{originalStart:5,originalLength:1,modifiedStart:5,modifiedLength:1}])}),test("Insert a md cell, delete a code cell and modify the next 2 code cells (deleted and inserted lineup)",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["import sys"],"python",e.Code,[],void 0],[['print("Foo Bar")'],"python",e.Code,[],void 0],[['print("bar baz")'],"python",e.Code,[],void 0],[['print("Fox Trot")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["import sys"],"python",e.Code,[],void 0],[["sys.executable"],"python",e.Code,[],void 0],[['print("bar baz Modified")'],"python",e.Code,[],void 0],[['print("Fox Trot")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:3,originalLength:1,modifiedStart:3,modifiedLength:1},{originalStart:4,originalLength:1,modifiedStart:4,modifiedLength:1}])}),test("Insert a few md cells and modify the next few code cells",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Yet another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# New 1"],"markdown",e.Markup,[],void 0],[["# New 2"],"markdown",e.Markup,[],void 0],[["# Another MD cell (modified1)"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Another MD cell (modified)"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:-1},{modified:5,original:-1},{modified:6,original:4},{modified:7,original:5},{modified:8,original:6},{modified:9,original:7}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:4,originalLength:0,modifiedStart:4,modifiedLength:2},{originalStart:4,originalLength:1,modifiedStart:6,modifiedLength:1},{originalStart:6,originalLength:1,modifiedStart:8,modifiedLength:1}])}),test("Insert & delete a few md cells and modify the next few code cells",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Yet another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# New 1"],"markdown",e.Markup,[],void 0],[["# New 2"],"markdown",e.Markup,[],void 0],[["# Another MD cell (modified1)"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Another MD cell (modified)"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:-1},{modified:5,original:-1},{modified:6,original:4},{modified:7,original:5},{modified:8,original:6},{modified:9,original:7}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:4,originalLength:0,modifiedStart:4,modifiedLength:2},{originalStart:4,originalLength:1,modifiedStart:6,modifiedLength:1},{originalStart:6,originalLength:1,modifiedStart:8,modifiedLength:1}])}),test("Modify, then insert ",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Yet another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo BaZ"],"markdown",e.Markup,[],void 0],[["# Header"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Yet another MD cell"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:-1},{modified:4,original:3},{modified:5,original:4},{modified:6,original:5},{modified:7,original:6},{modified:8,original:7}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1},{originalStart:3,originalLength:0,modifiedStart:3,modifiedLength:1}])}),test("Modify, then delete ",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo Bar"],"markdown",e.Markup,[],void 0],[['print("foo bar")'],"python",e.Code,[],void 0],[["# Another MD cell"],"markdown",e.Markup,[],void 0],[["import sys"],"python",e.Code,[],void 0],[["# Yet another MD cell"],"markdown",e.Markup,[],void 0],[["sys.executable"],"python",e.Code,[],void 0]],[[["# Hello World"],"markdown",e.Markup,[],void 0],[['print("Hello world")'],"python",e.Code,[],void 0],[["# Foo BaZ"],"markdown",e.Markup,[],void 0],[["# Another MD cell"],"markdown",e.Markup,[],void 0],[["import sys"],"python",e.Code,[],void 0],[["# Yet another MD cell"],"markdown",e.Markup,[],void 0],[["sys.executable"],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:4},{modified:4,original:5},{modified:5,original:6},{modified:6,original:7}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1},{originalStart:3,originalLength:1,modifiedStart:3,modifiedLength:0}])}),test("Update code cell",async()=>{const{mapping:n,diff:t}=await i([[[`# This is a simple notebook
`,`
`,"There's nothing special here, I am just writing some text and plotting a function"],"markdown",e.Markup,[],void 0],[[`import numpy as np
`,`import matplotlib.pyplot as plt
`,`import pandas as pd
`,`
`,"%matplotlib inline"],"python",e.Code,[],void 0],[[`x = np.linspace(0, 4*np.pi,50)
`,`y = np.sin(x)
`,`
`,"plt.plot(x, y)"],"python",e.Code,[],void 0],[[`df = pd.DataFrame({f"column_{c}": np.random.normal(size=100) for c in range(100)})
`,"df"],"python",e.Code,[],void 0],[["You could actually do some neat stuff with it, pandas like changing the colors (values above 1 should be green)"],"python",e.Markup,[],void 0],[['df.style.applymap(lambda x: "background-color: green" if x>1 else "background-color: white")'],"python",e.Code,[],void 0],[[],"python",e.Code,[],void 0]],[[[`# This is a simple notebook
`,`
`,"There's nothing special here, I am just writing some text and plotting a function"],"markdown",e.Markup,[],void 0],[[`import numpy as np
`,`import matplotlib.pyplot as plt
`,`import pandas as pd
...
`,`
`,"plt.plot(x, y)"],"python",e.Code,[],void 0],[[`df = pd.DataFrame({f"column_{c}": np.random.normal(size=100) for c in range(100)})
`,"df"],"python",e.Code,[],void 0],[["You could actually do some neat stuff with it, pandas like changing the colors (values above 1 should be green)"],"python",e.Markup,[],void 0],[['df.style.applymap(lambda x: "background-color: green" if x>1 else "background-color: white")'],"python",e.Code,[],void 0],[[],"python",e.Code,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1}])}),test("Update code cell 1",async()=>{const{mapping:n,diff:t}=await i([[["# Hello World"],"markdown",e.Markup,[],void 0],[[`import os
`,`from pprint import pprint 
`,`from sklearn.preprocessing import LabelEncoder
`,`import ast
`,`import pandas as pd
`,`from clipper import clipper
`,"import ffmpeg"],"python",e.Code,[],void 0],[[`data_dir = '../../../app/data/'
`,`output_dir = 'output/'
`,`video_dir = 'videos/'
`,`
...
`,"df.head()"],"python",e.Code,[],void 0],[[`# convert the string representation of results to a list
`,`df['list_categories'] = df['categories'].apply(ast.literal_eval)
`,`
`,`# get most likely label from each list
`,"df['label'] = df['list_categories'].apply(lambda x: x[0] if x else None)"],"python",e.Code,[],void 0],[[`# initialize the LabelEncoder
`,`label_encoder = LabelEncoder()
`,`
`,`# fit and transform the label to a numerical value
`,`numerical_data = label_encoder.fit_transform(df['label'])
`,`
`,"df['label_value'] = numerical_data"],"python",e.Markup,[],void 0]],[[["# Updated markdown cell"],"markdown",e.Markup,[],void 0],[[`from sklearn.preprocessing import LabelEncoder
`,`import ast
`,`import pandas as pd
`,`from clipper import clipper
`,"import ffmpeg"],"python",e.Code,[],void 0],[[`data_dir = '../../../app/data/'
...
`,`numerical_data = label_encoder.fit_transform(df['label'])
`,`
`,"df['label_value'] = numerical_data"],"python",e.Markup,[],void 0]]);o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:1,modifiedStart:0,modifiedLength:1},{originalStart:1,originalLength:1,modifiedStart:1,modifiedLength:1}])}),test("Detect modification and insertion of cells",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"markdown",source:[`# Live 3D Human Pose Estimation with OpenVINO
`,`
...
`,`
`,"run_pose_estimation(source=source, flip=isinstance(source, int), use_popup=False)"]}].map(r),[{cell_type:"markdown",source:[`# Live 3D Human Pose Estimation with OpenVINO
`,`
`,`This notebook demonstrates live 3D Human Pose Estimation with OpenVINO via a webcam. We utilize the model [human-pose-estimation-3d-0001](https://github.com/openvinotoolkit/open_model_zoo/tree/master/models/public/human-pose-estimation-3d-0001) from [Open Model Zoo](https://github.com/openvinotoolkit/open_model_zoo/). At the end of this notebook, you will see live inference results from your webcam (if available). Alternatively, you can also upload a video file to test out the algorithms.
`,"**Make sure you have properly installed the [Jupyter extension](https://github.com/jupyter-widgets/pythreejs#jupyterlab) and been using JupyterLab to run the demo as suggested in the `README.md`**\n",`
`,"> **NOTE**: _To use a webcam, you must run this Jupyter notebook on a computer with a webcam. If you run on a remote server, the webcam will not work. However, you can still do inference on a video file in the final step. This demo utilizes the Python interface in `Three.js` integrated with WebGL to process data from the model inference. These results are processed and displayed in the notebook._\n",`
...
`,`source = cam_id if USE_WEBCAM else video_path
`,`
`,"run_pose_estimation(source=source, flip=isinstance(source, int), use_popup=False)"]}].map(r));o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6},{modified:7,original:7},{modified:8,original:8},{modified:9,original:9},{modified:10,original:10},{modified:11,original:11},{modified:12,original:12},{modified:13,original:15},{modified:14,original:16},{modified:15,original:17},{modified:16,original:18},{modified:17,original:19},{modified:18,original:20},{modified:19,original:21},{modified:20,original:22},{modified:21,original:23}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:2,originalLength:1,modifiedStart:2,modifiedLength:1},{originalStart:5,originalLength:1,modifiedStart:5,modifiedLength:1},{modifiedLength:1,modifiedStart:6,originalLength:1,originalStart:6},{modifiedLength:1,modifiedStart:7,originalLength:1,originalStart:7},{modifiedLength:1,modifiedStart:8,originalLength:1,originalStart:8},{modifiedLength:1,modifiedStart:12,originalLength:1,originalStart:12},{modifiedLength:0,modifiedStart:13,originalLength:2,originalStart:13},{modifiedLength:1,modifiedStart:14,originalLength:1,originalStart:16}])}),test("Detect modification in 2 cells",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"markdown",source:[`# Live 3D Human Pose Estimation with OpenVINO
`,`
`,`This notebook demonstrates live 3D Human Pose Estimation with OpenVINO via a webcam. We utilize the model [human-pose-estimation-3d-0001](https://github.com/openvinotoolkit/open_model_zoo/tree/master/models/public/human-pose-estimation-3d-0001) from [Open Model Zoo](https://github.com/openvinotoolkit/open_model_zoo/). At the end of this notebook, you will see live inference results from your webcam (if available). Alternatively, you can also upload a video file to test out the algorithms.
`,"**Make sure you have properly installed the [Jupyter extension](https://github.com/jupyter-widgets/pythreejs#jupyterlab) and been using JupyterLab to run the demo as suggested in the `README.md`**\n",`
`,"> **NOTE**: _To use a webcam, you must run this Jupyter notebook on a computer with a webcam. If you run on a remote server, the webcam will not work. However, you can still do inference on a video file in the final step. This demo utilizes the Python interface in `Three.js` integrated with WebGL to process data from the model inference. These results are processed and displayed in the notebook._\n",`
...
`,`source = cam_id if USE_WEBCAM else video_path
`,`
`,"run_pose_estimation(source=source, flip=isinstance(source, int), use_popup=False)"]}].map(r));o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6},{modified:7,original:7},{modified:8,original:8},{modified:9,original:9},{modified:10,original:10},{modified:11,original:11},{modified:12,original:12},{modified:13,original:13},{modified:14,original:14},{modified:15,original:15},{modified:16,original:16},{modified:17,original:17},{modified:18,original:18},{modified:19,original:19},{modified:20,original:20},{modified:21,original:21},{modified:22,original:22},{modified:23,original:23}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:1,originalLength:1,modifiedStart:1,modifiedLength:1},{originalStart:4,originalLength:1,modifiedStart:4,modifiedLength:1},{originalStart:20,originalLength:1,modifiedStart:20,modifiedLength:1}])}),test("Detect modification in multiple cells",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"markdown",source:[`# Live 3D Human Pose Estimation with OpenVINO
`,`
`,`This notebook demonstrates live 3D Human Pose Estimation with OpenVINO via a webcam. We utilize the model [human-pose-estimation-3d-0001](https://github.com/openvinotoolkit/open_model_zoo/tree/master/models/public/human-pose-estimation-3d-0001) from [Open Model Zoo](https://github.com/openvinotoolkit/open_model_zoo/). At the end of this notebook, you will see live inference results from your webcam (if available). Alternatively, you can also upload a video file to test out the algorithms.
`,"**Make sure you have properly installed the [Jupyter extension](https://github.com/jupyter-widgets/pythreejs#jupyterlab) and been using JupyterLab to run the demo as suggested in the `README.md`**\n",`
`,"> **NOTE**: _To use a webcam, you must run this Jupyter notebook on a computer with a webcam. If you run on a remote server, the webcam will not work. However, you can still do inference on a video file in the final step. This demo utilizes the Python interface in `Three.js` integrated with WebGL to process data from the model inference. These results are processed and displayed in the notebook._\n",`
...
`,`source = cam_id if USE_WEBCAM else video_path
`,`
`,"run_pose_estimation(source=source, flip=isinstance(source, int), use_popup=False)"]}].map(r));o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6},{modified:7,original:7},{modified:8,original:8},{modified:9,original:9},{modified:10,original:10},{modified:11,original:11},{modified:12,original:12},{modified:13,original:13},{modified:14,original:14},{modified:15,original:15},{modified:16,original:16},{modified:17,original:17},{modified:18,original:18},{modified:19,original:19},{modified:20,original:20},{modified:21,original:21},{modified:22,original:22},{modified:23,original:23}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:4,originalLength:1,modifiedStart:4,modifiedLength:1},{originalStart:10,originalLength:1,modifiedStart:10,modifiedLength:1},{originalStart:16,originalLength:1,modifiedStart:16,modifiedLength:1},{originalStart:18,originalLength:1,modifiedStart:18,modifiedLength:1},{originalStart:20,originalLength:1,modifiedStart:20,modifiedLength:1}])}),test("Modification with Insertion, detected as deletion of a cell",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"markdown",source:[`# Video generation with ZeroScope and OpenVINO
`,`
`,`#### Table of contents:
`,`
...
`,`
`,"We will use the first one."]},{cell_type:"markdown",source:[`<div class="alert alert-block alert-warning">
...
`,"</div>"]},{cell_type:"markdown",source:[`## Install and import required packages
`,`[back to top \u2B06\uFE0F](#Table-of-contents:)
...
`,`IPython.display.HTML(f'<img src="{b64}" />')`]},{cell_type:"markdown",source:[`## Interactive demo
`,`[back to top \u2B06\uFE0F](#Table-of-contents:)
...
`,"# Read more in the docs: https://gradio.app/docs/"]}].map(r),[{cell_type:"markdown",source:[`# Video generation with ZeroScope and OpenVINO
`,`
`,`#### Table of contents:
`,`
`,`- [Install and import required packages](#Install-and-import-required-packages)
...
`,`# if you are launching remotely, specify server_name and server_port
`,`# demo.launch(server_name='your server name', server_port='server port in int')
`,"# Read more in the docs: https://gradio.app/docs/"]}].map(r));o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6},{modified:7,original:7},{modified:8,original:8},{modified:9,original:9},{modified:10,original:10},{modified:11,original:11},{modified:12,original:12},{modified:13,original:13},{modified:14,original:14},{modified:15,original:15},{modified:16,original:16},{modified:17,original:17},{modified:18,original:18},{modified:19,original:19},{modified:20,original:20},{modified:21,original:21},{modified:22,original:22},{modified:23,original:23},{modified:24,original:24},{modified:25,original:25},{modified:26,original:26},{modified:27,original:27},{modified:28,original:28},{modified:29,original:29},{modified:30,original:30},{modified:31,original:31},{modified:32,original:32},{modified:33,original:33},{modified:34,original:34},{modified:35,original:35},{modified:36,original:36},{modified:37,original:37},{modified:38,original:38},{modified:39,original:39},{modified:40,original:40},{modified:41,original:41},{modified:42,original:42},{modified:43,original:43},{modified:44,original:44},{modified:45,original:45},{modified:46,original:46},{modified:47,original:47},{modified:48,original:48},{modified:49,original:49}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:6,originalLength:1,modifiedStart:6,modifiedLength:1},{originalStart:15,originalLength:1,modifiedStart:15,modifiedLength:1},{originalStart:36,originalLength:1,modifiedStart:36,modifiedLength:1}])}),test("Modification of multiple cells",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"markdown",id:"a2e7d62b-5779-4211-822c-457c77321f8b",source:[`# Convert and Optimize YOLOv11 instance segmentation model with OpenVINO\u2122
`,`
...
`,`[back to top \u2B06\uFE0F](#Table-of-contents:)
`,`
`,"Use a webcam as the video input. By default, the primary webcam is set with\xA0`source=0`. If you have multiple webcams, each one will be assigned a consecutive number starting at 0. Set\xA0`flip=True`\xA0when using a front-facing camera. Some web browsers, especially Mozilla Firefox, may cause flickering. If you experience flickering, set\xA0`use_popup=True`.\n",`
...
`,`    model=seg_ov_model,
`,`    device=device.value,
`,")"]}].map(r),[{attachments:{},cell_type:"markdown",id:"a2e7d62b-5779-4211-822c-457c77321f8b",metadata:{},source:[`# Convert and Optimize YOLOv11 instance segmentation model with OpenVINO\u2122
`,`
`,`Instance segmentation goes a step further than object detection and involves identifying individual objects in an image and segmenting them from the rest of the image. Instance segmentation as an object detection are often used as key components in computer vision systems. 
`,`Applications that use real-time instance segmentation models include video analytics, robotics, autonomous vehicles, multi-object tracking and object counting, medical image analysis, and many others.
`,`
...
`,`    device=device.value,
`,`    video_width=1280,
`,")"]}].map(r));o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6},{modified:7,original:7},{modified:8,original:8},{modified:9,original:9},{modified:10,original:10},{modified:11,original:11},{modified:12,original:12},{modified:13,original:13},{modified:14,original:14},{modified:15,original:15},{modified:16,original:16},{modified:17,original:17},{modified:18,original:18},{modified:19,original:19},{modified:20,original:20},{modified:21,original:21},{modified:22,original:22},{modified:23,original:23},{modified:24,original:24},{modified:25,original:25},{modified:26,original:26},{modified:27,original:27},{modified:28,original:28},{modified:29,original:29},{modified:30,original:30},{modified:31,original:31},{modified:32,original:32},{modified:33,original:33},{modified:34,original:34},{modified:35,original:35},{modified:36,original:36},{modified:37,original:37},{modified:38,original:38},{modified:39,original:39},{modified:40,original:40},{modified:41,original:41},{modified:42,original:42},{modified:43,original:43},{modified:44,original:44},{modified:45,original:45},{modified:46,original:46}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:5,originalLength:1,modifiedStart:5,modifiedLength:1},{originalStart:6,originalLength:1,modifiedStart:6,modifiedLength:1},{originalStart:25,originalLength:1,modifiedStart:25,modifiedLength:1},{originalStart:42,originalLength:1,modifiedStart:42,modifiedLength:1},{originalStart:44,originalLength:1,modifiedStart:44,modifiedLength:1},{originalStart:46,originalLength:1,modifiedStart:46,modifiedLength:1}])}),test("Modification of a large cell and insert a new cell",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"markdown",id:"e9d010ff-85ba-4e69-b439-ba89e4a3a715",source:[`# Convert and Optimize YOLOv10 with OpenVINO
`,`
...
`,`except Exception:
`,"    demo.launch(debug=True, share=True)"]}].map(r),[{cell_type:"markdown",id:"e9d010ff-85ba-4e69-b439-ba89e4a3a715",source:[`# Convert and Optimize YOLOv10 with OpenVINO
`,`
`,`Real-time object detection aims to accurately predict object categories and positions in images with low latency. The YOLO series has been at the forefront of this research due to its balance between performance and efficiency. However, reliance on NMS and architectural inefficiencies have hindered optimal performance. YOLOv10 addresses these issues by introducing consistent dual assignments for NMS-free training and a holistic efficiency-accuracy driven model design strategy.
`,`
`,`YOLOv10, built on the [Ultralytics Python package](https://pypi.org/project/ultralytics/) by researchers at [Tsinghua University](https://www.tsinghua.edu.cn/en/), introduces a new approach to real-time object detection, addressing both the post-processing and model architecture deficiencies found in previous YOLO versions. By eliminating non-maximum suppression (NMS) and optimizing various model components, YOLOv10 achieves state-of-the-art performance with significantly reduced computational overhead. Extensive experiments demonstrate its superior accuracy-latency trade-offs across multiple model scales.
...
`,"# demo.close()"]}].map(r));o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6},{modified:7,original:7},{modified:8,original:8},{modified:9,original:9},{modified:10,original:10},{modified:11,original:11},{modified:12,original:12},{modified:13,original:13},{modified:14,original:14},{modified:15,original:15},{modified:16,original:16},{modified:17,original:17},{modified:18,original:18},{modified:19,original:19},{modified:20,original:20},{modified:21,original:21},{modified:22,original:22},{modified:23,original:23},{modified:24,original:24},{modified:25,original:25},{modified:26,original:26},{modified:27,original:27},{modified:28,original:28},{modified:29,original:29},{modified:30,original:30},{modified:31,original:31},{modified:32,original:32},{modified:33,original:33},{modified:34,original:34},{modified:35,original:35},{modified:36,original:36},{modified:37,original:37},{modified:38,original:38},{modified:39,original:39},{modified:40,original:40},{modified:41,original:41},{modified:42,original:42},{modified:43,original:43},{modified:44,original:44},{modified:45,original:45},{modified:46,original:46},{modified:47,original:47},{modified:48,original:48},{modified:49,original:49},{modified:50,original:50},{modified:51,original:51},{modified:52,original:52},{modified:53,original:-1},{modified:54,original:-1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:52,originalLength:1,modifiedStart:52,modifiedLength:1},{originalStart:53,originalLength:0,modifiedStart:53,modifiedLength:2}])}),test("Misalignment due to 2 deleted cells",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"markdown",metadata:{id:"F0Wut2G5kz2Z"},source:[`[![Roboflow Notebooks](https://ik.imagekit.io/roboflow/notebooks/template/bannertest2-2.png?ik-sdk-version=javascript-1.4.3&updatedAt=1672932710194)](https://github.com/roboflow/notebooks)
`,`
...
`,`
`,"## \u{1F525} Let's begin!"]},{cell_type:"markdown",metadata:{id:"W4u6KjiVdNZM"},source:[`## Before you start
`,`
...
`,'    return "data:image/jpg;base64,"+encoded']},{cell_type:"markdown",metadata:{id:"xrxd-Ug9MSWG"},source:["**NOTE:** Execute cell below and use your mouse to draw bounding box on the image \u{1F447}"]},{cell_type:"code",execution_count:null,metadata:{colab:{base_uri:"https://localhost:8080/",height:1e3,referenced_widgets:["a747e095e21448f29d8697fb6b1a7a74","6401ca8c2f574ba5ab62f0f06b9e0d06"]},id:"nLA7xmDIMTfx",outputId:"06b51195-d54f-44ed-9236-258e94d624c5"},outputs:[],source:[`IS_COLAB = True
`,`
`,`if IS_COLAB:
...
`,`annotated_image=annotate_image(image_path=IMAGE_PATH, masks=masks)
`,"sv.plot_image(image=annotated_image, size=(8, 8))"]},{cell_type:"markdown",metadata:{id:"gP9gEw9Tp8GJ"},source:[`## \u{1F3C6} Congratulations
`,`
`,`### Learning Resources
`,`
...
`,`        image_bytes = f.read()
`,`    encoded = str(base64.b64encode(image_bytes), 'utf-8')
`,'    return "data:image/jpg;base64,"+encoded']},{cell_type:"markdown",metadata:{id:"xrxd-Ug9MSWG"},source:["**NOTE:** Execute cell below and use your mouse to draw bounding box on the image \u{1F447}"]},{cell_type:"code",metadata:{colab:{base_uri:"https://localhost:8080/",height:1e3,referenced_widgets:["a747e095e21448f29d8697fb6b1a7a74","6401ca8c2f574ba5ab62f0f06b9e0d06"]},id:"nLA7xmDIMTfx",outputId:"06b51195-d54f-44ed-9236-258e94d624c5"},source:[`IS_COLAB = True
`,`
`,`if IS_COLAB:
`,`    from google.colab import output
`,`    output.enable_custom_widget_manager()
...
`,`### Connect computer vision to your project logic
`,`
`,"[Roboflow Templates](https://roboflow.com/templates) is a public gallery of code snippets that you can use to connect computer vision to your project logic. Code snippets range from sending emails after inference to measuring object distance between detections."]}].map(r));o.deepStrictEqual(n,[{modified:0,original:0},{modified:1,original:1},{modified:2,original:2},{modified:3,original:3},{modified:4,original:4},{modified:5,original:5},{modified:6,original:6},{modified:7,original:7},{modified:8,original:8},{modified:9,original:9},{modified:10,original:10},{modified:11,original:11},{modified:12,original:12},{modified:13,original:13},{modified:14,original:14},{modified:15,original:15},{modified:16,original:16},{modified:17,original:17},{modified:18,original:19},{modified:19,original:20},{modified:20,original:22},{modified:21,original:23},{modified:22,original:24},{modified:23,original:25},{modified:24,original:26},{modified:25,original:27},{modified:26,original:28},{modified:27,original:29},{modified:28,original:30},{modified:29,original:31},{modified:30,original:32},{modified:31,original:33},{modified:32,original:34},{modified:33,original:35},{modified:34,original:36},{modified:35,original:37},{modified:36,original:38},{modified:37,original:39},{modified:38,original:40},{modified:39,original:41},{modified:40,original:42},{modified:41,original:43},{modified:42,original:44},{modified:43,original:45},{modified:44,original:46},{modified:45,original:47},{modified:46,original:48},{modified:47,original:49},{modified:48,original:50},{modified:49,original:51},{modified:50,original:52},{modified:51,original:53},{modified:52,original:54},{modified:53,original:55},{modified:54,original:56},{modified:55,original:57},{modified:56,original:58},{modified:57,original:59},{modified:58,original:60},{modified:59,original:61},{modified:60,original:62},{modified:61,original:63},{modified:62,original:64},{modified:63,original:65},{modified:64,original:66},{modified:65,original:67},{modified:66,original:68},{modified:67,original:69}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:12,originalLength:1,modifiedStart:12,modifiedLength:1},{originalStart:15,originalLength:1,modifiedStart:15,modifiedLength:1},{originalStart:18,originalLength:1,modifiedStart:18,modifiedLength:0},{originalStart:20,originalLength:1,modifiedStart:19,modifiedLength:1},{originalStart:21,originalLength:1,modifiedStart:20,modifiedLength:0},{originalStart:22,originalLength:1,modifiedStart:20,modifiedLength:1},{originalStart:23,originalLength:1,modifiedStart:21,modifiedLength:1},{originalStart:26,originalLength:1,modifiedStart:24,modifiedLength:1},{originalStart:37,originalLength:1,modifiedStart:35,modifiedLength:1},{originalStart:44,originalLength:1,modifiedStart:42,modifiedLength:1},{originalStart:48,originalLength:1,modifiedStart:46,modifiedLength:1},{originalStart:56,originalLength:1,modifiedStart:54,modifiedLength:1},{originalStart:58,originalLength:1,modifiedStart:56,modifiedLength:1},{originalStart:60,originalLength:1,modifiedStart:58,modifiedLength:1},{originalStart:63,originalLength:1,modifiedStart:61,modifiedLength:1},{originalStart:68,originalLength:1,modifiedStart:66,modifiedLength:1}])}),test("Insert a few cells (one on top), modify a few and completely misaligned",async()=>{const{mapping:n,diff:t}=await i([{cell_type:"code",execution_count:null,metadata:{},outputs:[],source:[`import requests
`,`import pandas as pd
`,`import matplotlib.pyplot as plt
...
`,`    ))
`]},{cell_type:"code",execution_count:null,metadata:{},outputs:[],source:[`for REPO in REPOS:
`,'    plot_repo_metrics(f"{OWNER}/{REPO}")']}].map(r),[{cell_type:"markdown",metadata:{},source:["# Fetch Data"]},{cell_type:"code",execution_count:null,metadata:{},outputs:[],source:[`import requests
`,`import sys
`,`import pandas as pd
`,`import matplotlib.pyplot as plt
`,`from cachetools import cached, TTLCache
...
`,'    plot_repo_metrics(f"{OWNER}/{REPO}")']},{cell_type:"code",execution_count:null,metadata:{},outputs:[],source:['plot_repo_metrics(f"{OWNER}/vscode")']}].map(r));o.deepStrictEqual(n,[{modified:0,original:-1},{modified:1,original:0},{modified:2,original:1},{modified:3,original:2},{modified:4,original:3},{modified:5,original:4},{modified:6,original:5},{modified:7,original:6},{modified:8,original:-1},{modified:9,original:7},{modified:10,original:-1}]),o.deepStrictEqual(t.cellsDiff.changes,[{originalStart:0,originalLength:0,modifiedStart:0,modifiedLength:1},{originalStart:0,originalLength:1,modifiedStart:1,modifiedLength:1},{originalStart:1,originalLength:1,modifiedStart:2,modifiedLength:1},{originalStart:7,originalLength:0,modifiedStart:8,modifiedLength:1},{originalStart:8,originalLength:0,modifiedStart:10,modifiedLength:1}])});let h=0;async function i(n,t){const p=y(t.map(g),n.map(g)).map(d=>({modified:d.modified,original:d.original})),c=_.parse(`file://original${h++}.ipynb`),m=_.parse(`file://modified${h++}.ipynb`);l.$acceptNewModel(c.toString(),{},{},n.map((d,f)=>b(c,d,f))),l.$acceptNewModel(m.toString(),{},{},t.map((d,f)=>b(m,d,f)));const u=await l.$computeDiff(c.toString(),m.toString());return u.cellsDiff.changes=u.cellsDiff.changes.map(d=>({originalStart:d.originalStart,originalLength:d.originalLength,modifiedStart:d.modifiedStart,modifiedLength:d.modifiedLength})),{mapping:p,diff:u}}function g(n){return{cellKind:n[2],getValue:()=>n[0].join(`
`),getLinesContent:()=>n[0]}}function b(n,t,p){return{source:t[0],language:t[1],cellKind:t[2],outputs:t[3]||[],metadata:t[4],eol:`
`,handle:p,url:_.from({scheme:"file",path:n.path,fragment:`cell/${p}`}).toString(),versionId:0,internalMetadata:void 0}}function r(n){return[n.source,n.cell_type==="code"?"python":"markdown",n.cell_type==="code"?e.Code:e.Markup]}});
