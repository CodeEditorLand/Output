...
let SettingsTargetsWidget = class SettingsTargetsWidget2 extends Widget {
  ...
  create(parent) {
    ...
    this.userLocalSettings = new Action("userSettings", "", ".settings-tab", true, () => this.updateTarget(
      3
      /* ConfigurationTarget.USER_LOCAL */
    ));
    this.userLocalSettings.tooltip = localize("userSettings", "User");
    this.userRemoteSettings = new Action("userSettingsRemote", "", ".settings-tab", true, () => this.updateTarget(
      4
    ...
    this.workspaceSettings = new Action("workspaceSettings", "", ".settings-tab", false, () => this.updateTarget(
      5
