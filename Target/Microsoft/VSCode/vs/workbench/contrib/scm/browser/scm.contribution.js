  ...
  [
    {
      ...
      singleViewPaneContainerTitle: localize(
...
CommandsRegistry.registerCommand("scm.setActiveProvider", async (accessor) => {
  ...
  const autoQuickItemDescription = localize(
    ...
    "The active repository is updated based on focused repository/active editor"
  );
  const repositoryPicker = instantiationService.createInstance(
    RepositoryPicker,
    placeHolder,
    autoQuickItemDescription
  );
