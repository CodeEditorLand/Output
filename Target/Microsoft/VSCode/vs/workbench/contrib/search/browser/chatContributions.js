...
let FilesAndFoldersPickerPick = class FilesAndFoldersPickerPick2 {
  ...
  _createPickItem(resource, kind) {
    return {
      ...
      iconClass: kind === FileKind.FILE ? getIconClasses(this._modelService, this._languageService, resource, FileKind.FILE).join(" ") : ThemeIcon.asClassName(Codicon.folder),
...
//# sourceMappingURL=chatContributions.js.map
