...
let SearchModelImpl = class SearchModelImpl2 extends Disposable {
  static {
  ...
  onSearchError(e, duration, ai) {
    if (errors.isCancellationError(e)) {
      this.onSearchCompleted((ai ? this.aiSearchCancelledForNewSearch : this.searchCancelledForNewSearch) ? { exit: 1, results: [], messages: [] } : void 0, duration, "", ai);
      if (ai) {
        this.aiSearchCancelledForNewSearch = false;
      } else {
        this.searchCancelledForNewSearch = false;
...
let SearchViewModelWorkbenchService = class SearchViewModelWorkbenchService2 {
  static {
