...
const terminalConfiguration = {
  ...
  [
    ...
    enum: [
      "editor",
      "view"
      /* TerminalLocationConfigValue.TerminalView */
    ],
    enumDescriptions: [
  ...
  [
    ...
    markdownDescription: localize("terminal.integrated.fontLigatures.enabled", "Controls whether font ligatures are enabled in the terminal. Ligatures will only work if the configured {0} supports them.", `\`#${"terminal.integrated.fontFamily"}#\``),
    type: "boolean",
    default: false
  },
  [
  ...
  [
    ...
    "type": "string",
    "default": " - ",
    "markdownDescription": localize("terminal.integrated.tabs.separator", "Separator used by {0} and {1}.", `\`#${"terminal.integrated.tabs.title"}#\``, `\`#${"terminal.integrated.tabs.description"}#\``)
  },
  [
  ...
  [
    ...
    markdownDescription: localize("terminal.integrated.shellIntegration.environmentReporting", "Controls whether to report the shell environment, enabling its use in features such as {0}. This may cause a slowdown when printing your shell's prompt.", `\`#${"terminal.integrated.suggest.enabled"}#\``),
    type: "boolean",
...
async function registerTerminalConfiguration(getFontSnippets) {
  ...
  terminalConfiguration[
    "terminal.integrated.fontFamily"
    /* TerminalSettingId.FontFamily */
  ].defaultSnippets = await getFontSnippets();
}
...
Registry.as(WorkbenchExtensions.ConfigurationMigration).registerConfigurationMigrations([{
  key: "terminal.integrated.enableBell",
  migrateFn: /* @__PURE__ */ __name((enableBell, accessor) => {
    ...
    configurationKeyValuePairs.push(["terminal.integrated.enableBell", { value: void 0 }]);
    configurationKeyValuePairs.push(["terminal.integrated.enableVisualBell", { value: enableBell }]);
