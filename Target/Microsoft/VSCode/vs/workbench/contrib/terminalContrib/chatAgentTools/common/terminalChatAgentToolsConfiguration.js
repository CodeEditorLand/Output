...
(function(TerminalChatAgentToolsSettingId2) {
  ...
  TerminalChatAgentToolsSettingId2["AutoReplyToPrompts"] = "chat.tools.terminal.autoReplyToPrompts";
  TerminalChatAgentToolsSettingId2["OutputLocation"] = "chat.tools.terminal.outputLocation";
  TerminalChatAgentToolsSettingId2["TerminalSandboxEnabled"] = "chat.tools.terminal.sandbox.enabled";
  TerminalChatAgentToolsSettingId2["TerminalSandboxNetwork"] = "chat.tools.terminal.sandbox.network";
  TerminalChatAgentToolsSettingId2["TerminalSandboxLinuxFileSystem"] = "chat.tools.terminal.sandbox.linuxFileSystem";
  TerminalChatAgentToolsSettingId2["TerminalSandboxMacFileSystem"] = "chat.tools.terminal.sandbox.macFileSystem";
...
const terminalChatAgentToolsConfiguration = {
  ...
  [
    ...
    markdownDescription: localize("terminalSandbox.networkSetting", "Note: this setting is applicable only when {0} is enabled. Controls network access in the terminal sandbox.", `\`#${"chat.tools.terminal.sandbox.enabled"}#\``),
    type: "object",
    properties: {
      allowedDomains: {
        type: "array",
...
for (const id of [
  ...
  terminalChatAgentToolsConfiguration[id] = {
    deprecated: true,
    markdownDeprecationMessage: localize("autoApprove.deprecated", "Use {0} instead", `\`#${"chat.tools.terminal.autoApprove"}#\``)
  };
}
export {
