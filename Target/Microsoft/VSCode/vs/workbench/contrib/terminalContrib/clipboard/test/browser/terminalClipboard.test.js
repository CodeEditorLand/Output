import{strictEqual as e}from"assert";import{$s$ as s}from"../../../../../../base/test/common/utils.js";import{$El as a}from"../../../../../../platform/configuration/common/configuration.js";import{$OFc as r}from"../../../../../../platform/configuration/test/common/testConfigurationService.js";import{$_o as c}from"../../../../../../platform/dialogs/common/dialogs.js";import{$PFc as l}from"../../../../../../platform/dialogs/test/common/testDialogService.js";import{$TFc as d}from"../../../../../../platform/instantiation/test/common/instantiationServiceMock.js";import{$0rc as i}from"../../browser/terminalClipboard.js";suite("TerminalClipboard",function(){const u=s();suite("shouldPasteTerminalText",()=>{let n,o;setup(async()=>{n=u.add(new d),o=new r({"terminal.integrated.enableMultiLinePasteWarning":"auto"}),n.stub(a,o),n.stub(c,new l(void 0,{result:{confirmed:!1}}))});function t(f){o=new r({"terminal.integrated.enableMultiLinePasteWarning":f}),n.stub(a,o)}test("Single line string",async()=>{e(await n.invokeFunction(i,"foo",void 0),!0),t("always"),e(await n.invokeFunction(i,"foo",void 0),!0),t("never"),e(await n.invokeFunction(i,"foo",void 0),!0)}),test("Single line string with trailing new line",async()=>{e(await n.invokeFunction(i,`foo
