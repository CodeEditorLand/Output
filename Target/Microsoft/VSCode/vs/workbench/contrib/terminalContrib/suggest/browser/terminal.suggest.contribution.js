...
registerActiveInstanceAction({
  id: "workbench.action.terminal.resetDiscoverability",
  title: localize2("workbench.action.terminal.resetDiscoverability", "Reset Suggest Discoverability"),
  f1: true,
  precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.isOpen, ContextKeyExpr.equals(`config.${"terminal.integrated.suggest.enabled"}`, true)),
