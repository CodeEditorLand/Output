...
let TerminalSuggestContribution = class extends DisposableStore {
    ...
    this.add(
      this._configurationService.onDidChangeConfiguration((e) => {
        if (e.affectsConfiguration(TerminalSuggestSettingId.Enabled)) {
          const completionsEnabled = this._configurationService.getValue(
            terminalSuggestConfigSection
          ).enabled;
  ...
  async _loadPwshCompletionAddon(xterm) {
    if (this._ctx.instance.shellType !== GeneralShellType.PowerShell || this._ctx.instance.shellLaunchConfig.executable?.endsWith(
    ...
    const pwshCompletionProviderAddon = this._pwshAddon.value = this._instantiationService.createInstance(
    ...
    this.add(
      this._terminalCompletionService.registerTerminalCompletionProvider(
        "builtinPwsh",
        pwshCompletionProviderAddon.id,
        pwshCompletionProviderAddon
      )
    );
    if (!isWindows) {
    ...
    this.add(
      dom.addDisposableListener(
        ...
        (e) => {
          ...
          if (focusedElement?.classList.contains(
...
registerActiveInstanceAction({
  ...
  run: /* @__PURE__ */ __name((activeInstance) => TerminalSuggestContribution.get(
    activeInstance
  )?.addon?.requestCompletions(true), "run")
});
registerActiveInstanceAction({
...
registerActiveInstanceAction({
  ...
  keybinding: {
    ...
    when: ContextKeyExpr.or(
      ...
      ContextKeyExpr.equals(
        `config.${TerminalSuggestSettingId.UpArrowNavigatesHistory}`,
        false
      )
    )
  },
...
registerActiveInstanceAction({
  ...
  run: /* @__PURE__ */ __name((activeInstance) => TerminalSuggestContribution.get(
    activeInstance
  )?.addon?.toggleSuggestionFocus(), "run")
});
registerActiveInstanceAction({
  ...
  run: /* @__PURE__ */ __name((activeInstance) => TerminalSuggestContribution.get(
    activeInstance
  )?.addon?.toggleSuggestionDetails(), "run")
});
registerActiveInstanceAction({
...
registerActiveInstanceAction({
  ...
  run: /* @__PURE__ */ __name(async (activeInstance) => TerminalSuggestContribution.get(
    activeInstance
...
registerActiveInstanceAction({
  ...
  run: /* @__PURE__ */ __name((activeInstance) => TerminalSuggestContribution.get(
    activeInstance
  )?.addon?.hideSuggestWidget(true), "run")
});
registerActiveInstanceAction({
