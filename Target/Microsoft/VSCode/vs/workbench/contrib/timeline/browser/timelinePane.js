...
const TimelineViewFocusedContext = new RawContextKey(
  "timelineFocused",
  true
);
let TimelinePane = class extends ViewPane {
  ...
  loadTimelineForSource(source, uri, reset, options) {
    ...
    const newRequest = this.timelineService.getTimeline(
      source,
      uri,
      options,
      tokenSource
    ...
    this.pendingRequests.set(source, {
      request: newRequest,
      ...
      [this.treeRenderer],
      {
        ...
        accessibilityProvider: {
          ...
          getRole(element) {
            ...
            return element.accessibilityInformation?.role ? element.accessibilityInformation.role : "treeitem";
          },
          getWidgetAriaLabel() {
