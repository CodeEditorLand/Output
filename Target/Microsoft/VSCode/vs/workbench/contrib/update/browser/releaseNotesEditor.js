import"./media/releasenoteseditor.css";import{CancellationToken as z}from"../../../../base/common/cancellation.js";import{$jb as _}from"../../../../base/common/errors.js";import{$Zj as y}from"../../../../base/common/htmlContent.js";import{$Q0 as D}from"../../../../base/common/keybindingParser.js";import{$Bf as P}from"../../../../base/common/strings.js";import{URI as b}from"../../../../base/common/uri.js";import{$Rm as M}from"../../../../base/common/uuid.js";import{$xD as $}from"../../../../editor/common/languages.js";import{$XPb as q}from"../../../../editor/common/languages/supports/tokenization.js";import{$yD as L}from"../../../../editor/common/languages/language.js";import*as w from"../../../../nls.js";import{$fl as I}from"../../../../platform/environment/common/environment.js";import{$sx as j}from"../../../../platform/keybinding/common/keybinding.js";import{$2$ as A}from"../../../../platform/opener/common/opener.js";import{$nn as B}from"../../../../platform/product/common/productService.js";import{$ro as O,$mo as U}from"../../../../platform/request/common/request.js";import{$5hc as W,$6hc as T}from"../../markdown/browser/markdownDocumentRenderer.js";import{$NYb as V}from"../../webviewPanel/browser/webviewWorkbenchService.js";import{$hI as H}from"../../../services/editor/common/editorGroupsService.js";import{$mI as K,$lI as Y}from"../../../services/editor/common/editorService.js";import{$ZO as F}from"../../../services/extensions/common/extensions.js";import{$Gu as G,$Eu as X}from"../../../../platform/telemetry/common/telemetryUtils.js";import{$El as Z}from"../../../../platform/configuration/common/configuration.js";import{$td as k}from"../../../../base/common/lifecycle.js";import{$lvc as Q}from"../../markdown/browser/markdownSettingRenderer.js";import{$nj as J}from"../../../../platform/instantiation/common/instantiation.js";import{Schemas as R}from"../../../../base/common/network.js";import{$8_ as ee}from"../../../../editor/browser/services/codeEditorService.js";import{$ih as te}from"../../../../base/common/resources.js";import{$9Tb as oe}from"../../webview/common/webview.js";var S=function(g,e,t,o){var a=arguments.length,n=a<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(g,e,t,o);else for(var r=g.length-1;r>=0;r--)(i=g[r])&&(n=(a<3?i(n):a>3?i(e,t,n):i(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},d=function(g,e){return function(t,o){e(t,o,g)}};let E=class{constructor(e,t,o,a,n,i,r,m,h,u,s,f,v){this.g=e,this.h=t,this.i=o,this.j=a,this.k=n,this.l=i,this.m=r,this.n=m,this.o=h,this.p=u,this.q=s,this.r=f,this.s=v,this.b=new Map,this.c=void 0,this.f=new k,$.onDidChange(()=>this.t()),i.onDidChangeConfiguration(this.B,this,this.f),u.onDidChangeActiveWebviewEditor(this.C,this,this.f),this.a=this.s.createInstance(Q)}async t(){if(!this.c||!this.d)return;const e=await this.A(this.d);this.c&&this.c.webview.setHtml(e)}async u(e){if(e){const t=this.o.getActiveCodeEditor()?.getModel()?.uri;if(t)return te(t)}return b.parse("https://code.visualstudio.com/raw")}async show(e,t){const o=await this.v(e,t),a=await this.u(t);this.d={text:o,base:a};const n=await this.A(this.d),i=w.localize(12573,null,e),r=this.m.activeEditorPane;if(this.c)this.c.setName(i),this.c.webview.setHtml(n),this.p.revealWebview(this.c,r?r.group:this.n.activeGroup,!1);else{this.c=this.p.openWebview({title:i,options:{tryRestoreScrollPosition:!0,enableFindWidget:!0,disableServiceWorker:!t},contentOptions:{localResourceRoots:t?[a]:[],allowScripts:!0},extension:void 0},"releaseNotes",i,{group:K,preserveFocus:!1}),this.c.webview.onDidClickLink(h=>this.w(b.parse(h)));const m=new k;m.add(this.c.webview.onMessage(h=>{if(h.message.type==="showReleaseNotes")this.l.updateValue("update.showReleaseNotes",h.message.value);else if(h.message.type==="clickSetting"){const u=this.c?.webview.container.offsetLeft+h.message.value.x,s=this.c?.webview.container.offsetTop+h.message.value.y;this.a.updateSetting(b.parse(h.message.value.uri),u,s)}})),m.add(this.c.onWillDispose(()=>{m.dispose(),this.c=void 0})),this.c.webview.setHtml(n)}return!0}async v(e,t){const o=/^(\d+\.\d+)\./.exec(e);if(!o)throw new Error("not found");const i=`https://code.visualstudio.com/raw/v${o[1].replace(/\./g,"_")}.md`,r=w.localize(12574,null),m=s=>P(s).replace(/\\/g,"\\\\"),h=s=>{const f=(p,c)=>{const l=this.h.lookupKeybinding(c);return l&&l.getLabel()||r},v=(p,c)=>{const l=D.parseKeybinding(c);if(!l)return r;const x=this.h.resolveKeybinding(l);return x.length===0?r:x[0].getLabel()||r},C=(p,c)=>{const l=f(p,c);return l&&`<code title="${c}">${m(l)}</code>`},N=(p,c)=>{const l=v(p,c);return l&&`<code title="${c}">${m(l)}</code>`};return s.replace(/`kb\(([a-z.\d\-]+)\)`/gi,C).replace(/`kbstyle\(([^\)]+)\)`/gi,N).replace(/kb\(([a-z.\d\-]+)\)/gi,(p,c)=>y(f(p,c))).replace(/kbstyle\(([^\)]+)\)/gi,(p,c)=>y(v(p,c)))},u=async()=>{let s;try{if(t){const f=this.o.getActiveCodeEditor()?.getModel()?.getValue();s=f?f.substring(f.indexOf("#")):void 0}else s=await O(await this.k.request({url:i},z.None))}catch{throw new Error("Failed to fetch release notes")}if(!s||!/^#\s/.test(s)&&!t)throw new Error("Invalid release notes");return h(s)};return t?u():(this.b.has(e)||this.b.set(e,(async()=>{try{return await u()}catch(s){throw this.b.delete(e),s}})()),this.b.get(e))}async w(e){e.scheme===R.codeSetting||this.z(e,"ReleaseNotes").then(t=>this.j.open(t,{allowCommands:["workbench.action.openSettings"]})).then(void 0,_)}async z(e,t,o="1"){return X(this.r,this.g)&&G(this.l)===3&&e.scheme==="https"&&e.authority==="code.visualstudio.com"?e.with({query:`${e.query?e.query+"&":""}utm_source=VsCode&utm_medium=${encodeURIComponent(t)}&utm_content=${encodeURIComponent(o)}`}):e}async A(e){const t=M(),o=await T(e.text,this.q,this.i,{shouldSanitize:!1,markedExtensions:[{renderer:{html:this.a.getHtmlRenderer(),codespan:this.a.getCodeSpanRenderer()}}]}),a=$.getColorMap(),n=a?q(a):"",i=!!this.l.getValue("update.showReleaseNotes");return`<!DOCTYPE html>
		<html>
			<head>
			...
			<body>
				...
				<script nonce="${t}">
					...
					label.textContent = '${w.localize(12575,null)}';
		...
		</html>`}B(e){e.affectsConfiguration("update.showReleaseNotes")&&this.D()}C(e){e&&e===this.c&&this.D()}D(){this.c&&this.c.webview.postMessage({type:"showReleaseNotes",value:this.l.getValue("update.showReleaseNotes")})}};E=S([d(0,I),d(1,j),d(2,L),d(3,A),d(4,U),d(5,Z),d(6,Y),d(7,H),d(8,ee),d(9,V),d(10,F),d(11,B),d(12,J)],E);export{E as $mvc};
