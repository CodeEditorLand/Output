...
`:"",o.length===0?e+=E:e+=JSON.stringify(o,null,2),e}let u=class{static{this.ID="workbench.contrib.trustedDomainsFileSystemProvider"}constructor(o,t,e){this.a=o,this.b=t,this.c=e,this.capabilities=2,this.onDidChangeCapabilities=h.None,this.onDidChangeFile=h.None,this.a.registerProvider(S,this)}stat(o){return Promise.resolve(C)}async readFile(o){let t=this.b.get(f,-1);const e=o.fragment,{defaultTrustedDomains:i,trustedDomains:s}=await this.c.invokeFunction(T);return(!t||t.indexOf(l)===-1||t.indexOf(p)===-1||t.indexOf(e??"")===-1||[...i,...s].some(c=>!w(t).includes(c)))&&(t=M(i,s,e)),a.fromString(t).buffer}writeFile(o,t,e){try{const i=a.wrap(t).toString(),s=g(i);this.b.store(f,i,-1,0),this.b.store(v,JSON.stringify(s)||"",-1,0)}catch{}return Promise.resolve()}watch(o,t){return{dispose(){}}}mkdir(o){return Promise.resolve(void 0)}readdir(o){return Promise.resolve(void 0)}delete(o,t){return Promise.resolve(void 0)}rename(o,t,e){return Promise.resolve(void 0)}};u=d([m(0,_),m(1,D),m(2,P)],u);export{u as $vqc};
