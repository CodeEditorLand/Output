  ...
  async getChildren(resourceType) {
    if (resourceType === void 0) {
      ...
      return Promise.all(resourceTypes.map(async (r) => {
        const children = r === "settings" || r === "keybindings" || r === "tasks" ? await this.getChildrenForResourceType(r) : [];
        return {
          handle: r,
          checkbox: void 0,
          resourceType: r,
...
let NewProfileElement = class NewProfileElement2 extends AbstractUserDataProfileElement {
  ...
  constructor(name, copyFrom, titleButtons, actions, userDataProfileImportExportService, userDataProfileManagementService, userDataProfilesService, commandService, workspaceContextService, hostService, uriIdentityService, fileService, extensionManagementService, instantiationService) {
    super(name, void 0, void 0, void 0, false, userDataProfileManagementService, userDataProfilesService, commandService, workspaceContextService, hostService, uriIdentityService, fileService, extensionManagementService, instantiationService);
    this.titleButtons = titleButtons;
    this.actions = actions;
