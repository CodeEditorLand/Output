...
let GettingStartedPage = class extends EditorPane {
  ...
  setSlide(toEnable, firstLaunch = false) {
    ...
    if (toEnable === "categories") {
      ...
      this.container.querySelector(".gettingStartedSlideDetails")?.querySelectorAll("button").forEach((button2) => button2.disabled = true);
      this.container.querySelector(".gettingStartedSlideCategories")?.querySelectorAll("button").forEach((button2) => button2.disabled = false);
      this.container.querySelector(".gettingStartedSlideCategories")?.querySelectorAll("input").forEach((button2) => button2.disabled = false);
    } else {
