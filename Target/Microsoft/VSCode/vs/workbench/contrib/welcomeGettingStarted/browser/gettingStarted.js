  ...
  updateNavButtons(newIndex, steps) {
    ...
    if (this.nextButton) {
      ...
      if (textNode && textNode.nodeType === Node.TEXT_NODE) {
        textNode.textContent = isLastSlide ? localize("last", "Start coding") : localize("next", "Next");
      }
      this.nextButton.setAttribute("aria-label", isLastSlide ? localize("lastStep", "Start coding") : localize("nextStep", "Next"));
    }
  }
