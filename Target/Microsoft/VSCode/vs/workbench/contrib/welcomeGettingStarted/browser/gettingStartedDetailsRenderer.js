import{$Rm as l}from"../../../../base/common/uuid.js";import{$XPb as m}from"../../../../editor/common/languages/supports/tokenization.js";import{$xD as h}from"../../../../editor/common/languages.js";import{$5hc as p,$6hc as w}from"../../markdown/browser/markdownDocumentRenderer.js";import{$z as u}from"../../../../base/common/platform.js";import{$jh as k}from"../../../../base/common/resources.js";import{$0c as f}from"../../../../base/common/types.js";import{$9Tb as C}from"../../webview/common/webview.js";import{$Hc as y}from"../../../../base/common/map.js";import{$6j as S}from"../../../../platform/files/common/files.js";import{$OI as E}from"../../../../platform/notification/common/notification.js";import{$yD as L}from"../../../../editor/common/languages/language.js";import{$ZO as P}from"../../../services/extensions/common/extensions.js";import{$Euc as q}from"../common/gettingStartedContent.js";var b=function(i,t,n,e){var o=arguments.length,r=o<3?t:e===null?e=Object.getOwnPropertyDescriptor(t,n):e,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,t,n,e);else for(var s=i.length-1;s>=0;s--)(c=i[s])&&(r=(o<3?c(r):o>3?c(t,n,r):c(t,n))||r);return o>3&&r&&Object.defineProperty(t,n,r),r},a=function(i,t){return function(n,e){t(n,e,i)}};let g=class{constructor(t,n,e,o){this.c=t,this.d=n,this.f=e,this.g=o,this.a=new y,this.b=new y}async renderMarkdown(t,n){const e=await this.i(t,n),o=l(),r=h.getColorMap(),c=r?m(r):"";return`<!DOCTYPE html>
		<html>
			<head>
		...
		</html>`}async h(t){if(!this.b.has(t)){const n=await this.j(t,!1);this.b.set(t,n)}return f(this.b.get(t))}async i(t,n){if(!this.a.has(t)){const e=await this.j(t),o=await w(z(e,n),this.f,this.g,{allowUnknownProtocols:!0});this.a.set(t,o)}return f(this.a.get(t))}async j(t,n=!0){try{const e=JSON.parse(t.query).moduleId;if(n&&e)return await new Promise((r,c)=>{const s=q.getProvider(e);s?r(s()):c(`Getting started: no provider registered for ${e}`)})}catch{}try{const e=t.with({path:t.path.replace(/\.md$/,`.nls.${u}.md`)}),o=u?.replace(/-.*$/,""),r=t.with({path:t.path.replace(/\.md$/,`.nls.${o}.md`)}),c=x=>this.c.stat(x).then(v=>!!v.size).catch(()=>!1),[s,d]=await Promise.all([c(e),c(r)]);return(await this.c.readFile(s?e:d?r:t)).value.toString()}catch(e){return this.d.error("Error reading markdown document at `"+t+"`: "+e),""}}};g=b([a(0,S),a(1,E),a(2,P),a(3,L)],g);const $=(i,t)=>{const n=k(t,i);return C(n).toString(!0)},z=(i,t)=>i.replace(/src="([^"]*)"/g,(n,e)=>e.startsWith("https://")?`src="${e}"`:`src="${$(e,t)}"`).replace(/!\[([^\]]*)\]\(([^)]*)\)/g,(n,e,o)=>o.startsWith("https://")?`![${e}](${o})`:`![${e}](${$(o,t)})`);export{g as $Fvc};
