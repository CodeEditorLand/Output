import{$Sm as l}from"../../../../base/common/uuid.js";import{$FQb as m}from"../../../../editor/common/languages/supports/tokenization.js";import{$BD as h}from"../../../../editor/common/languages.js";import{$Ric as p,$Sic as w}from"../../markdown/browser/markdownDocumentRenderer.js";import{$A as u}from"../../../../base/common/platform.js";import{$kh as k}from"../../../../base/common/resources.js";import{$$c as f}from"../../../../base/common/types.js";import{$zTb as C}from"../../webview/common/webview.js";import{$Ic as y}from"../../../../base/common/map.js";import{$5j as S}from"../../../../platform/files/common/files.js";import{$_I as L}from"../../../../platform/notification/common/notification.js";import{$CD as q}from"../../../../editor/common/languages/language.js";import{$YO as E}from"../../../services/extensions/common/extensions.js";import{$uvc as P}from"../common/gettingStartedContent.js";var b=function(i,t,n,e){var o=arguments.length,r=o<3?t:e===null?e=Object.getOwnPropertyDescriptor(t,n):e,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(i,t,n,e);else for(var s=i.length-1;s>=0;s--)(c=i[s])&&(r=(o<3?c(r):o>3?c(t,n,r):c(t,n))||r);return o>3&&r&&Object.defineProperty(t,n,r),r},a=function(i,t){return function(n,e){t(n,e,i)}};let g=class{constructor(t,n,e,o){this.c=t,this.d=n,this.f=e,this.g=o,this.a=new y,this.b=new y}async renderMarkdown(t,n){const e=await this.i(t,n),o=l(),r=h.getColorMap(),c=r?m(r):"";return`<!DOCTYPE html>
		<html>
			<head>
