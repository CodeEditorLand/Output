...
(function(StoredFileWorkingCopyState2) {
...
let StoredFileWorkingCopy = class StoredFileWorkingCopy2 extends ResourceWorkingCopy {
  static {
  ...
  async save(options = /* @__PURE__ */ Object.create(null)) {
    ...
    if ((this.hasState(
      3
      /* StoredFileWorkingCopyState.CONFLICT */
    ) || this.hasState(
      5
    ...
    return this.hasState(
      0
      /* StoredFileWorkingCopyState.SAVED */
    );
  }
  ...
  doHandleSaveError(error, options) {
    ...
    if (fileOperationError.fileOperationResult === 3) {
      ...
      primaryActions.push(toAction({ id: "fileWorkingCopy.overwrite", label: localize("overwrite", "Overwrite"), run: /* @__PURE__ */ __name(() => this.save({
        ...options,
      ...
      if (canSaveElevated && (isPermissionDenied || triedToUnlock)) {
        ...
        primaryActions.push(toAction({ id: "fileWorkingCopy.unlock", label: localize("overwrite", "Overwrite"), run: /* @__PURE__ */ __name(() => this.save({
          ...options,
          writeUnlock: true,
          reason: 1
          /* SaveReason.EXPLICIT */
        ...
        primaryActions.push(toAction({ id: "fileWorkingCopy.retry", label: localize("retry", "Retry"), run: /* @__PURE__ */ __name(() => this.save({
          ...options,
          reason: 1
          /* SaveReason.EXPLICIT */
        }), "run") }));
