...
var WorkingCopyHistoryService_1;
var NativeWorkingCopyHistoryService_1;
class WorkingCopyHistoryModel {
  ...
  static {
    this.FILE_SAVED_SOURCE = SaveSourceRegistry.registerSource("default.source", localize("default.source", "File Saved"));
  }
  static {
    this.SETTINGS = {
...
let WorkingCopyHistoryService = class WorkingCopyHistoryService2 extends Disposable {
  static {
  ...
  static {
    this.FILE_MOVED_SOURCE = SaveSourceRegistry.registerSource("moved.source", localize("moved.source", "File Moved"));
  }
  static {
    this.FILE_RENAMED_SOURCE = SaveSourceRegistry.registerSource("renamed.source", localize("renamed.source", "File Renamed"));
  }
...
let NativeWorkingCopyHistoryService = class NativeWorkingCopyHistoryService2 extends WorkingCopyHistoryService {
  static {
    __name(this, "NativeWorkingCopyHistoryService");
  }
  static {
    NativeWorkingCopyHistoryService_1 = this;
  }
  static {
    this.STORE_ALL_INTERVAL = 5 * 60 * 1e3;
  }
  // 5min
