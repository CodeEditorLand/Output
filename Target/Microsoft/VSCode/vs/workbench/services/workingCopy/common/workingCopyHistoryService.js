...
class WorkingCopyHistoryModel {
  ...
  async addEntry(source, sourceDescription, timestamp, token) {
  ...
  async doAddEntry(source, sourceDescription, timestamp, token) {
  ...
  async doReplaceEntry(entry, source, sourceDescription, timestamp, token) {
    const workingCopyResource = assertIsDefined(this.workingCopyResource);
